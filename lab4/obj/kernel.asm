...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6b3040ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc02000ac:	ed050513          	addi	a0,a0,-304 # ffffffffc0204f78 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	18b040ef          	jal	ra,ffffffffc0204afe <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	155040ef          	jal	ra,ffffffffc0204afe <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	db650513          	addi	a0,a0,-586 # ffffffffc0204f80 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc02001e4:	dc050513          	addi	a0,a0,-576 # ffffffffc0204fa0 <etext+0x56>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d5e58593          	addi	a1,a1,-674 # ffffffffc0204f4a <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	dcc50513          	addi	a0,a0,-564 # ffffffffc0204fc0 <etext+0x76>
...
ffffffffc020020c:	dd850513          	addi	a0,a0,-552 # ffffffffc0204fe0 <etext+0x96>
...
ffffffffc0200220:	de450513          	addi	a0,a0,-540 # ffffffffc0205000 <etext+0xb6>
...
ffffffffc020024e:	dd650513          	addi	a0,a0,-554 # ffffffffc0205020 <etext+0xd6>
}
...
ffffffffc020025c:	df860613          	addi	a2,a2,-520 # ffffffffc0205050 <etext+0x106>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	e0450513          	addi	a0,a0,-508 # ffffffffc0205068 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc0200278:	e0c60613          	addi	a2,a2,-500 # ffffffffc0205080 <etext+0x136>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e2458593          	addi	a1,a1,-476 # ffffffffc02050a0 <etext+0x156>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e2450513          	addi	a0,a0,-476 # ffffffffc02050a8 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e2660613          	addi	a2,a2,-474 # ffffffffc02050b8 <etext+0x16e>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e4658593          	addi	a1,a1,-442 # ffffffffc02050e0 <etext+0x196>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	e0650513          	addi	a0,a0,-506 # ffffffffc02050a8 <etext+0x15e>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e4260613          	addi	a2,a2,-446 # ffffffffc02050f0 <etext+0x1a6>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e5a58593          	addi	a1,a1,-422 # ffffffffc0205110 <etext+0x1c6>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dea50513          	addi	a0,a0,-534 # ffffffffc02050a8 <etext+0x15e>
...
ffffffffc02002fc:	e2850513          	addi	a0,a0,-472 # ffffffffc0205120 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e2e50513          	addi	a0,a0,-466 # ffffffffc0205148 <etext+0x1fe>
...
ffffffffc0200348:	e2c90913          	addi	s2,s2,-468 # ffffffffc0205170 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e2c48493          	addi	s1,s1,-468 # ffffffffc0205178 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e2ab0b13          	addi	s6,s6,-470 # ffffffffc0205180 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d42a0a13          	addi	s4,s4,-702 # ffffffffc02050a0 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	33b040ef          	jal	ra,ffffffffc0204ec8 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	327040ef          	jal	ra,ffffffffc0204ec8 <strcmp>
...
ffffffffc02003e0:	307040ef          	jal	ra,ffffffffc0204ee6 <strchr>
...
ffffffffc020041e:	2c9040ef          	jal	ra,ffffffffc0204ee6 <strchr>
...
ffffffffc020043c:	d6850513          	addi	a0,a0,-664 # ffffffffc02051a0 <etext+0x256>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	183040ef          	jal	ra,ffffffffc0204f0e <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	15f040ef          	jal	ra,ffffffffc0204f0e <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	42663603          	ld	a2,1062(a2) # ffffffffc0207050 <nbase>
...
ffffffffc02016f4:	9606b683          	ld	a3,-1696(a3) # ffffffffc0207050 <nbase>
...
ffffffffc0201968:	6ec53503          	ld	a0,1772(a0) # ffffffffc0207050 <nbase>
...
ffffffffc0201bbe:	33e030ef          	jal	ra,ffffffffc0204efc <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	2ac030ef          	jal	ra,ffffffffc0204efc <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	365020ef          	jal	ra,ffffffffc0204eb6 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	36b020ef          	jal	ra,ffffffffc0204ec8 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2ed020ef          	jal	ra,ffffffffc0204e80 <strlen>
...
ffffffffc0202e2c:	22860613          	addi	a2,a2,552 # ffffffffc0207050 <nbase>
...
ffffffffc0203cc2:	392a3a03          	ld	s4,914(s4) # ffffffffc0207050 <nbase>
...
ffffffffc0204078:	b4450513          	addi	a0,a0,-1212 # ffffffffc0206bb8 <default_pmm_manager+0xf18>
...
ffffffffc02040a2:	af250513          	addi	a0,a0,-1294 # ffffffffc0206b90 <default_pmm_manager+0xef0>
...
ffffffffc02040b4:	a9050513          	addi	a0,a0,-1392 # ffffffffc0206b40 <default_pmm_manager+0xea0>
...
ffffffffc02040c4:	b1850513          	addi	a0,a0,-1256 # ffffffffc0206bd8 <default_pmm_manager+0xf38>
...
ffffffffc02040d4:	aa050513          	addi	a0,a0,-1376 # ffffffffc0206b70 <default_pmm_manager+0xed0>
...
ffffffffc0204106:	afe60613          	addi	a2,a2,-1282 # ffffffffc0206c00 <default_pmm_manager+0xf60>
ffffffffc020410a:	45b5                	li	a1,13
ffffffffc020410c:	00003517          	auipc	a0,0x3
ffffffffc0204110:	b1450513          	addi	a0,a0,-1260 # ffffffffc0206c20 <default_pmm_manager+0xf80>
...
ffffffffc0204140:	f1473703          	ld	a4,-236(a4) # ffffffffc0207050 <nbase>
...
ffffffffc020417a:	ac260613          	addi	a2,a2,-1342 # ffffffffc0206c38 <default_pmm_manager+0xf98>
ffffffffc020417e:	45d1                	li	a1,20
ffffffffc0204180:	00003517          	auipc	a0,0x3
ffffffffc0204184:	aa050513          	addi	a0,a0,-1376 # ffffffffc0206c20 <default_pmm_manager+0xf80>
...
ffffffffc0204196:	b4660613          	addi	a2,a2,-1210 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc020419a:	00002517          	auipc	a0,0x2
ffffffffc020419e:	b6650513          	addi	a0,a0,-1178 # ffffffffc0205d00 <default_pmm_manager+0x60>
...
ffffffffc02041ce:	e8673703          	ld	a4,-378(a4) # ffffffffc0207050 <nbase>
...
ffffffffc0204208:	a3460613          	addi	a2,a2,-1484 # ffffffffc0206c38 <default_pmm_manager+0xf98>
ffffffffc020420c:	45e5                	li	a1,25
ffffffffc020420e:	00003517          	auipc	a0,0x3
ffffffffc0204212:	a1250513          	addi	a0,a0,-1518 # ffffffffc0206c20 <default_pmm_manager+0xf80>
...
ffffffffc0204224:	ab860613          	addi	a2,a2,-1352 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0204228:	00002517          	auipc	a0,0x2
ffffffffc020422c:	ad850513          	addi	a0,a0,-1320 # ffffffffc0205d00 <default_pmm_manager+0x60>
...
ffffffffc0204236:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204238:	48e000ef          	jal	ra,ffffffffc02046c6 <do_exit>
...
ffffffffc0204272:	48b000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc0204290:	46d000ef          	jal	ra,ffffffffc0204efc <memset>
    }
    return proc;
}
...
ffffffffc02042fa:	98a50513          	addi	a0,a0,-1654 # ffffffffc0206c80 <default_pmm_manager+0xfe0>
ffffffffc02042fe:	e83fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204302:	00003517          	auipc	a0,0x3
ffffffffc0204306:	98e50513          	addi	a0,a0,-1650 # ffffffffc0206c90 <default_pmm_manager+0xff0>
...
ffffffffc0204358:	5f4000ef          	jal	ra,ffffffffc020494c <switch_to>
    if (flag) {
...
ffffffffc020439e:	26f75163          	bge	a4,a5,ffffffffc0204600 <do_fork+0x27c>
...
ffffffffc02043aa:	89aa                	mv	s3,a0
    if (proc == NULL) {
ffffffffc02043ac:	24050f63          	beqz	a0,ffffffffc020460a <do_fork+0x286>
    proc->parent = current;    
...
ffffffffc02043c2:	e6afd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043c6:	1e050763          	beqz	a0,ffffffffc02045b4 <do_fork+0x230>
    return page - pages + nbase;
...
ffffffffc02043dc:	c7853503          	ld	a0,-904(a0) # ffffffffc0207050 <nbase>
...
ffffffffc02043f0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043f2:	22e7fe63          	bgeu	a5,a4,ffffffffc020462e <do_fork+0x2aa>
...
ffffffffc0204406:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc020440a:	20079263          	bnez	a5,ffffffffc020460e <do_fork+0x28a>
...
ffffffffc0204446:	12090563          	beqz	s2,ffffffffc0204570 <do_fork+0x1ec>
...
ffffffffc0204462:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204464:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204466:	12079663          	bnez	a5,ffffffffc0204592 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc020446a:	00007817          	auipc	a6,0x7
ffffffffc020446e:	bee80813          	addi	a6,a6,-1042 # ffffffffc020b058 <last_pid.1>
...
ffffffffc0204480:	08e55163          	bge	a0,a4,ffffffffc0204502 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204484:	00007317          	auipc	t1,0x7
ffffffffc0204488:	bd830313          	addi	t1,t1,-1064 # ffffffffc020b05c <next_safe.0>
ffffffffc020448c:	00032783          	lw	a5,0(t1)
ffffffffc0204490:	00012417          	auipc	s0,0x12
ffffffffc0204494:	09840413          	addi	s0,s0,152 # ffffffffc0216528 <proc_list>
ffffffffc0204498:	06f55d63          	bge	a0,a5,ffffffffc0204512 <do_fork+0x18e>
    proc->pid = get_pid(); // 返回码->子进程的id号
ffffffffc020449c:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044a0:	45a9                	li	a1,10
ffffffffc02044a2:	2501                	sext.w	a0,a0
ffffffffc02044a4:	5d8000ef          	jal	ra,ffffffffc0204a7c <hash32>
ffffffffc02044a8:	02051793          	slli	a5,a0,0x20
ffffffffc02044ac:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044b0:	0000e797          	auipc	a5,0xe
ffffffffc02044b4:	06878793          	addi	a5,a5,104 # ffffffffc0212518 <hash_list>
ffffffffc02044b8:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044ba:	6510                	ld	a2,8(a0)
ffffffffc02044bc:	0d898793          	addi	a5,s3,216
ffffffffc02044c0:	6414                	ld	a3,8(s0)
    nr_process ++;
ffffffffc02044c2:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044c4:	e21c                	sd	a5,0(a2)
ffffffffc02044c6:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044c8:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link)); // 进程控制块放入hash_list和proc_list 5
ffffffffc02044cc:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044d0:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044d4:	e29c                	sd	a5,0(a3)
    nr_process ++;
ffffffffc02044d6:	2705                	addiw	a4,a4,1
ffffffffc02044d8:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044da:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044de:	0c89b423          	sd	s0,200(s3)
ffffffffc02044e2:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044e4:	0a091b63          	bnez	s2,ffffffffc020459a <do_fork+0x216>
    wakeup_proc(proc); // wakeup_proc函数-子进程变成可执行状态 6
ffffffffc02044e8:	854e                	mv	a0,s3
ffffffffc02044ea:	4cc000ef          	jal	ra,ffffffffc02049b6 <wakeup_proc>
    ret = proc->pid; // set ret vaule using child proc's pid 7
ffffffffc02044ee:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044f2:	70a2                	ld	ra,40(sp)
ffffffffc02044f4:	7402                	ld	s0,32(sp)
ffffffffc02044f6:	64e2                	ld	s1,24(sp)
ffffffffc02044f8:	6942                	ld	s2,16(sp)
ffffffffc02044fa:	69a2                	ld	s3,8(sp)
ffffffffc02044fc:	6a02                	ld	s4,0(sp)
ffffffffc02044fe:	6145                	addi	sp,sp,48
ffffffffc0204500:	8082                	ret
        last_pid = 1;
ffffffffc0204502:	4785                	li	a5,1
ffffffffc0204504:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204508:	4505                	li	a0,1
ffffffffc020450a:	00007317          	auipc	t1,0x7
ffffffffc020450e:	b5230313          	addi	t1,t1,-1198 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204512:	00012417          	auipc	s0,0x12
ffffffffc0204516:	01640413          	addi	s0,s0,22 # ffffffffc0216528 <proc_list>
ffffffffc020451a:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc020451e:	6789                	lui	a5,0x2
ffffffffc0204520:	00f32023          	sw	a5,0(t1)
ffffffffc0204524:	86aa                	mv	a3,a0
ffffffffc0204526:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204528:	6e89                	lui	t4,0x2
ffffffffc020452a:	088e0063          	beq	t3,s0,ffffffffc02045aa <do_fork+0x226>
ffffffffc020452e:	88ae                	mv	a7,a1
ffffffffc0204530:	87f2                	mv	a5,t3
ffffffffc0204532:	6609                	lui	a2,0x2
ffffffffc0204534:	a811                	j	ffffffffc0204548 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204536:	00e6d663          	bge	a3,a4,ffffffffc0204542 <do_fork+0x1be>
ffffffffc020453a:	00c75463          	bge	a4,a2,ffffffffc0204542 <do_fork+0x1be>
ffffffffc020453e:	863a                	mv	a2,a4
ffffffffc0204540:	4885                	li	a7,1
ffffffffc0204542:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204544:	00878d63          	beq	a5,s0,ffffffffc020455e <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc0204548:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020454c:	fed715e3          	bne	a4,a3,ffffffffc0204536 <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204550:	2685                	addiw	a3,a3,1
ffffffffc0204552:	04c6d763          	bge	a3,a2,ffffffffc02045a0 <do_fork+0x21c>
ffffffffc0204556:	679c                	ld	a5,8(a5)
ffffffffc0204558:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020455a:	fe8797e3          	bne	a5,s0,ffffffffc0204548 <do_fork+0x1c4>
ffffffffc020455e:	c581                	beqz	a1,ffffffffc0204566 <do_fork+0x1e2>
ffffffffc0204560:	00d82023          	sw	a3,0(a6)
ffffffffc0204564:	8536                	mv	a0,a3
ffffffffc0204566:	f2088be3          	beqz	a7,ffffffffc020449c <do_fork+0x118>
ffffffffc020456a:	00c32023          	sw	a2,0(t1)
ffffffffc020456e:	b73d                	j	ffffffffc020449c <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204570:	8936                	mv	s2,a3
ffffffffc0204572:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204576:	00000797          	auipc	a5,0x0
ffffffffc020457a:	d2878793          	addi	a5,a5,-728 # ffffffffc020429e <forkret>
ffffffffc020457e:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204582:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204586:	100027f3          	csrr	a5,sstatus
ffffffffc020458a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020458c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020458e:	ec078ee3          	beqz	a5,ffffffffc020446a <do_fork+0xe6>
        intr_disable();
ffffffffc0204592:	830fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204596:	4905                	li	s2,1
ffffffffc0204598:	bdc9                	j	ffffffffc020446a <do_fork+0xe6>
        intr_enable();
ffffffffc020459a:	822fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020459e:	b7a9                	j	ffffffffc02044e8 <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc02045a0:	01d6c363          	blt	a3,t4,ffffffffc02045a6 <do_fork+0x222>
                        last_pid = 1;
ffffffffc02045a4:	4685                	li	a3,1
                    goto repeat;
ffffffffc02045a6:	4585                	li	a1,1
ffffffffc02045a8:	b749                	j	ffffffffc020452a <do_fork+0x1a6>
ffffffffc02045aa:	cda9                	beqz	a1,ffffffffc0204604 <do_fork+0x280>
ffffffffc02045ac:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045b0:	8536                	mv	a0,a3
ffffffffc02045b2:	b5ed                	j	ffffffffc020449c <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045b4:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc02045b8:	c02007b7          	lui	a5,0xc0200
ffffffffc02045bc:	0af6e163          	bltu	a3,a5,ffffffffc020465e <do_fork+0x2da>
ffffffffc02045c0:	00012797          	auipc	a5,0x12
ffffffffc02045c4:	fc07b783          	ld	a5,-64(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045c8:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045cc:	83b1                	srli	a5,a5,0xc
ffffffffc02045ce:	00012717          	auipc	a4,0x12
ffffffffc02045d2:	f9a73703          	ld	a4,-102(a4) # ffffffffc0216568 <npage>
ffffffffc02045d6:	06e7f863          	bgeu	a5,a4,ffffffffc0204646 <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045da:	00003717          	auipc	a4,0x3
ffffffffc02045de:	a7673703          	ld	a4,-1418(a4) # ffffffffc0207050 <nbase>
ffffffffc02045e2:	8f99                	sub	a5,a5,a4
ffffffffc02045e4:	079a                	slli	a5,a5,0x6
ffffffffc02045e6:	00012517          	auipc	a0,0x12
ffffffffc02045ea:	f8a53503          	ld	a0,-118(a0) # ffffffffc0216570 <pages>
ffffffffc02045ee:	953e                	add	a0,a0,a5
ffffffffc02045f0:	4589                	li	a1,2
ffffffffc02045f2:	cccfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045f6:	854e                	mv	a0,s3
ffffffffc02045f8:	b06fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045fc:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045fe:	bdd5                	j	ffffffffc02044f2 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204600:	556d                	li	a0,-5
ffffffffc0204602:	bdc5                	j	ffffffffc02044f2 <do_fork+0x16e>
    return last_pid;
ffffffffc0204604:	00082503          	lw	a0,0(a6)
ffffffffc0204608:	bd51                	j	ffffffffc020449c <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc020460a:	5571                	li	a0,-4
    return ret;
ffffffffc020460c:	b5dd                	j	ffffffffc02044f2 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc020460e:	00002697          	auipc	a3,0x2
ffffffffc0204612:	6a268693          	addi	a3,a3,1698 # ffffffffc0206cb0 <default_pmm_manager+0x1010>
ffffffffc0204616:	00001617          	auipc	a2,0x1
ffffffffc020461a:	2da60613          	addi	a2,a2,730 # ffffffffc02058f0 <commands+0x738>
ffffffffc020461e:	10b00593          	li	a1,267
ffffffffc0204622:	00002517          	auipc	a0,0x2
ffffffffc0204626:	6a650513          	addi	a0,a0,1702 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
ffffffffc020462a:	e1dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020462e:	00001617          	auipc	a2,0x1
ffffffffc0204632:	6aa60613          	addi	a2,a2,1706 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0204636:	06900593          	li	a1,105
ffffffffc020463a:	00001517          	auipc	a0,0x1
ffffffffc020463e:	6c650513          	addi	a0,a0,1734 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0204642:	e05fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204646:	00001617          	auipc	a2,0x1
ffffffffc020464a:	76260613          	addi	a2,a2,1890 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc020464e:	06200593          	li	a1,98
ffffffffc0204652:	00001517          	auipc	a0,0x1
ffffffffc0204656:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc020465a:	dedfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020465e:	00001617          	auipc	a2,0x1
ffffffffc0204662:	72260613          	addi	a2,a2,1826 # ffffffffc0205d80 <default_pmm_manager+0xe0>
ffffffffc0204666:	06e00593          	li	a1,110
ffffffffc020466a:	00001517          	auipc	a0,0x1
ffffffffc020466e:	69650513          	addi	a0,a0,1686 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0204672:	dd5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020468c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020468e:	06f000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc02046ae:	b8a78793          	addi	a5,a5,-1142 # ffffffffc0204234 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046b2:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046b4:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046b6:	ccfff0ef          	jal	ra,ffffffffc0204384 <do_fork>
}
...
ffffffffc02046cc:	61860613          	addi	a2,a2,1560 # ffffffffc0206ce0 <default_pmm_manager+0x1040>
ffffffffc02046d0:	17600593          	li	a1,374
ffffffffc02046d4:	00002517          	auipc	a0,0x2
ffffffffc02046d8:	5f450513          	addi	a0,a0,1524 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
do_exit(int error_code) {
ffffffffc02046dc:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046de:	d69fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02046e4:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046e6:	00012797          	auipc	a5,0x12
ffffffffc02046ea:	e4278793          	addi	a5,a5,-446 # ffffffffc0216528 <proc_list>
...
ffffffffc02046f6:	0000e497          	auipc	s1,0xe
ffffffffc02046fa:	e2248493          	addi	s1,s1,-478 # ffffffffc0212518 <hash_list>
...
ffffffffc0204702:	00012717          	auipc	a4,0x12
ffffffffc0204706:	e1670713          	addi	a4,a4,-490 # ffffffffc0216518 <name.2>
...
ffffffffc0204716:	b27ff0ef          	jal	ra,ffffffffc020423c <alloc_proc>
ffffffffc020471a:	00012917          	auipc	s2,0x12
ffffffffc020471e:	e9e90913          	addi	s2,s2,-354 # ffffffffc02165b8 <idleproc>
...
ffffffffc020472e:	920fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc0204738:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020473a:	7c2000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc020474c:	7da000ef          	jal	ra,ffffffffc0204f26 <memcmp>
ffffffffc0204750:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204752:	453d                	li	a0,15
ffffffffc0204754:	8fafd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020475c:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020475e:	79e000ef          	jal	ra,ffffffffc0204efc <memset>
...
ffffffffc020476e:	7b8000ef          	jal	ra,ffffffffc0204f26 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204772:	00093783          	ld	a5,0(s2)
ffffffffc0204776:	00012717          	auipc	a4,0x12
ffffffffc020477a:	de273703          	ld	a4,-542(a4) # ffffffffc0216558 <boot_cr3>
...
ffffffffc0204788:	00004717          	auipc	a4,0x4
ffffffffc020478c:	87870713          	addi	a4,a4,-1928 # ffffffffc0208000 <bootstack>
...
ffffffffc02047a0:	75c000ef          	jal	ra,ffffffffc0204efc <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047a4:	463d                	li	a2,15
ffffffffc02047a6:	00002597          	auipc	a1,0x2
ffffffffc02047aa:	58258593          	addi	a1,a1,1410 # ffffffffc0206d28 <default_pmm_manager+0x1088>
ffffffffc02047ae:	8522                	mv	a0,s0
ffffffffc02047b0:	75e000ef          	jal	ra,ffffffffc0204f0e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02047b4:	00012717          	auipc	a4,0x12
ffffffffc02047b8:	e1470713          	addi	a4,a4,-492 # ffffffffc02165c8 <nr_process>
...
ffffffffc02047ca:	56a58593          	addi	a1,a1,1386 # ffffffffc0206d30 <default_pmm_manager+0x1090>
ffffffffc02047ce:	00000517          	auipc	a0,0x0
ffffffffc02047d2:	ade50513          	addi	a0,a0,-1314 # ffffffffc02042ac <init_main>
    nr_process ++;
ffffffffc02047d6:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047d8:	00012797          	auipc	a5,0x12
ffffffffc02047dc:	dcd7bc23          	sd	a3,-552(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
...
ffffffffc02047fa:	282000ef          	jal	ra,ffffffffc0204a7c <hash32>
...
ffffffffc0204824:	00012417          	auipc	s0,0x12
ffffffffc0204828:	d9c40413          	addi	s0,s0,-612 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020482c:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020482e:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204830:	6cc000ef          	jal	ra,ffffffffc0204efc <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204834:	463d                	li	a2,15
ffffffffc0204836:	00002597          	auipc	a1,0x2
ffffffffc020483a:	52a58593          	addi	a1,a1,1322 # ffffffffc0206d60 <default_pmm_manager+0x10c0>
ffffffffc020483e:	8526                	mv	a0,s1
ffffffffc0204840:	6ce000ef          	jal	ra,ffffffffc0204f0e <memcpy>
...
ffffffffc02048ac:	46850513          	addi	a0,a0,1128 # ffffffffc0206d10 <default_pmm_manager+0x1070>
ffffffffc02048b0:	8d1fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
...
ffffffffc02048c4:	43860613          	addi	a2,a2,1080 # ffffffffc0206cf8 <default_pmm_manager+0x1058>
ffffffffc02048c8:	18e00593          	li	a1,398
ffffffffc02048cc:	00002517          	auipc	a0,0x2
ffffffffc02048d0:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
ffffffffc02048d4:	b73fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048d8:	00002617          	auipc	a2,0x2
ffffffffc02048dc:	46860613          	addi	a2,a2,1128 # ffffffffc0206d40 <default_pmm_manager+0x10a0>
ffffffffc02048e0:	1ae00593          	li	a1,430
ffffffffc02048e4:	00002517          	auipc	a0,0x2
ffffffffc02048e8:	3e450513          	addi	a0,a0,996 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
ffffffffc02048ec:	b5bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048f0:	00002697          	auipc	a3,0x2
ffffffffc02048f4:	4a068693          	addi	a3,a3,1184 # ffffffffc0206d90 <default_pmm_manager+0x10f0>
ffffffffc02048f8:	00001617          	auipc	a2,0x1
ffffffffc02048fc:	ff860613          	addi	a2,a2,-8 # ffffffffc02058f0 <commands+0x738>
ffffffffc0204900:	1b500593          	li	a1,437
ffffffffc0204904:	00002517          	auipc	a0,0x2
ffffffffc0204908:	3c450513          	addi	a0,a0,964 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
ffffffffc020490c:	b3bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204910:	00002697          	auipc	a3,0x2
ffffffffc0204914:	45868693          	addi	a3,a3,1112 # ffffffffc0206d68 <default_pmm_manager+0x10c8>
ffffffffc0204918:	00001617          	auipc	a2,0x1
ffffffffc020491c:	fd860613          	addi	a2,a2,-40 # ffffffffc02058f0 <commands+0x738>
ffffffffc0204920:	1b400593          	li	a1,436
ffffffffc0204924:	00002517          	auipc	a0,0x2
ffffffffc0204928:	3a450513          	addi	a0,a0,932 # ffffffffc0206cc8 <default_pmm_manager+0x1028>
ffffffffc020492c:	b1bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204936:	00012417          	auipc	s0,0x12
ffffffffc020493a:	c7a40413          	addi	s0,s0,-902 # ffffffffc02165b0 <current>
    while (1) {
...
ffffffffc0204944:	dff5                	beqz	a5,ffffffffc0204940 <cpu_idle+0x10>
            schedule();
ffffffffc0204946:	0a2000ef          	jal	ra,ffffffffc02049e8 <schedule>
ffffffffc020494a:	bfd5                	j	ffffffffc020493e <cpu_idle+0xe>

ffffffffc020494c <switch_to>:
.text
...
ffffffffc020494c:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204950:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204954:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204956:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204958:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020495c:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204960:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204964:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204968:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020496c:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204970:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204974:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204978:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020497c:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204980:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204984:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204988:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020498a:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020498c:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204990:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204994:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204998:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020499c:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02049a0:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02049a4:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02049a8:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02049ac:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049b0:	0685bd83          	ld	s11,104(a1)
...
ffffffffc02049cc:	3f068693          	addi	a3,a3,1008 # ffffffffc0206db8 <default_pmm_manager+0x1118>
ffffffffc02049d0:	00001617          	auipc	a2,0x1
ffffffffc02049d4:	f2060613          	addi	a2,a2,-224 # ffffffffc02058f0 <commands+0x738>
ffffffffc02049d8:	45a5                	li	a1,9
ffffffffc02049da:	00002517          	auipc	a0,0x2
ffffffffc02049de:	41e50513          	addi	a0,a0,1054 # ffffffffc0206df8 <default_pmm_manager+0x1158>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049e2:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049e4:	a63fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204a40:	00a88463          	beq	a7,a0,ffffffffc0204a48 <schedule+0x60>
            proc_run(next);
ffffffffc0204a44:	8dbff0ef          	jal	ra,ffffffffc020431e <proc_run>
    if (flag) {
...
ffffffffc0204a62:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a64:	b59fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc0204a72:	b76d                	j	ffffffffc0204a1c <schedule+0x34>
        intr_disable();
ffffffffc0204a74:	b4ffb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a78:	4405                	li	s0,1
ffffffffc0204a7a:	bfbd                	j	ffffffffc02049f8 <schedule+0x10>

ffffffffc0204a7c <hash32>:
 *
...
ffffffffc0204a7c:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a80:	2785                	addiw	a5,a5,1
ffffffffc0204a82:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a86:	02000793          	li	a5,32
ffffffffc0204a8a:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a8c:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a90:	8082                	ret

ffffffffc0204a92 <printnum>:
 * */
static void
...
ffffffffc0204a92:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a96:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a98:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a9c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a9e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204aa2:	f022                	sd	s0,32(sp)
ffffffffc0204aa4:	ec26                	sd	s1,24(sp)
ffffffffc0204aa6:	e84a                	sd	s2,16(sp)
ffffffffc0204aa8:	f406                	sd	ra,40(sp)
ffffffffc0204aaa:	e44e                	sd	s3,8(sp)
ffffffffc0204aac:	84aa                	mv	s1,a0
ffffffffc0204aae:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204ab0:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204ab4:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204ab6:	03067e63          	bgeu	a2,a6,ffffffffc0204af2 <printnum+0x60>
ffffffffc0204aba:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204abc:	00805763          	blez	s0,ffffffffc0204aca <printnum+0x38>
ffffffffc0204ac0:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204ac2:	85ca                	mv	a1,s2
ffffffffc0204ac4:	854e                	mv	a0,s3
ffffffffc0204ac6:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204ac8:	fc65                	bnez	s0,ffffffffc0204ac0 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aca:	1a02                	slli	s4,s4,0x20
ffffffffc0204acc:	00002797          	auipc	a5,0x2
ffffffffc0204ad0:	34478793          	addi	a5,a5,836 # ffffffffc0206e10 <default_pmm_manager+0x1170>
ffffffffc0204ad4:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ad8:	9a3e                	add	s4,s4,a5
}
ffffffffc0204ada:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204adc:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204ae0:	70a2                	ld	ra,40(sp)
ffffffffc0204ae2:	69a2                	ld	s3,8(sp)
ffffffffc0204ae4:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ae6:	85ca                	mv	a1,s2
ffffffffc0204ae8:	87a6                	mv	a5,s1
}
ffffffffc0204aea:	6942                	ld	s2,16(sp)
ffffffffc0204aec:	64e2                	ld	s1,24(sp)
ffffffffc0204aee:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204af0:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204af2:	03065633          	divu	a2,a2,a6
ffffffffc0204af6:	8722                	mv	a4,s0
ffffffffc0204af8:	f9bff0ef          	jal	ra,ffffffffc0204a92 <printnum>
ffffffffc0204afc:	b7f9                	j	ffffffffc0204aca <printnum+0x38>

ffffffffc0204afe <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204afe:	7119                	addi	sp,sp,-128
ffffffffc0204b00:	f4a6                	sd	s1,104(sp)
ffffffffc0204b02:	f0ca                	sd	s2,96(sp)
ffffffffc0204b04:	ecce                	sd	s3,88(sp)
ffffffffc0204b06:	e8d2                	sd	s4,80(sp)
ffffffffc0204b08:	e4d6                	sd	s5,72(sp)
ffffffffc0204b0a:	e0da                	sd	s6,64(sp)
ffffffffc0204b0c:	fc5e                	sd	s7,56(sp)
ffffffffc0204b0e:	f06a                	sd	s10,32(sp)
ffffffffc0204b10:	fc86                	sd	ra,120(sp)
ffffffffc0204b12:	f8a2                	sd	s0,112(sp)
ffffffffc0204b14:	f862                	sd	s8,48(sp)
ffffffffc0204b16:	f466                	sd	s9,40(sp)
ffffffffc0204b18:	ec6e                	sd	s11,24(sp)
ffffffffc0204b1a:	892a                	mv	s2,a0
ffffffffc0204b1c:	84ae                	mv	s1,a1
ffffffffc0204b1e:	8d32                	mv	s10,a2
ffffffffc0204b20:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b22:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204b26:	5b7d                	li	s6,-1
ffffffffc0204b28:	00002a97          	auipc	s5,0x2
ffffffffc0204b2c:	314a8a93          	addi	s5,s5,788 # ffffffffc0206e3c <default_pmm_manager+0x119c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b30:	00002b97          	auipc	s7,0x2
ffffffffc0204b34:	4e8b8b93          	addi	s7,s7,1256 # ffffffffc0207018 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b38:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b3c:	001d0413          	addi	s0,s10,1
ffffffffc0204b40:	01350a63          	beq	a0,s3,ffffffffc0204b54 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b44:	c121                	beqz	a0,ffffffffc0204b84 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b50:	ff351ae3          	bne	a0,s3,ffffffffc0204b44 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b54:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b58:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b5c:	4c81                	li	s9,0
ffffffffc0204b5e:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b60:	5c7d                	li	s8,-1
ffffffffc0204b62:	5dfd                	li	s11,-1
ffffffffc0204b64:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b68:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b6a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b6e:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b72:	00140d13          	addi	s10,s0,1
ffffffffc0204b76:	04b56263          	bltu	a0,a1,ffffffffc0204bba <vprintfmt+0xbc>
ffffffffc0204b7a:	058a                	slli	a1,a1,0x2
ffffffffc0204b7c:	95d6                	add	a1,a1,s5
ffffffffc0204b7e:	4194                	lw	a3,0(a1)
ffffffffc0204b80:	96d6                	add	a3,a3,s5
...
ffffffffc0204ba0:	8082                	ret
            padc = '0';
ffffffffc0204ba2:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204ba4:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba8:	846a                	mv	s0,s10
ffffffffc0204baa:	00140d13          	addi	s10,s0,1
ffffffffc0204bae:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204bb2:	0ff5f593          	zext.b	a1,a1
ffffffffc0204bb6:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b7a <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204bba:	85a6                	mv	a1,s1
ffffffffc0204bbc:	02500513          	li	a0,37
ffffffffc0204bc0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bc2:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bc6:	8d22                	mv	s10,s0
ffffffffc0204bc8:	f73788e3          	beq	a5,s3,ffffffffc0204b38 <vprintfmt+0x3a>
ffffffffc0204bcc:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bd0:	1d7d                	addi	s10,s10,-1
ffffffffc0204bd2:	ff379de3          	bne	a5,s3,ffffffffc0204bcc <vprintfmt+0xce>
ffffffffc0204bd6:	b78d                	j	ffffffffc0204b38 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bd8:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bdc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be0:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204be2:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204be6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bea:	02d86463          	bltu	a6,a3,ffffffffc0204c12 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bee:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bf2:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bf6:	0186873b          	addw	a4,a3,s8
ffffffffc0204bfa:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bfe:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204c00:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c04:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c06:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204c0a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c0e:	fed870e3          	bgeu	a6,a3,ffffffffc0204bee <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c12:	f40ddce3          	bgez	s11,ffffffffc0204b6a <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c16:	8de2                	mv	s11,s8
ffffffffc0204c18:	5c7d                	li	s8,-1
ffffffffc0204c1a:	bf81                	j	ffffffffc0204b6a <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c1c:	fffdc693          	not	a3,s11
ffffffffc0204c20:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c22:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c26:	00144603          	lbu	a2,1(s0)
ffffffffc0204c2a:	2d81                	sext.w	s11,s11
ffffffffc0204c2c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c2e:	bf35                	j	ffffffffc0204b6a <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c30:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c34:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c38:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c3a:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c3c:	bfd9                	j	ffffffffc0204c12 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c3e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c40:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c44:	01174463          	blt	a4,a7,ffffffffc0204c4c <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c48:	1a088e63          	beqz	a7,ffffffffc0204e04 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c4c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c50:	46c1                	li	a3,16
ffffffffc0204c52:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c54:	2781                	sext.w	a5,a5
ffffffffc0204c56:	876e                	mv	a4,s11
ffffffffc0204c58:	85a6                	mv	a1,s1
ffffffffc0204c5a:	854a                	mv	a0,s2
ffffffffc0204c5c:	e37ff0ef          	jal	ra,ffffffffc0204a92 <printnum>
            break;
ffffffffc0204c60:	bde1                	j	ffffffffc0204b38 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c62:	000a2503          	lw	a0,0(s4)
ffffffffc0204c66:	85a6                	mv	a1,s1
ffffffffc0204c68:	0a21                	addi	s4,s4,8
ffffffffc0204c6a:	9902                	jalr	s2
            break;
ffffffffc0204c6c:	b5f1                	j	ffffffffc0204b38 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c6e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c70:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c74:	01174463          	blt	a4,a7,ffffffffc0204c7c <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c78:	18088163          	beqz	a7,ffffffffc0204dfa <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c7c:	000a3603          	ld	a2,0(s4)
ffffffffc0204c80:	46a9                	li	a3,10
ffffffffc0204c82:	8a2e                	mv	s4,a1
ffffffffc0204c84:	bfc1                	j	ffffffffc0204c54 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c86:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c8a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c8c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c8e:	bdf1                	j	ffffffffc0204b6a <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c90:	85a6                	mv	a1,s1
ffffffffc0204c92:	02500513          	li	a0,37
ffffffffc0204c96:	9902                	jalr	s2
            break;
ffffffffc0204c98:	b545                	j	ffffffffc0204b38 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c9a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c9e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ca0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ca2:	b5e1                	j	ffffffffc0204b6a <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204ca4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204ca6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204caa:	01174463          	blt	a4,a7,ffffffffc0204cb2 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204cae:	14088163          	beqz	a7,ffffffffc0204df0 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204cb2:	000a3603          	ld	a2,0(s4)
ffffffffc0204cb6:	46a1                	li	a3,8
ffffffffc0204cb8:	8a2e                	mv	s4,a1
ffffffffc0204cba:	bf69                	j	ffffffffc0204c54 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204cbc:	03000513          	li	a0,48
ffffffffc0204cc0:	85a6                	mv	a1,s1
ffffffffc0204cc2:	e03e                	sd	a5,0(sp)
ffffffffc0204cc4:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204cc6:	85a6                	mv	a1,s1
ffffffffc0204cc8:	07800513          	li	a0,120
ffffffffc0204ccc:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cce:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cd0:	6782                	ld	a5,0(sp)
ffffffffc0204cd2:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cd4:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cd8:	bfb5                	j	ffffffffc0204c54 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cda:	000a3403          	ld	s0,0(s4)
ffffffffc0204cde:	008a0713          	addi	a4,s4,8
ffffffffc0204ce2:	e03a                	sd	a4,0(sp)
ffffffffc0204ce4:	14040263          	beqz	s0,ffffffffc0204e28 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204ce8:	0fb05763          	blez	s11,ffffffffc0204dd6 <vprintfmt+0x2d8>
ffffffffc0204cec:	02d00693          	li	a3,45
ffffffffc0204cf0:	0cd79163          	bne	a5,a3,ffffffffc0204db2 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cf4:	00044783          	lbu	a5,0(s0)
ffffffffc0204cf8:	0007851b          	sext.w	a0,a5
ffffffffc0204cfc:	cf85                	beqz	a5,ffffffffc0204d34 <vprintfmt+0x236>
ffffffffc0204cfe:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d02:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d06:	000c4563          	bltz	s8,ffffffffc0204d10 <vprintfmt+0x212>
ffffffffc0204d0a:	3c7d                	addiw	s8,s8,-1
ffffffffc0204d0c:	036c0263          	beq	s8,s6,ffffffffc0204d30 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d10:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d12:	0e0c8e63          	beqz	s9,ffffffffc0204e0e <vprintfmt+0x310>
ffffffffc0204d16:	3781                	addiw	a5,a5,-32
ffffffffc0204d18:	0ef47b63          	bgeu	s0,a5,ffffffffc0204e0e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d1c:	03f00513          	li	a0,63
ffffffffc0204d20:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d22:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d26:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d28:	0a05                	addi	s4,s4,1
ffffffffc0204d2a:	0007851b          	sext.w	a0,a5
ffffffffc0204d2e:	ffe1                	bnez	a5,ffffffffc0204d06 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d30:	01b05963          	blez	s11,ffffffffc0204d42 <vprintfmt+0x244>
...
ffffffffc0204d3c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d3e:	fe0d9be3          	bnez	s11,ffffffffc0204d34 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d42:	6a02                	ld	s4,0(sp)
ffffffffc0204d44:	bbd5                	j	ffffffffc0204b38 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d46:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d48:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d4c:	01174463          	blt	a4,a7,ffffffffc0204d54 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d50:	08088d63          	beqz	a7,ffffffffc0204dea <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d54:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d58:	0a044d63          	bltz	s0,ffffffffc0204e12 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d5c:	8622                	mv	a2,s0
ffffffffc0204d5e:	8a66                	mv	s4,s9
ffffffffc0204d60:	46a9                	li	a3,10
ffffffffc0204d62:	bdcd                	j	ffffffffc0204c54 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d64:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d68:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d6a:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d6c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d70:	8fb5                	xor	a5,a5,a3
ffffffffc0204d72:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d76:	02d74163          	blt	a4,a3,ffffffffc0204d98 <vprintfmt+0x29a>
ffffffffc0204d7a:	00369793          	slli	a5,a3,0x3
ffffffffc0204d7e:	97de                	add	a5,a5,s7
ffffffffc0204d80:	639c                	ld	a5,0(a5)
ffffffffc0204d82:	cb99                	beqz	a5,ffffffffc0204d98 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d84:	86be                	mv	a3,a5
ffffffffc0204d86:	00000617          	auipc	a2,0x0
ffffffffc0204d8a:	1f260613          	addi	a2,a2,498 # ffffffffc0204f78 <etext+0x2e>
ffffffffc0204d8e:	85a6                	mv	a1,s1
ffffffffc0204d90:	854a                	mv	a0,s2
ffffffffc0204d92:	0ce000ef          	jal	ra,ffffffffc0204e60 <printfmt>
ffffffffc0204d96:	b34d                	j	ffffffffc0204b38 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d98:	00002617          	auipc	a2,0x2
ffffffffc0204d9c:	09860613          	addi	a2,a2,152 # ffffffffc0206e30 <default_pmm_manager+0x1190>
ffffffffc0204da0:	85a6                	mv	a1,s1
ffffffffc0204da2:	854a                	mv	a0,s2
ffffffffc0204da4:	0bc000ef          	jal	ra,ffffffffc0204e60 <printfmt>
ffffffffc0204da8:	bb41                	j	ffffffffc0204b38 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204daa:	00002417          	auipc	s0,0x2
ffffffffc0204dae:	07e40413          	addi	s0,s0,126 # ffffffffc0206e28 <default_pmm_manager+0x1188>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204db2:	85e2                	mv	a1,s8
ffffffffc0204db4:	8522                	mv	a0,s0
ffffffffc0204db6:	e43e                	sd	a5,8(sp)
ffffffffc0204db8:	0e2000ef          	jal	ra,ffffffffc0204e9a <strnlen>
ffffffffc0204dbc:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204dc0:	01b05b63          	blez	s11,ffffffffc0204dd6 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204dc4:	67a2                	ld	a5,8(sp)
ffffffffc0204dc6:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dca:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dcc:	85a6                	mv	a1,s1
ffffffffc0204dce:	8552                	mv	a0,s4
ffffffffc0204dd0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dd2:	fe0d9ce3          	bnez	s11,ffffffffc0204dca <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dd6:	00044783          	lbu	a5,0(s0)
ffffffffc0204dda:	00140a13          	addi	s4,s0,1
ffffffffc0204dde:	0007851b          	sext.w	a0,a5
ffffffffc0204de2:	d3a5                	beqz	a5,ffffffffc0204d42 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204de4:	05e00413          	li	s0,94
ffffffffc0204de8:	bf39                	j	ffffffffc0204d06 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dea:	000a2403          	lw	s0,0(s4)
ffffffffc0204dee:	b7ad                	j	ffffffffc0204d58 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204df0:	000a6603          	lwu	a2,0(s4)
ffffffffc0204df4:	46a1                	li	a3,8
ffffffffc0204df6:	8a2e                	mv	s4,a1
ffffffffc0204df8:	bdb1                	j	ffffffffc0204c54 <vprintfmt+0x156>
ffffffffc0204dfa:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dfe:	46a9                	li	a3,10
ffffffffc0204e00:	8a2e                	mv	s4,a1
ffffffffc0204e02:	bd89                	j	ffffffffc0204c54 <vprintfmt+0x156>
ffffffffc0204e04:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e08:	46c1                	li	a3,16
ffffffffc0204e0a:	8a2e                	mv	s4,a1
ffffffffc0204e0c:	b5a1                	j	ffffffffc0204c54 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204e0e:	9902                	jalr	s2
ffffffffc0204e10:	bf09                	j	ffffffffc0204d22 <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc0204e1e:	8a66                	mv	s4,s9
ffffffffc0204e20:	40800633          	neg	a2,s0
ffffffffc0204e24:	46a9                	li	a3,10
ffffffffc0204e26:	b53d                	j	ffffffffc0204c54 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e28:	03b05163          	blez	s11,ffffffffc0204e4a <vprintfmt+0x34c>
ffffffffc0204e2c:	02d00693          	li	a3,45
ffffffffc0204e30:	f6d79de3          	bne	a5,a3,ffffffffc0204daa <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e34:	00002417          	auipc	s0,0x2
ffffffffc0204e38:	ff440413          	addi	s0,s0,-12 # ffffffffc0206e28 <default_pmm_manager+0x1188>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e3c:	02800793          	li	a5,40
ffffffffc0204e40:	02800513          	li	a0,40
ffffffffc0204e44:	00140a13          	addi	s4,s0,1
ffffffffc0204e48:	bd6d                	j	ffffffffc0204d02 <vprintfmt+0x204>
ffffffffc0204e4a:	00002a17          	auipc	s4,0x2
ffffffffc0204e4e:	fdfa0a13          	addi	s4,s4,-33 # ffffffffc0206e29 <default_pmm_manager+0x1189>
ffffffffc0204e52:	02800513          	li	a0,40
ffffffffc0204e56:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e5a:	05e00413          	li	s0,94
ffffffffc0204e5e:	b565                	j	ffffffffc0204d06 <vprintfmt+0x208>

ffffffffc0204e60 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e60:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e62:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e66:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e68:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e6a:	ec06                	sd	ra,24(sp)
ffffffffc0204e6c:	f83a                	sd	a4,48(sp)
ffffffffc0204e6e:	fc3e                	sd	a5,56(sp)
ffffffffc0204e70:	e0c2                	sd	a6,64(sp)
ffffffffc0204e72:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e74:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e76:	c89ff0ef          	jal	ra,ffffffffc0204afe <vprintfmt>
}
ffffffffc0204e7a:	60e2                	ld	ra,24(sp)
ffffffffc0204e7c:	6161                	addi	sp,sp,80
ffffffffc0204e7e:	8082                	ret

ffffffffc0204e80 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204e80:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204e84:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e86:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e88:	cb81                	beqz	a5,ffffffffc0204e98 <strlen+0x18>
        cnt ++;
ffffffffc0204e8a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e8c:	00a707b3          	add	a5,a4,a0
ffffffffc0204e90:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e94:	fbfd                	bnez	a5,ffffffffc0204e8a <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e9a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e9c:	e589                	bnez	a1,ffffffffc0204ea6 <strnlen+0xc>
ffffffffc0204e9e:	a811                	j	ffffffffc0204eb2 <strnlen+0x18>
        cnt ++;
ffffffffc0204ea0:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204ea2:	00f58863          	beq	a1,a5,ffffffffc0204eb2 <strnlen+0x18>
ffffffffc0204ea6:	00f50733          	add	a4,a0,a5
ffffffffc0204eaa:	00074703          	lbu	a4,0(a4)
ffffffffc0204eae:	fb6d                	bnez	a4,ffffffffc0204ea0 <strnlen+0x6>
ffffffffc0204eb0:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204eb2:	852e                	mv	a0,a1
ffffffffc0204eb4:	8082                	ret

ffffffffc0204eb6 <strcpy>:
char *
...
ffffffffc0204ebc:	0785                	addi	a5,a5,1
ffffffffc0204ebe:	0585                	addi	a1,a1,1
ffffffffc0204ec0:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204ec4:	fb75                	bnez	a4,ffffffffc0204eb8 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204ecc:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ed0:	cb89                	beqz	a5,ffffffffc0204ee2 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ed2:	0505                	addi	a0,a0,1
ffffffffc0204ed4:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ed6:	fee789e3          	beq	a5,a4,ffffffffc0204ec8 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eda:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ede:	9d19                	subw	a0,a0,a4
ffffffffc0204ee0:	8082                	ret
ffffffffc0204ee2:	4501                	li	a0,0
ffffffffc0204ee4:	bfed                	j	ffffffffc0204ede <strcmp+0x16>
...
ffffffffc0204eea:	c799                	beqz	a5,ffffffffc0204ef8 <strchr+0x12>
        if (*s == c) {
ffffffffc0204eec:	00f58763          	beq	a1,a5,ffffffffc0204efa <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ef0:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204ef4:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204ef6:	fbfd                	bnez	a5,ffffffffc0204eec <strchr+0x6>
    }
    return NULL;
...
ffffffffc0204f12:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f14:	0005c703          	lbu	a4,0(a1)
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f26:	c205                	beqz	a2,ffffffffc0204f46 <memcmp+0x20>
ffffffffc0204f28:	962e                	add	a2,a2,a1
ffffffffc0204f2a:	a019                	j	ffffffffc0204f30 <memcmp+0xa>
ffffffffc0204f2c:	00c58d63          	beq	a1,a2,ffffffffc0204f46 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204f34:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204f38:	0505                	addi	a0,a0,1
ffffffffc0204f3a:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f3c:	fee788e3          	beq	a5,a4,ffffffffc0204f2c <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f40:	40e7853b          	subw	a0,a5,a4
