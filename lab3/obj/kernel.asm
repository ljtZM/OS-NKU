...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	372040ef          	jal	ra,ffffffffc02043bc <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	39a58593          	addi	a1,a1,922 # ffffffffc02043e8 <etext+0x2>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3b250513          	addi	a0,a0,946 # ffffffffc0204408 <etext+0x22>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	65d030ef          	jal	ra,ffffffffc0203f0a <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	627030ef          	jal	ra,ffffffffc0203f0a <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	30c50513          	addi	a0,a0,780 # ffffffffc0204410 <etext+0x2a>
void print_kerninfo(void) {
...
ffffffffc020011e:	31650513          	addi	a0,a0,790 # ffffffffc0204430 <etext+0x4a>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2c058593          	addi	a1,a1,704 # ffffffffc02043e6 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	32250513          	addi	a0,a0,802 # ffffffffc0204450 <etext+0x6a>
...
ffffffffc0200146:	32e50513          	addi	a0,a0,814 # ffffffffc0204470 <etext+0x8a>
...
ffffffffc020015a:	33a50513          	addi	a0,a0,826 # ffffffffc0204490 <etext+0xaa>
...
ffffffffc0200188:	32c50513          	addi	a0,a0,812 # ffffffffc02044b0 <etext+0xca>
}
...
ffffffffc0200196:	34e60613          	addi	a2,a2,846 # ffffffffc02044e0 <etext+0xfa>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	35a50513          	addi	a0,a0,858 # ffffffffc02044f8 <etext+0x112>
void print_stackframe(void) {
...
ffffffffc02001b2:	36260613          	addi	a2,a2,866 # ffffffffc0204510 <etext+0x12a>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	37a58593          	addi	a1,a1,890 # ffffffffc0204530 <etext+0x14a>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	37a50513          	addi	a0,a0,890 # ffffffffc0204538 <etext+0x152>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	37c60613          	addi	a2,a2,892 # ffffffffc0204548 <etext+0x162>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	39c58593          	addi	a1,a1,924 # ffffffffc0204570 <etext+0x18a>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	35c50513          	addi	a0,a0,860 # ffffffffc0204538 <etext+0x152>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	39860613          	addi	a2,a2,920 # ffffffffc0204580 <etext+0x19a>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3b058593          	addi	a1,a1,944 # ffffffffc02045a0 <etext+0x1ba>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	34050513          	addi	a0,a0,832 # ffffffffc0204538 <etext+0x152>
...
ffffffffc0200236:	37e50513          	addi	a0,a0,894 # ffffffffc02045b0 <etext+0x1ca>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	38450513          	addi	a0,a0,900 # ffffffffc02045d8 <etext+0x1f2>
...
ffffffffc020027e:	38648493          	addi	s1,s1,902 # ffffffffc0204600 <etext+0x21a>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	384b0b13          	addi	s6,s6,900 # ffffffffc0204608 <etext+0x222>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2a4a0a13          	addi	s4,s4,676 # ffffffffc0204530 <etext+0x14a>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7f5030ef          	jal	ra,ffffffffc020428c <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0cc040ef          	jal	ra,ffffffffc0204388 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0b8040ef          	jal	ra,ffffffffc0204388 <strcmp>
...
ffffffffc020030e:	098040ef          	jal	ra,ffffffffc02043a6 <strchr>
...
ffffffffc020034c:	05a040ef          	jal	ra,ffffffffc02043a6 <strchr>
...
ffffffffc020036a:	2c250513          	addi	a0,a0,706 # ffffffffc0204628 <etext+0x242>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	717030ef          	jal	ra,ffffffffc02043ce <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6f3030ef          	jal	ra,ffffffffc02043ce <memcpy>
    return 0;
}
...
ffffffffc0200b6e:	68e5b583          	ld	a1,1678(a1) # ffffffffc02061f8 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	68a63603          	ld	a2,1674(a2) # ffffffffc0206200 <nbase>
...
ffffffffc0201722:	adab3b03          	ld	s6,-1318(s6) # ffffffffc02061f8 <error_string+0x38>
...
ffffffffc0201760:	45d020ef          	jal	ra,ffffffffc02043bc <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	a2cb3b03          	ld	s6,-1492(s6) # ffffffffc02061f8 <error_string+0x38>
...
ffffffffc0201802:	3bb020ef          	jal	ra,ffffffffc02043bc <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02019f8:	80443403          	ld	s0,-2044(s0) # ffffffffc02061f8 <error_string+0x38>
...
ffffffffc0201dfe:	3fecbc83          	ld	s9,1022(s9) # ffffffffc02061f8 <error_string+0x38>
...
ffffffffc0201f60:	416020ef          	jal	ra,ffffffffc0204376 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	41c020ef          	jal	ra,ffffffffc0204388 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	39a020ef          	jal	ra,ffffffffc0204340 <strlen>
...
ffffffffc02027a4:	a586b683          	ld	a3,-1448(a3) # ffffffffc02061f8 <error_string+0x38>
...
ffffffffc0202ba0:	664c0c13          	addi	s8,s8,1636 # ffffffffc0206200 <nbase>
...
ffffffffc02031f6:	7a668693          	addi	a3,a3,1958 # ffffffffc0205998 <default_pmm_manager+0x870>
ffffffffc02031fa:	00002617          	auipc	a2,0x2
ffffffffc02031fe:	b7e60613          	addi	a2,a2,-1154 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203202:	09000593          	li	a1,144
ffffffffc0203206:	00003517          	auipc	a0,0x3
ffffffffc020320a:	94250513          	addi	a0,a0,-1726 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020320e:	966fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203212:	00003697          	auipc	a3,0x3
ffffffffc0203216:	98668693          	addi	a3,a3,-1658 # ffffffffc0205b98 <default_pmm_manager+0xa70>
ffffffffc020321a:	00002617          	auipc	a2,0x2
ffffffffc020321e:	b5e60613          	addi	a2,a2,-1186 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203222:	0a700593          	li	a1,167
ffffffffc0203226:	00003517          	auipc	a0,0x3
ffffffffc020322a:	92250513          	addi	a0,a0,-1758 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020322e:	946fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203232:	00003697          	auipc	a3,0x3
ffffffffc0203236:	93e68693          	addi	a3,a3,-1730 # ffffffffc0205b70 <default_pmm_manager+0xa48>
ffffffffc020323a:	00002617          	auipc	a2,0x2
ffffffffc020323e:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203242:	0a500593          	li	a1,165
ffffffffc0203246:	00003517          	auipc	a0,0x3
ffffffffc020324a:	90250513          	addi	a0,a0,-1790 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020324e:	926fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203252:	00003697          	auipc	a3,0x3
ffffffffc0203256:	90e68693          	addi	a3,a3,-1778 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc020325a:	00002617          	auipc	a2,0x2
ffffffffc020325e:	b1e60613          	addi	a2,a2,-1250 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203262:	0a400593          	li	a1,164
ffffffffc0203266:	00003517          	auipc	a0,0x3
ffffffffc020326a:	8e250513          	addi	a0,a0,-1822 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020326e:	906fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203272:	00003697          	auipc	a3,0x3
ffffffffc0203276:	8ee68693          	addi	a3,a3,-1810 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc020327a:	00002617          	auipc	a2,0x2
ffffffffc020327e:	afe60613          	addi	a2,a2,-1282 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203282:	0a200593          	li	a1,162
ffffffffc0203286:	00003517          	auipc	a0,0x3
ffffffffc020328a:	8c250513          	addi	a0,a0,-1854 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020328e:	8e6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203292:	00003697          	auipc	a3,0x3
ffffffffc0203296:	8ce68693          	addi	a3,a3,-1842 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc020329a:	00002617          	auipc	a2,0x2
ffffffffc020329e:	ade60613          	addi	a2,a2,-1314 # ffffffffc0204d78 <commands+0x738>
ffffffffc02032a2:	0a000593          	li	a1,160
ffffffffc02032a6:	00003517          	auipc	a0,0x3
ffffffffc02032aa:	8a250513          	addi	a0,a0,-1886 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc02032ae:	8c6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032b2:	00003697          	auipc	a3,0x3
ffffffffc02032b6:	8ae68693          	addi	a3,a3,-1874 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc02032ba:	00002617          	auipc	a2,0x2
ffffffffc02032be:	abe60613          	addi	a2,a2,-1346 # ffffffffc0204d78 <commands+0x738>
ffffffffc02032c2:	09e00593          	li	a1,158
ffffffffc02032c6:	00003517          	auipc	a0,0x3
ffffffffc02032ca:	88250513          	addi	a0,a0,-1918 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc02032ce:	8a6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032d2:	00003697          	auipc	a3,0x3
ffffffffc02032d6:	88e68693          	addi	a3,a3,-1906 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc02032da:	00002617          	auipc	a2,0x2
ffffffffc02032de:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0204d78 <commands+0x738>
ffffffffc02032e2:	09c00593          	li	a1,156
ffffffffc02032e6:	00003517          	auipc	a0,0x3
ffffffffc02032ea:	86250513          	addi	a0,a0,-1950 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc02032ee:	886fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032f2:	00003697          	auipc	a3,0x3
ffffffffc02032f6:	86e68693          	addi	a3,a3,-1938 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc02032fa:	00002617          	auipc	a2,0x2
ffffffffc02032fe:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203302:	09a00593          	li	a1,154
ffffffffc0203306:	00003517          	auipc	a0,0x3
ffffffffc020330a:	84250513          	addi	a0,a0,-1982 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020330e:	866fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203312:	00003697          	auipc	a3,0x3
ffffffffc0203316:	84e68693          	addi	a3,a3,-1970 # ffffffffc0205b60 <default_pmm_manager+0xa38>
ffffffffc020331a:	00002617          	auipc	a2,0x2
ffffffffc020331e:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203322:	09800593          	li	a1,152
ffffffffc0203326:	00003517          	auipc	a0,0x3
ffffffffc020332a:	82250513          	addi	a0,a0,-2014 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020332e:	846fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203332:	00002697          	auipc	a3,0x2
ffffffffc0203336:	66668693          	addi	a3,a3,1638 # ffffffffc0205998 <default_pmm_manager+0x870>
ffffffffc020333a:	00002617          	auipc	a2,0x2
ffffffffc020333e:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203342:	09600593          	li	a1,150
ffffffffc0203346:	00003517          	auipc	a0,0x3
ffffffffc020334a:	80250513          	addi	a0,a0,-2046 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020334e:	826fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203352:	00002697          	auipc	a3,0x2
ffffffffc0203356:	64668693          	addi	a3,a3,1606 # ffffffffc0205998 <default_pmm_manager+0x870>
ffffffffc020335a:	00002617          	auipc	a2,0x2
ffffffffc020335e:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203362:	09400593          	li	a1,148
ffffffffc0203366:	00002517          	auipc	a0,0x2
ffffffffc020336a:	7e250513          	addi	a0,a0,2018 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc020336e:	806fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203372:	00002697          	auipc	a3,0x2
ffffffffc0203376:	62668693          	addi	a3,a3,1574 # ffffffffc0205998 <default_pmm_manager+0x870>
ffffffffc020337a:	00002617          	auipc	a2,0x2
ffffffffc020337e:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203382:	09200593          	li	a1,146
ffffffffc0203386:	00002517          	auipc	a0,0x2
ffffffffc020338a:	7c250513          	addi	a0,a0,1986 # ffffffffc0205b48 <default_pmm_manager+0xa20>
...
ffffffffc0203396:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc0203398:	c7b1                	beqz	a5,ffffffffc02033e4 <_clock_swap_out_victim+0x52>
     assert(in_tick==0);
ffffffffc020339a:	e62d                	bnez	a2,ffffffffc0203404 <_clock_swap_out_victim+0x72>
    return listelm->prev;
ffffffffc020339c:	639c                	ld	a5,0(a5)
ffffffffc020339e:	882e                	mv	a6,a1
        if (p->visited == 0){
ffffffffc02033a0:	fe07b703          	ld	a4,-32(a5)
ffffffffc02033a4:	cb11                	beqz	a4,ffffffffc02033b8 <_clock_swap_out_victim+0x26>
        if (p->visited == 1){
ffffffffc02033a6:	4685                	li	a3,1
ffffffffc02033a8:	00d71463          	bne	a4,a3,ffffffffc02033b0 <_clock_swap_out_victim+0x1e>
            p->visited = 0;
ffffffffc02033ac:	fe07b023          	sd	zero,-32(a5)
ffffffffc02033b0:	639c                	ld	a5,0(a5)
        if (p->visited == 0){
ffffffffc02033b2:	fe07b703          	ld	a4,-32(a5)
ffffffffc02033b6:	fb6d                	bnez	a4,ffffffffc02033a8 <_clock_swap_out_victim+0x16>
    __list_del(listelm->prev, listelm->next);
ffffffffc02033b8:	6398                	ld	a4,0(a5)
        struct Page *p = le2page(entry, pra_page_link);
ffffffffc02033ba:	fd078693          	addi	a3,a5,-48
ffffffffc02033be:	679c                	ld	a5,8(a5)
            cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc02033c0:	0000e597          	auipc	a1,0xe
ffffffffc02033c4:	1985b583          	ld	a1,408(a1) # ffffffffc0211558 <curr_ptr>
ffffffffc02033c8:	00003517          	auipc	a0,0x3
ffffffffc02033cc:	80050513          	addi	a0,a0,-2048 # ffffffffc0205bc8 <default_pmm_manager+0xaa0>
    prev->next = next;
ffffffffc02033d0:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02033d2:	e398                	sd	a4,0(a5)
            *ptr_page = p;
ffffffffc02033d4:	00d83023          	sd	a3,0(a6)
            cprintf("curr_ptr %p\n", curr_ptr);
...
ffffffffc02033e8:	7c468693          	addi	a3,a3,1988 # ffffffffc0205ba8 <default_pmm_manager+0xa80>
ffffffffc02033ec:	00002617          	auipc	a2,0x2
ffffffffc02033f0:	98c60613          	addi	a2,a2,-1652 # ffffffffc0204d78 <commands+0x738>
ffffffffc02033f4:	04c00593          	li	a1,76
ffffffffc02033f8:	00002517          	auipc	a0,0x2
ffffffffc02033fc:	75050513          	addi	a0,a0,1872 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc0203400:	f75fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203404:	00002697          	auipc	a3,0x2
ffffffffc0203408:	7b468693          	addi	a3,a3,1972 # ffffffffc0205bb8 <default_pmm_manager+0xa90>
ffffffffc020340c:	00002617          	auipc	a2,0x2
ffffffffc0203410:	96c60613          	addi	a2,a2,-1684 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203414:	04d00593          	li	a1,77
ffffffffc0203418:	00002517          	auipc	a0,0x2
ffffffffc020341c:	73050513          	addi	a0,a0,1840 # ffffffffc0205b48 <default_pmm_manager+0xa20>
ffffffffc0203420:	f55fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203424 <_clock_init_mm>:
{     
ffffffffc0203424:	1141                	addi	sp,sp,-16
ffffffffc0203426:	e406                	sd	ra,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0203428:	0000e597          	auipc	a1,0xe
ffffffffc020342c:	cc058593          	addi	a1,a1,-832 # ffffffffc02110e8 <pra_list_head>
    mm->sm_priv = &pra_list_head;
ffffffffc0203430:	f50c                	sd	a1,40(a0)
    cprintf(" mm->sm_priv %x in fifo_init_mm\n",mm->sm_priv);
ffffffffc0203432:	00002517          	auipc	a0,0x2
ffffffffc0203436:	7a650513          	addi	a0,a0,1958 # ffffffffc0205bd8 <default_pmm_manager+0xab0>
ffffffffc020343a:	e58c                	sd	a1,8(a1)
ffffffffc020343c:	e18c                	sd	a1,0(a1)
    curr_ptr = &pra_list_head;
ffffffffc020343e:	0000e797          	auipc	a5,0xe
ffffffffc0203442:	10b7bd23          	sd	a1,282(a5) # ffffffffc0211558 <curr_ptr>
    cprintf(" mm->sm_priv %x in fifo_init_mm\n",mm->sm_priv);
ffffffffc0203446:	c75fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020344a:	60a2                	ld	ra,8(sp)
ffffffffc020344c:	4501                	li	a0,0
ffffffffc020344e:	0141                	addi	sp,sp,16
ffffffffc0203450:	8082                	ret

ffffffffc0203452 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203452:	0000e717          	auipc	a4,0xe
ffffffffc0203456:	10670713          	addi	a4,a4,262 # ffffffffc0211558 <curr_ptr>
ffffffffc020345a:	631c                	ld	a5,0(a4)
{
ffffffffc020345c:	1141                	addi	sp,sp,-16
ffffffffc020345e:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203460:	c795                	beqz	a5,ffffffffc020348c <_clock_map_swappable+0x3a>
    list_entry_t *head = (list_entry_t *)mm->sm_priv;
ffffffffc0203462:	751c                	ld	a5,40(a0)
ffffffffc0203464:	03060593          	addi	a1,a2,48
    cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc0203468:	00002517          	auipc	a0,0x2
ffffffffc020346c:	76050513          	addi	a0,a0,1888 # ffffffffc0205bc8 <default_pmm_manager+0xaa0>
    __list_add(elm, listelm, listelm->next);
ffffffffc0203470:	6794                	ld	a3,8(a5)
    curr_ptr = entry;
ffffffffc0203472:	e30c                	sd	a1,0(a4)
    prev->next = next->prev = elm;
ffffffffc0203474:	e28c                	sd	a1,0(a3)
ffffffffc0203476:	e78c                	sd	a1,8(a5)
    elm->prev = prev;
ffffffffc0203478:	fa1c                	sd	a5,48(a2)
    page->visited = 1;
ffffffffc020347a:	4785                	li	a5,1
    elm->next = next;
ffffffffc020347c:	fe14                	sd	a3,56(a2)
ffffffffc020347e:	ea1c                	sd	a5,16(a2)
    cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc0203480:	c3bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203484:	60a2                	ld	ra,8(sp)
...
ffffffffc0203490:	77468693          	addi	a3,a3,1908 # ffffffffc0205c00 <default_pmm_manager+0xad8>
ffffffffc0203494:	00002617          	auipc	a2,0x2
ffffffffc0203498:	8e460613          	addi	a2,a2,-1820 # ffffffffc0204d78 <commands+0x738>
ffffffffc020349c:	03700593          	li	a1,55
...
ffffffffc02034b2:	79268693          	addi	a3,a3,1938 # ffffffffc0205c40 <default_pmm_manager+0xb18>
...
ffffffffc02034c6:	79e50513          	addi	a0,a0,1950 # ffffffffc0205c60 <default_pmm_manager+0xb38>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
// 将新的VMA插入到进程的VMA链表中。在插入之前，检查与相邻VMA的重叠情况，以确保不会出现重叠的VMA。
void
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203586:	6590                	ld	a2,8(a1)
ffffffffc0203588:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc0203710:	0d300593          	li	a1,211
ffffffffc0203714:	00002517          	auipc	a0,0x2
ffffffffc0203718:	54c50513          	addi	a0,a0,1356 # ffffffffc0205c60 <default_pmm_manager+0xb38>
...
ffffffffc0203764:	0d900593          	li	a1,217
ffffffffc0203768:	00002517          	auipc	a0,0x2
ffffffffc020376c:	4f850513          	addi	a0,a0,1272 # ffffffffc0205c60 <default_pmm_manager+0xb38>
...
ffffffffc020382c:	5a850513          	addi	a0,a0,1448 # ffffffffc0205dd0 <default_pmm_manager+0xca8>
ffffffffc0203830:	88bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203834:	00002697          	auipc	a3,0x2
ffffffffc0203838:	5c468693          	addi	a3,a3,1476 # ffffffffc0205df8 <default_pmm_manager+0xcd0>
ffffffffc020383c:	00001617          	auipc	a2,0x1
ffffffffc0203840:	53c60613          	addi	a2,a2,1340 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203844:	0fb00593          	li	a1,251
ffffffffc0203848:	00002517          	auipc	a0,0x2
ffffffffc020384c:	41850513          	addi	a0,a0,1048 # ffffffffc0205c60 <default_pmm_manager+0xb38>
...
ffffffffc020388a:	5b250513          	addi	a0,a0,1458 # ffffffffc0205e38 <default_pmm_manager+0xd10>
...
ffffffffc0203968:	89c73703          	ld	a4,-1892(a4) # ffffffffc0206200 <nbase>
...
ffffffffc02039cc:	4c050513          	addi	a0,a0,1216 # ffffffffc0205e88 <default_pmm_manager+0xd60>
...
ffffffffc02039f4:	4b850513          	addi	a0,a0,1208 # ffffffffc0205ea8 <default_pmm_manager+0xd80>
}
...
ffffffffc0203b34:	11200593          	li	a1,274
ffffffffc0203b38:	00002517          	auipc	a0,0x2
ffffffffc0203b3c:	12850513          	addi	a0,a0,296 # ffffffffc0205c60 <default_pmm_manager+0xb38>
ffffffffc0203b40:	835fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b44:	00002697          	auipc	a3,0x2
ffffffffc0203b48:	37c68693          	addi	a3,a3,892 # ffffffffc0205ec0 <default_pmm_manager+0xd98>
ffffffffc0203b4c:	00001617          	auipc	a2,0x1
ffffffffc0203b50:	22c60613          	addi	a2,a2,556 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203b54:	10f00593          	li	a1,271
ffffffffc0203b58:	00002517          	auipc	a0,0x2
ffffffffc0203b5c:	10850513          	addi	a0,a0,264 # ffffffffc0205c60 <default_pmm_manager+0xb38>
    check_mm_struct = mm_create();
...
ffffffffc0203bd4:	06500593          	li	a1,101
...
ffffffffc0203be8:	22c68693          	addi	a3,a3,556 # ffffffffc0205e10 <default_pmm_manager+0xce8>
ffffffffc0203bec:	00001617          	auipc	a2,0x1
ffffffffc0203bf0:	18c60613          	addi	a2,a2,396 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203bf4:	13300593          	li	a1,307
ffffffffc0203bf8:	00002517          	auipc	a0,0x2
ffffffffc0203bfc:	06850513          	addi	a0,a0,104 # ffffffffc0205c60 <default_pmm_manager+0xb38>
ffffffffc0203c00:	f74fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c04:	00002697          	auipc	a3,0x2
ffffffffc0203c08:	20c68693          	addi	a3,a3,524 # ffffffffc0205e10 <default_pmm_manager+0xce8>
ffffffffc0203c0c:	00001617          	auipc	a2,0x1
ffffffffc0203c10:	16c60613          	addi	a2,a2,364 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203c14:	0c200593          	li	a1,194
ffffffffc0203c18:	00002517          	auipc	a0,0x2
ffffffffc0203c1c:	04850513          	addi	a0,a0,72 # ffffffffc0205c60 <default_pmm_manager+0xb38>
...
ffffffffc0203c34:	0cc00593          	li	a1,204
ffffffffc0203c38:	00002517          	auipc	a0,0x2
ffffffffc0203c3c:	02850513          	addi	a0,a0,40 # ffffffffc0205c60 <default_pmm_manager+0xb38>
ffffffffc0203c40:	f34fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c44:	00002697          	auipc	a3,0x2
ffffffffc0203c48:	1cc68693          	addi	a3,a3,460 # ffffffffc0205e10 <default_pmm_manager+0xce8>
ffffffffc0203c4c:	00001617          	auipc	a2,0x1
ffffffffc0203c50:	12c60613          	addi	a2,a2,300 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203c54:	10000593          	li	a1,256
ffffffffc0203c58:	00002517          	auipc	a0,0x2
ffffffffc0203c5c:	00850513          	addi	a0,a0,8 # ffffffffc0205c60 <default_pmm_manager+0xb38>
ffffffffc0203c60:	f14fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c64 <do_pgfault>:
 
 
// 处理页错误的主要函数。首先根据地址查找对应的VMA。如果找不到，表示地址无效，返回错误。
// 检查该地址的访问权限，根据权限决定后续操作。
int
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c64:	7179                	addi	sp,sp,-48
// struct mm_struct *mm: 当前进程的内存管理结构，包含虚拟内存区域 (VMA) 的信息。
// uint_t error_code: 发生错误的代码，指示错误的具体原因（如缺页、权限错误等）。
// uintptr_t addr: 发生页故障的地址。
    int ret = -E_INVAL; // 这里初始化 ret 为 -E_INVAL，表示无效地址错误。
    //try to find a vma which include addr  使用 find_vma 函数查找包含 addr 的虚拟内存区域 (VMA)。如果找不到，说明地址不在任何 VMA 中。
...
ffffffffc0203c86:	8ef72323          	sw	a5,-1818(a4) # ffffffffc0211568 <pgfault_num>
    ...
    // 如果未找到对应的 VMA，或地址超出 VMA 的范围，打印错误信息并跳转到失败处理。
...
ffffffffc0203c8e:	08f46163          	bltu	s0,a5,ffffffffc0203d10 <do_pgfault+0xac>
     ...
     *    continue process
     */
     // 确定页面的访问权限。如果 VMA 可写，添加可读和可写标志。同时将地址向下对齐到页面边界。
    uint32_t perm = PTE_U;
...
ffffffffc0203caa:	c1b9                	beqz	a1,ffffffffc0203cf0 <do_pgfault+0x8c>
        ...
        *    从磁盘加载页面内容到内存。
        *    page_insert ： 建立一个Page的phy addr与线性addr la的映射,建立线性地址和物理地址之间的映射。
        *    swap_map_swappable ： 设置页面可交换,方便后续的内存管理。
        */
        if (swap_init_ok) {// 处理交换情况:
...
ffffffffc0203d04:	20850513          	addi	a0,a0,520 # ffffffffc0205f08 <default_pmm_manager+0xde0>
...
ffffffffc0203d16:	1c650513          	addi	a0,a0,454 # ffffffffc0205ed8 <default_pmm_manager+0xdb0>
...
ffffffffc0203d26:	20e50513          	addi	a0,a0,526 # ffffffffc0205f30 <default_pmm_manager+0xe08>
...
ffffffffc0203d58:	20460613          	addi	a2,a2,516 # ffffffffc0205f58 <default_pmm_manager+0xe30>
ffffffffc0203d5c:	45b5                	li	a1,13
ffffffffc0203d5e:	00002517          	auipc	a0,0x2
ffffffffc0203d62:	21a50513          	addi	a0,a0,538 # ffffffffc0205f78 <default_pmm_manager+0xe50>
...
ffffffffc0203d92:	46a5b583          	ld	a1,1130(a1) # ffffffffc02061f8 <error_string+0x38>
ffffffffc0203d96:	02b60633          	mul	a2,a2,a1
ffffffffc0203d9a:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d9e:	00002797          	auipc	a5,0x2
ffffffffc0203da2:	4627b783          	ld	a5,1122(a5) # ffffffffc0206200 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203dd8:	1bc60613          	addi	a2,a2,444 # ffffffffc0205f90 <default_pmm_manager+0xe68>
ffffffffc0203ddc:	45d1                	li	a1,20
ffffffffc0203dde:	00002517          	auipc	a0,0x2
ffffffffc0203de2:	19a50513          	addi	a0,a0,410 # ffffffffc0205f78 <default_pmm_manager+0xe50>
ffffffffc0203de6:	d8efc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203dea:	86b2                	mv	a3,a2
ffffffffc0203dec:	06a00593          	li	a1,106
...
ffffffffc0203e2c:	3d05b583          	ld	a1,976(a1) # ffffffffc02061f8 <error_string+0x38>
ffffffffc0203e30:	02b60633          	mul	a2,a2,a1
ffffffffc0203e34:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e38:	00002797          	auipc	a5,0x2
ffffffffc0203e3c:	3c87b783          	ld	a5,968(a5) # ffffffffc0206200 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e52:	02e7f963          	bgeu	a5,a4,ffffffffc0203e84 <swapfs_write+0x80>
}
...
ffffffffc0203e72:	12260613          	addi	a2,a2,290 # ffffffffc0205f90 <default_pmm_manager+0xe68>
ffffffffc0203e76:	45e5                	li	a1,25
ffffffffc0203e78:	00002517          	auipc	a0,0x2
ffffffffc0203e7c:	10050513          	addi	a0,a0,256 # ffffffffc0205f78 <default_pmm_manager+0xe50>
ffffffffc0203e80:	cf4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e84:	86b2                	mv	a3,a2
ffffffffc0203e86:	06a00593          	li	a1,106
ffffffffc0203e8a:	00001617          	auipc	a2,0x1
ffffffffc0203e8e:	32e60613          	addi	a2,a2,814 # ffffffffc02051b8 <default_pmm_manager+0x90>
ffffffffc0203e92:	00001517          	auipc	a0,0x1
ffffffffc0203e96:	2ee50513          	addi	a0,a0,750 # ffffffffc0205180 <default_pmm_manager+0x58>
ffffffffc0203e9a:	cdafc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e9e <printnum>:
 * */
static void
...
ffffffffc0203e9e:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea2:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203ea4:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea8:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203eaa:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203eae:	f022                	sd	s0,32(sp)
ffffffffc0203eb0:	ec26                	sd	s1,24(sp)
ffffffffc0203eb2:	e84a                	sd	s2,16(sp)
ffffffffc0203eb4:	f406                	sd	ra,40(sp)
ffffffffc0203eb6:	e44e                	sd	s3,8(sp)
ffffffffc0203eb8:	84aa                	mv	s1,a0
ffffffffc0203eba:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203ebc:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203ec0:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203ec2:	03067e63          	bgeu	a2,a6,ffffffffc0203efe <printnum+0x60>
ffffffffc0203ec6:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ec8:	00805763          	blez	s0,ffffffffc0203ed6 <printnum+0x38>
ffffffffc0203ecc:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ece:	85ca                	mv	a1,s2
ffffffffc0203ed0:	854e                	mv	a0,s3
ffffffffc0203ed2:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ed4:	fc65                	bnez	s0,ffffffffc0203ecc <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ed6:	1a02                	slli	s4,s4,0x20
ffffffffc0203ed8:	00002797          	auipc	a5,0x2
ffffffffc0203edc:	0d878793          	addi	a5,a5,216 # ffffffffc0205fb0 <default_pmm_manager+0xe88>
ffffffffc0203ee0:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203ee4:	9a3e                	add	s4,s4,a5
}
ffffffffc0203ee6:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee8:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203eec:	70a2                	ld	ra,40(sp)
ffffffffc0203eee:	69a2                	ld	s3,8(sp)
ffffffffc0203ef0:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef2:	85ca                	mv	a1,s2
ffffffffc0203ef4:	87a6                	mv	a5,s1
}
ffffffffc0203ef6:	6942                	ld	s2,16(sp)
ffffffffc0203ef8:	64e2                	ld	s1,24(sp)
ffffffffc0203efa:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203efc:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203efe:	03065633          	divu	a2,a2,a6
ffffffffc0203f02:	8722                	mv	a4,s0
ffffffffc0203f04:	f9bff0ef          	jal	ra,ffffffffc0203e9e <printnum>
ffffffffc0203f08:	b7f9                	j	ffffffffc0203ed6 <printnum+0x38>

ffffffffc0203f0a <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f0a:	7119                	addi	sp,sp,-128
ffffffffc0203f0c:	f4a6                	sd	s1,104(sp)
ffffffffc0203f0e:	f0ca                	sd	s2,96(sp)
ffffffffc0203f10:	ecce                	sd	s3,88(sp)
...
ffffffffc0203f1a:	f06a                	sd	s10,32(sp)
ffffffffc0203f1c:	fc86                	sd	ra,120(sp)
ffffffffc0203f1e:	f8a2                	sd	s0,112(sp)
ffffffffc0203f20:	f862                	sd	s8,48(sp)
ffffffffc0203f22:	f466                	sd	s9,40(sp)
ffffffffc0203f24:	ec6e                	sd	s11,24(sp)
ffffffffc0203f26:	892a                	mv	s2,a0
ffffffffc0203f28:	84ae                	mv	s1,a1
ffffffffc0203f2a:	8d32                	mv	s10,a2
ffffffffc0203f2c:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f2e:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f32:	5b7d                	li	s6,-1
ffffffffc0203f34:	00002a97          	auipc	s5,0x2
ffffffffc0203f38:	0b0a8a93          	addi	s5,s5,176 # ffffffffc0205fe4 <default_pmm_manager+0xebc>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f3c:	00002b97          	auipc	s7,0x2
ffffffffc0203f40:	284b8b93          	addi	s7,s7,644 # ffffffffc02061c0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f44:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f48:	001d0413          	addi	s0,s10,1
ffffffffc0203f4c:	01350a63          	beq	a0,s3,ffffffffc0203f60 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f50:	c121                	beqz	a0,ffffffffc0203f90 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f52:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f54:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f56:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f58:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f5c:	ff351ae3          	bne	a0,s3,ffffffffc0203f50 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f60:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f64:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f68:	4c81                	li	s9,0
ffffffffc0203f6a:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f6c:	5c7d                	li	s8,-1
ffffffffc0203f6e:	5dfd                	li	s11,-1
ffffffffc0203f70:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f74:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f76:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f7a:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f7e:	00140d13          	addi	s10,s0,1
ffffffffc0203f82:	04b56263          	bltu	a0,a1,ffffffffc0203fc6 <vprintfmt+0xbc>
ffffffffc0203f86:	058a                	slli	a1,a1,0x2
ffffffffc0203f88:	95d6                	add	a1,a1,s5
ffffffffc0203f8a:	4194                	lw	a3,0(a1)
ffffffffc0203f8c:	96d6                	add	a3,a3,s5
ffffffffc0203f8e:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f90:	70e6                	ld	ra,120(sp)
ffffffffc0203f92:	7446                	ld	s0,112(sp)
ffffffffc0203f94:	74a6                	ld	s1,104(sp)
ffffffffc0203f96:	7906                	ld	s2,96(sp)
ffffffffc0203f98:	69e6                	ld	s3,88(sp)
ffffffffc0203f9a:	6a46                	ld	s4,80(sp)
ffffffffc0203f9c:	6aa6                	ld	s5,72(sp)
ffffffffc0203f9e:	6b06                	ld	s6,64(sp)
ffffffffc0203fa0:	7be2                	ld	s7,56(sp)
ffffffffc0203fa2:	7c42                	ld	s8,48(sp)
ffffffffc0203fa4:	7ca2                	ld	s9,40(sp)
ffffffffc0203fa6:	7d02                	ld	s10,32(sp)
ffffffffc0203fa8:	6de2                	ld	s11,24(sp)
ffffffffc0203faa:	6109                	addi	sp,sp,128
ffffffffc0203fac:	8082                	ret
            padc = '0';
ffffffffc0203fae:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fb0:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fb4:	846a                	mv	s0,s10
ffffffffc0203fb6:	00140d13          	addi	s10,s0,1
ffffffffc0203fba:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fbe:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fc2:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f86 <vprintfmt+0x7c>
            putch('%', putdat);
...
ffffffffc0203fd4:	f73788e3          	beq	a5,s3,ffffffffc0203f44 <vprintfmt+0x3a>
ffffffffc0203fd8:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fdc:	1d7d                	addi	s10,s10,-1
ffffffffc0203fde:	ff379de3          	bne	a5,s3,ffffffffc0203fd8 <vprintfmt+0xce>
ffffffffc0203fe2:	b78d                	j	ffffffffc0203f44 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fe4:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0203fee:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203ff2:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203ff6:	02d86463          	bltu	a6,a3,ffffffffc020401e <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203ffa:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ffe:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204002:	0186873b          	addw	a4,a3,s8
ffffffffc0204006:	0017171b          	slliw	a4,a4,0x1
ffffffffc020400a:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc020400c:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204010:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204012:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204016:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020401a:	fed870e3          	bgeu	a6,a3,ffffffffc0203ffa <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020401e:	f40ddce3          	bgez	s11,ffffffffc0203f76 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204022:	8de2                	mv	s11,s8
ffffffffc0204024:	5c7d                	li	s8,-1
ffffffffc0204026:	bf81                	j	ffffffffc0203f76 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204028:	fffdc693          	not	a3,s11
ffffffffc020402c:	96fd                	srai	a3,a3,0x3f
ffffffffc020402e:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204032:	00144603          	lbu	a2,1(s0)
ffffffffc0204036:	2d81                	sext.w	s11,s11
ffffffffc0204038:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020403a:	bf35                	j	ffffffffc0203f76 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc020403c:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204040:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204044:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204046:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204048:	bfd9                	j	ffffffffc020401e <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020404a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020404c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204050:	01174463          	blt	a4,a7,ffffffffc0204058 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204054:	1a088e63          	beqz	a7,ffffffffc0204210 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204058:	000a3603          	ld	a2,0(s4)
ffffffffc020405c:	46c1                	li	a3,16
ffffffffc020405e:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204060:	2781                	sext.w	a5,a5
ffffffffc0204062:	876e                	mv	a4,s11
ffffffffc0204064:	85a6                	mv	a1,s1
ffffffffc0204066:	854a                	mv	a0,s2
ffffffffc0204068:	e37ff0ef          	jal	ra,ffffffffc0203e9e <printnum>
            break;
ffffffffc020406c:	bde1                	j	ffffffffc0203f44 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020406e:	000a2503          	lw	a0,0(s4)
ffffffffc0204072:	85a6                	mv	a1,s1
ffffffffc0204074:	0a21                	addi	s4,s4,8
ffffffffc0204076:	9902                	jalr	s2
            break;
ffffffffc0204078:	b5f1                	j	ffffffffc0203f44 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020407a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020407c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204080:	01174463          	blt	a4,a7,ffffffffc0204088 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204084:	18088163          	beqz	a7,ffffffffc0204206 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204088:	000a3603          	ld	a2,0(s4)
ffffffffc020408c:	46a9                	li	a3,10
ffffffffc020408e:	8a2e                	mv	s4,a1
ffffffffc0204090:	bfc1                	j	ffffffffc0204060 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204092:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204096:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204098:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020409a:	bdf1                	j	ffffffffc0203f76 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020409c:	85a6                	mv	a1,s1
ffffffffc020409e:	02500513          	li	a0,37
ffffffffc02040a2:	9902                	jalr	s2
            break;
ffffffffc02040a4:	b545                	j	ffffffffc0203f44 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a6:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040aa:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040ac:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040ae:	b5e1                	j	ffffffffc0203f76 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040b0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040b2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040b6:	01174463          	blt	a4,a7,ffffffffc02040be <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040ba:	14088163          	beqz	a7,ffffffffc02041fc <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040be:	000a3603          	ld	a2,0(s4)
ffffffffc02040c2:	46a1                	li	a3,8
ffffffffc02040c4:	8a2e                	mv	s4,a1
ffffffffc02040c6:	bf69                	j	ffffffffc0204060 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040c8:	03000513          	li	a0,48
ffffffffc02040cc:	85a6                	mv	a1,s1
ffffffffc02040ce:	e03e                	sd	a5,0(sp)
ffffffffc02040d0:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040d2:	85a6                	mv	a1,s1
ffffffffc02040d4:	07800513          	li	a0,120
ffffffffc02040d8:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040da:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040dc:	6782                	ld	a5,0(sp)
ffffffffc02040de:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040e0:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040e4:	bfb5                	j	ffffffffc0204060 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040e6:	000a3403          	ld	s0,0(s4)
ffffffffc02040ea:	008a0713          	addi	a4,s4,8
ffffffffc02040ee:	e03a                	sd	a4,0(sp)
ffffffffc02040f0:	14040263          	beqz	s0,ffffffffc0204234 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040f4:	0fb05763          	blez	s11,ffffffffc02041e2 <vprintfmt+0x2d8>
ffffffffc02040f8:	02d00693          	li	a3,45
ffffffffc02040fc:	0cd79163          	bne	a5,a3,ffffffffc02041be <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204100:	00044783          	lbu	a5,0(s0)
ffffffffc0204104:	0007851b          	sext.w	a0,a5
ffffffffc0204108:	cf85                	beqz	a5,ffffffffc0204140 <vprintfmt+0x236>
ffffffffc020410a:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020410e:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204112:	000c4563          	bltz	s8,ffffffffc020411c <vprintfmt+0x212>
ffffffffc0204116:	3c7d                	addiw	s8,s8,-1
ffffffffc0204118:	036c0263          	beq	s8,s6,ffffffffc020413c <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc020411c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020411e:	0e0c8e63          	beqz	s9,ffffffffc020421a <vprintfmt+0x310>
ffffffffc0204122:	3781                	addiw	a5,a5,-32
ffffffffc0204124:	0ef47b63          	bgeu	s0,a5,ffffffffc020421a <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204128:	03f00513          	li	a0,63
ffffffffc020412c:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020412e:	000a4783          	lbu	a5,0(s4)
ffffffffc0204132:	3dfd                	addiw	s11,s11,-1
ffffffffc0204134:	0a05                	addi	s4,s4,1
ffffffffc0204136:	0007851b          	sext.w	a0,a5
ffffffffc020413a:	ffe1                	bnez	a5,ffffffffc0204112 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc020413c:	01b05963          	blez	s11,ffffffffc020414e <vprintfmt+0x244>
ffffffffc0204140:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204142:	85a6                	mv	a1,s1
ffffffffc0204144:	02000513          	li	a0,32
ffffffffc0204148:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020414a:	fe0d9be3          	bnez	s11,ffffffffc0204140 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020414e:	6a02                	ld	s4,0(sp)
ffffffffc0204150:	bbd5                	j	ffffffffc0203f44 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204152:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204154:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204158:	01174463          	blt	a4,a7,ffffffffc0204160 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc020415c:	08088d63          	beqz	a7,ffffffffc02041f6 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204160:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204164:	0a044d63          	bltz	s0,ffffffffc020421e <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204168:	8622                	mv	a2,s0
ffffffffc020416a:	8a66                	mv	s4,s9
ffffffffc020416c:	46a9                	li	a3,10
ffffffffc020416e:	bdcd                	j	ffffffffc0204060 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204170:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204174:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204176:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204178:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020417c:	8fb5                	xor	a5,a5,a3
ffffffffc020417e:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204182:	02d74163          	blt	a4,a3,ffffffffc02041a4 <vprintfmt+0x29a>
ffffffffc0204186:	00369793          	slli	a5,a3,0x3
ffffffffc020418a:	97de                	add	a5,a5,s7
ffffffffc020418c:	639c                	ld	a5,0(a5)
ffffffffc020418e:	cb99                	beqz	a5,ffffffffc02041a4 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204190:	86be                	mv	a3,a5
ffffffffc0204192:	00002617          	auipc	a2,0x2
ffffffffc0204196:	e4e60613          	addi	a2,a2,-434 # ffffffffc0205fe0 <default_pmm_manager+0xeb8>
ffffffffc020419a:	85a6                	mv	a1,s1
ffffffffc020419c:	854a                	mv	a0,s2
ffffffffc020419e:	0ce000ef          	jal	ra,ffffffffc020426c <printfmt>
ffffffffc02041a2:	b34d                	j	ffffffffc0203f44 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02041a4:	00002617          	auipc	a2,0x2
ffffffffc02041a8:	e2c60613          	addi	a2,a2,-468 # ffffffffc0205fd0 <default_pmm_manager+0xea8>
ffffffffc02041ac:	85a6                	mv	a1,s1
ffffffffc02041ae:	854a                	mv	a0,s2
ffffffffc02041b0:	0bc000ef          	jal	ra,ffffffffc020426c <printfmt>
ffffffffc02041b4:	bb41                	j	ffffffffc0203f44 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041b6:	00002417          	auipc	s0,0x2
ffffffffc02041ba:	e1240413          	addi	s0,s0,-494 # ffffffffc0205fc8 <default_pmm_manager+0xea0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041be:	85e2                	mv	a1,s8
ffffffffc02041c0:	8522                	mv	a0,s0
ffffffffc02041c2:	e43e                	sd	a5,8(sp)
ffffffffc02041c4:	196000ef          	jal	ra,ffffffffc020435a <strnlen>
ffffffffc02041c8:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041cc:	01b05b63          	blez	s11,ffffffffc02041e2 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041d0:	67a2                	ld	a5,8(sp)
ffffffffc02041d2:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc02041dc:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041de:	fe0d9ce3          	bnez	s11,ffffffffc02041d6 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041e2:	00044783          	lbu	a5,0(s0)
ffffffffc02041e6:	00140a13          	addi	s4,s0,1
ffffffffc02041ea:	0007851b          	sext.w	a0,a5
ffffffffc02041ee:	d3a5                	beqz	a5,ffffffffc020414e <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041f0:	05e00413          	li	s0,94
ffffffffc02041f4:	bf39                	j	ffffffffc0204112 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041f6:	000a2403          	lw	s0,0(s4)
ffffffffc02041fa:	b7ad                	j	ffffffffc0204164 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041fc:	000a6603          	lwu	a2,0(s4)
ffffffffc0204200:	46a1                	li	a3,8
ffffffffc0204202:	8a2e                	mv	s4,a1
ffffffffc0204204:	bdb1                	j	ffffffffc0204060 <vprintfmt+0x156>
ffffffffc0204206:	000a6603          	lwu	a2,0(s4)
ffffffffc020420a:	46a9                	li	a3,10
ffffffffc020420c:	8a2e                	mv	s4,a1
ffffffffc020420e:	bd89                	j	ffffffffc0204060 <vprintfmt+0x156>
ffffffffc0204210:	000a6603          	lwu	a2,0(s4)
ffffffffc0204214:	46c1                	li	a3,16
ffffffffc0204216:	8a2e                	mv	s4,a1
ffffffffc0204218:	b5a1                	j	ffffffffc0204060 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020421a:	9902                	jalr	s2
ffffffffc020421c:	bf09                	j	ffffffffc020412e <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc020422c:	40800633          	neg	a2,s0
ffffffffc0204230:	46a9                	li	a3,10
ffffffffc0204232:	b53d                	j	ffffffffc0204060 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204234:	03b05163          	blez	s11,ffffffffc0204256 <vprintfmt+0x34c>
ffffffffc0204238:	02d00693          	li	a3,45
ffffffffc020423c:	f6d79de3          	bne	a5,a3,ffffffffc02041b6 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204240:	00002417          	auipc	s0,0x2
ffffffffc0204244:	d8840413          	addi	s0,s0,-632 # ffffffffc0205fc8 <default_pmm_manager+0xea0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204248:	02800793          	li	a5,40
ffffffffc020424c:	02800513          	li	a0,40
ffffffffc0204250:	00140a13          	addi	s4,s0,1
ffffffffc0204254:	bd6d                	j	ffffffffc020410e <vprintfmt+0x204>
ffffffffc0204256:	00002a17          	auipc	s4,0x2
ffffffffc020425a:	d73a0a13          	addi	s4,s4,-653 # ffffffffc0205fc9 <default_pmm_manager+0xea1>
ffffffffc020425e:	02800513          	li	a0,40
ffffffffc0204262:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204266:	05e00413          	li	s0,94
ffffffffc020426a:	b565                	j	ffffffffc0204112 <vprintfmt+0x208>

ffffffffc020426c <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020426c:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020426e:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204272:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204274:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204276:	ec06                	sd	ra,24(sp)
ffffffffc0204278:	f83a                	sd	a4,48(sp)
ffffffffc020427a:	fc3e                	sd	a5,56(sp)
ffffffffc020427c:	e0c2                	sd	a6,64(sp)
ffffffffc020427e:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204280:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204282:	c89ff0ef          	jal	ra,ffffffffc0203f0a <vprintfmt>
}
ffffffffc0204286:	60e2                	ld	ra,24(sp)
ffffffffc0204288:	6161                	addi	sp,sp,80
ffffffffc020428a:	8082                	ret

ffffffffc020428c <readline>:
...
ffffffffc020428c:	715d                	addi	sp,sp,-80
ffffffffc020428e:	e486                	sd	ra,72(sp)
ffffffffc0204290:	e0a6                	sd	s1,64(sp)
ffffffffc0204292:	fc4a                	sd	s2,56(sp)
ffffffffc0204294:	f84e                	sd	s3,48(sp)
ffffffffc0204296:	f452                	sd	s4,40(sp)
ffffffffc0204298:	f056                	sd	s5,32(sp)
ffffffffc020429a:	ec5a                	sd	s6,24(sp)
ffffffffc020429c:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc020429e:	c901                	beqz	a0,ffffffffc02042ae <readline+0x22>
ffffffffc02042a0:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc02042a2:	00002517          	auipc	a0,0x2
ffffffffc02042a6:	d3e50513          	addi	a0,a0,-706 # ffffffffc0205fe0 <default_pmm_manager+0xeb8>
ffffffffc02042aa:	e11fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc02042ae:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc02042b0:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042b2:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042b4:	4aa9                	li	s5,10
ffffffffc02042b6:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042b8:	0000db97          	auipc	s7,0xd
ffffffffc02042bc:	e40b8b93          	addi	s7,s7,-448 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c0:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042c4:	e2ffb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042c8:	00054a63          	bltz	a0,ffffffffc02042dc <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042cc:	00a95a63          	bge	s2,a0,ffffffffc02042e0 <readline+0x54>
ffffffffc02042d0:	029a5263          	bge	s4,s1,ffffffffc02042f4 <readline+0x68>
        c = getchar();
ffffffffc02042d4:	e1ffb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042d8:	fe055ae3          	bgez	a0,ffffffffc02042cc <readline+0x40>
            return NULL;
ffffffffc02042dc:	4501                	li	a0,0
ffffffffc02042de:	a091                	j	ffffffffc0204322 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042e0:	03351463          	bne	a0,s3,ffffffffc0204308 <readline+0x7c>
ffffffffc02042e4:	e8a9                	bnez	s1,ffffffffc0204336 <readline+0xaa>
        c = getchar();
ffffffffc02042e6:	e0dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042ea:	fe0549e3          	bltz	a0,ffffffffc02042dc <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042ee:	fea959e3          	bge	s2,a0,ffffffffc02042e0 <readline+0x54>
ffffffffc02042f2:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042f4:	e42a                	sd	a0,8(sp)
ffffffffc02042f6:	dfbfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042fa:	6522                	ld	a0,8(sp)
ffffffffc02042fc:	009b87b3          	add	a5,s7,s1
ffffffffc0204300:	2485                	addiw	s1,s1,1
ffffffffc0204302:	00a78023          	sb	a0,0(a5)
ffffffffc0204306:	bf7d                	j	ffffffffc02042c4 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204308:	01550463          	beq	a0,s5,ffffffffc0204310 <readline+0x84>
ffffffffc020430c:	fb651ce3          	bne	a0,s6,ffffffffc02042c4 <readline+0x38>
            cputchar(c);
ffffffffc0204310:	de1fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204314:	0000d517          	auipc	a0,0xd
ffffffffc0204318:	de450513          	addi	a0,a0,-540 # ffffffffc02110f8 <buf>
ffffffffc020431c:	94aa                	add	s1,s1,a0
ffffffffc020431e:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204322:	60a6                	ld	ra,72(sp)
ffffffffc0204324:	6486                	ld	s1,64(sp)
ffffffffc0204326:	7962                	ld	s2,56(sp)
ffffffffc0204328:	79c2                	ld	s3,48(sp)
ffffffffc020432a:	7a22                	ld	s4,40(sp)
ffffffffc020432c:	7a82                	ld	s5,32(sp)
ffffffffc020432e:	6b62                	ld	s6,24(sp)
ffffffffc0204330:	6bc2                	ld	s7,16(sp)
ffffffffc0204332:	6161                	addi	sp,sp,80
ffffffffc0204334:	8082                	ret
            cputchar(c);
ffffffffc0204336:	4521                	li	a0,8
ffffffffc0204338:	db9fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc020433c:	34fd                	addiw	s1,s1,-1
ffffffffc020433e:	b759                	j	ffffffffc02042c4 <readline+0x38>

ffffffffc0204340 <strlen>:
...
strlen(const char *s) {
ffffffffc0204344:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204346:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204348:	cb81                	beqz	a5,ffffffffc0204358 <strlen+0x18>
        cnt ++;
ffffffffc020434a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc020434c:	00a707b3          	add	a5,a4,a0
ffffffffc0204350:	0007c783          	lbu	a5,0(a5)
ffffffffc0204354:	fbfd                	bnez	a5,ffffffffc020434a <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020435a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020435c:	e589                	bnez	a1,ffffffffc0204366 <strnlen+0xc>
ffffffffc020435e:	a811                	j	ffffffffc0204372 <strnlen+0x18>
        cnt ++;
ffffffffc0204360:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204362:	00f58863          	beq	a1,a5,ffffffffc0204372 <strnlen+0x18>
ffffffffc0204366:	00f50733          	add	a4,a0,a5
ffffffffc020436a:	00074703          	lbu	a4,0(a4)
ffffffffc020436e:	fb6d                	bnez	a4,ffffffffc0204360 <strnlen+0x6>
ffffffffc0204370:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204372:	852e                	mv	a0,a1
ffffffffc0204374:	8082                	ret

ffffffffc0204376 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204376:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204378:	0005c703          	lbu	a4,0(a1)
ffffffffc020437c:	0785                	addi	a5,a5,1
ffffffffc020437e:	0585                	addi	a1,a1,1
ffffffffc0204380:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204384:	fb75                	bnez	a4,ffffffffc0204378 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc020438c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204390:	cb89                	beqz	a5,ffffffffc02043a2 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204392:	0505                	addi	a0,a0,1
ffffffffc0204394:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204396:	fee789e3          	beq	a5,a4,ffffffffc0204388 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020439a:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020439e:	9d19                	subw	a0,a0,a4
ffffffffc02043a0:	8082                	ret
ffffffffc02043a2:	4501                	li	a0,0
ffffffffc02043a4:	bfed                	j	ffffffffc020439e <strcmp+0x16>

ffffffffc02043a6 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc02043a6:	00054783          	lbu	a5,0(a0)
ffffffffc02043aa:	c799                	beqz	a5,ffffffffc02043b8 <strchr+0x12>
        if (*s == c) {
ffffffffc02043ac:	00f58763          	beq	a1,a5,ffffffffc02043ba <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043b0:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043b4:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043b6:	fbfd                	bnez	a5,ffffffffc02043ac <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043bc:	ca01                	beqz	a2,ffffffffc02043cc <memset+0x10>
ffffffffc02043be:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043c0:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043c2:	0785                	addi	a5,a5,1
ffffffffc02043c4:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043c8:	fec79de3          	bne	a5,a2,ffffffffc02043c2 <memset+0x6>
    }
    return s;
...
ffffffffc02043ce <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043ce:	ca19                	beqz	a2,ffffffffc02043e4 <memcpy+0x16>
ffffffffc02043d0:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043d2:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043d4:	0005c703          	lbu	a4,0(a1)
ffffffffc02043d8:	0585                	addi	a1,a1,1
ffffffffc02043da:	0785                	addi	a5,a5,1
ffffffffc02043dc:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043e0:	fec59ae3          	bne	a1,a2,ffffffffc02043d4 <memcpy+0x6>
    }
    return dst;
