...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	578060ef          	jal	ra,ffffffffc02065c2 <memset>
...
ffffffffc0200056:	59e58593          	addi	a1,a1,1438 # ffffffffc02065f0 <etext+0x4>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	5b650513          	addi	a0,a0,1462 # ffffffffc0206610 <etext+0x24>
...
ffffffffc020007a:	4c1050ef          	jal	ra,ffffffffc0205d3a <proc_init>
...
ffffffffc020008e:	645050ef          	jal	ra,ffffffffc0205ed2 <cpu_idle>
...
ffffffffc02000ac:	57050513          	addi	a0,a0,1392 # ffffffffc0206618 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	050060ef          	jal	ra,ffffffffc02061c4 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	01a060ef          	jal	ra,ffffffffc02061c4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	41650513          	addi	a0,a0,1046 # ffffffffc0206620 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc0200224:	42050513          	addi	a0,a0,1056 # ffffffffc0206640 <etext+0x54>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	3c058593          	addi	a1,a1,960 # ffffffffc02065ec <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	42c50513          	addi	a0,a0,1068 # ffffffffc0206660 <etext+0x74>
...
ffffffffc020024c:	43850513          	addi	a0,a0,1080 # ffffffffc0206680 <etext+0x94>
...
ffffffffc0200260:	44450513          	addi	a0,a0,1092 # ffffffffc02066a0 <etext+0xb4>
...
ffffffffc020028e:	43650513          	addi	a0,a0,1078 # ffffffffc02066c0 <etext+0xd4>
}
...
ffffffffc020029c:	45860613          	addi	a2,a2,1112 # ffffffffc02066f0 <etext+0x104>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	46450513          	addi	a0,a0,1124 # ffffffffc0206708 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc02002b8:	46c60613          	addi	a2,a2,1132 # ffffffffc0206720 <etext+0x134>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	48458593          	addi	a1,a1,1156 # ffffffffc0206740 <etext+0x154>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	48450513          	addi	a0,a0,1156 # ffffffffc0206748 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	48660613          	addi	a2,a2,1158 # ffffffffc0206758 <etext+0x16c>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	4a658593          	addi	a1,a1,1190 # ffffffffc0206780 <etext+0x194>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	46650513          	addi	a0,a0,1126 # ffffffffc0206748 <etext+0x15c>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	4a260613          	addi	a2,a2,1186 # ffffffffc0206790 <etext+0x1a4>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	4ba58593          	addi	a1,a1,1210 # ffffffffc02067b0 <etext+0x1c4>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	44a50513          	addi	a0,a0,1098 # ffffffffc0206748 <etext+0x15c>
...
ffffffffc020033c:	48850513          	addi	a0,a0,1160 # ffffffffc02067c0 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	48e50513          	addi	a0,a0,1166 # ffffffffc02067e8 <etext+0x1fc>
...
ffffffffc020037c:	49890913          	addi	s2,s2,1176 # ffffffffc0206810 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	49848493          	addi	s1,s1,1176 # ffffffffc0206818 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	496b0b13          	addi	s6,s6,1174 # ffffffffc0206820 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	3aea0a13          	addi	s4,s4,942 # ffffffffc0206740 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	1cc060ef          	jal	ra,ffffffffc020658e <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	1b8060ef          	jal	ra,ffffffffc020658e <strcmp>
...
ffffffffc0200414:	198060ef          	jal	ra,ffffffffc02065ac <strchr>
...
ffffffffc0200452:	15a060ef          	jal	ra,ffffffffc02065ac <strchr>
...
ffffffffc0200470:	3d450513          	addi	a0,a0,980 # ffffffffc0206840 <etext+0x254>
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	7c5050ef          	jal	ra,ffffffffc02065d4 <memcpy>
    return 0;
}
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	7a1050ef          	jal	ra,ffffffffc02065d4 <memcpy>
    return 0;
}
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	63c0506f          	j	ffffffffc02060c2 <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	57c050ef          	jal	ra,ffffffffc02060c2 <syscall>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	33a0506f          	j	ffffffffc0205fd6 <schedule>
                do_exit(-E_KILLED);
...
ffffffffc0200ede:	dee63603          	ld	a2,-530(a2) # ffffffffc0208cc8 <nbase>
...
ffffffffc02019a4:	3286b683          	ld	a3,808(a3) # ffffffffc0208cc8 <nbase>
...
ffffffffc0201c1c:	0b053503          	ld	a0,176(a0) # ffffffffc0208cc8 <nbase>
...
ffffffffc0201e72:	750040ef          	jal	ra,ffffffffc02065c2 <memset>
    return page - pages + nbase;
...
ffffffffc0201f04:	6be040ef          	jal	ra,ffffffffc02065c2 <memset>
    return page - pages + nbase;
...
ffffffffc02029de:	39f030ef          	jal	ra,ffffffffc020657c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	3a5030ef          	jal	ra,ffffffffc020658e <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	327030ef          	jal	ra,ffffffffc0206546 <strlen>
...
ffffffffc0203232:	3a2030ef          	jal	ra,ffffffffc02065d4 <memcpy>
...
ffffffffc02036ea:	5e260613          	addi	a2,a2,1506 # ffffffffc0208cc8 <nbase>
...
ffffffffc0204706:	5c6a3a03          	ld	s4,1478(s4) # ffffffffc0208cc8 <nbase>
...
ffffffffc0204ab0:	85450513          	addi	a0,a0,-1964 # ffffffffc0208300 <default_pmm_manager+0xfc0>
...
ffffffffc0204ac2:	7f250513          	addi	a0,a0,2034 # ffffffffc02082b0 <default_pmm_manager+0xf70>
...
ffffffffc0204ad2:	85a50513          	addi	a0,a0,-1958 # ffffffffc0208328 <default_pmm_manager+0xfe8>
...
ffffffffc0204adc:	b749                	j	ffffffffc0204a5e <do_pgfault+0x66>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc0204ade:	00004517          	auipc	a0,0x4
ffffffffc0204ae2:	80250513          	addi	a0,a0,-2046 # ffffffffc02082e0 <default_pmm_manager+0xfa0>
...
ffffffffc0204ba8:	7ac60613          	addi	a2,a2,1964 # ffffffffc0208350 <default_pmm_manager+0x1010>
ffffffffc0204bac:	45b5                	li	a1,13
ffffffffc0204bae:	00003517          	auipc	a0,0x3
ffffffffc0204bb2:	7c250513          	addi	a0,a0,1986 # ffffffffc0208370 <default_pmm_manager+0x1030>
...
ffffffffc0204be2:	0ea73703          	ld	a4,234(a4) # ffffffffc0208cc8 <nbase>
...
ffffffffc0204c1c:	77060613          	addi	a2,a2,1904 # ffffffffc0208388 <default_pmm_manager+0x1048>
ffffffffc0204c20:	45d1                	li	a1,20
ffffffffc0204c22:	00003517          	auipc	a0,0x3
ffffffffc0204c26:	74e50513          	addi	a0,a0,1870 # ffffffffc0208370 <default_pmm_manager+0x1030>
...
ffffffffc0204c38:	74460613          	addi	a2,a2,1860 # ffffffffc0207378 <default_pmm_manager+0x38>
ffffffffc0204c3c:	00002517          	auipc	a0,0x2
ffffffffc0204c40:	76450513          	addi	a0,a0,1892 # ffffffffc02073a0 <default_pmm_manager+0x60>
...
ffffffffc0204c70:	05c73703          	ld	a4,92(a4) # ffffffffc0208cc8 <nbase>
...
ffffffffc0204caa:	6e260613          	addi	a2,a2,1762 # ffffffffc0208388 <default_pmm_manager+0x1048>
ffffffffc0204cae:	45e5                	li	a1,25
ffffffffc0204cb0:	00003517          	auipc	a0,0x3
ffffffffc0204cb4:	6c050513          	addi	a0,a0,1728 # ffffffffc0208370 <default_pmm_manager+0x1030>
...
ffffffffc0204cc6:	6b660613          	addi	a2,a2,1718 # ffffffffc0207378 <default_pmm_manager+0x38>
ffffffffc0204cca:	00002517          	auipc	a0,0x2
ffffffffc0204cce:	6d650513          	addi	a0,a0,1750 # ffffffffc02073a0 <default_pmm_manager+0x60>
...
ffffffffc0204cd8:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cda:	642000ef          	jal	ra,ffffffffc020531c <do_exit>
...
ffffffffc0204d14:	0af010ef          	jal	ra,ffffffffc02065c2 <memset>
...
ffffffffc0204d26:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN);         //将线程名变量全部赋值为0，清空
ffffffffc0204d2a:	463d                	li	a2,15
ffffffffc0204d2c:	4581                	li	a1,0
ffffffffc0204d2e:	0b440513          	addi	a0,s0,180
ffffffffc0204d32:	091010ef          	jal	ra,ffffffffc02065c2 <memset>
        proc->wait_state = 0;
ffffffffc0204d36:	0e042623          	sw	zero,236(s0)
        proc->cptr = NULL;
ffffffffc0204d3a:	0e043823          	sd	zero,240(s0)
        proc->optr = NULL;
ffffffffc0204d3e:	10043023          	sd	zero,256(s0)
        proc->yptr = NULL;
ffffffffc0204d42:	0e043c23          	sd	zero,248(s0)
    }
    return proc;
}
...
ffffffffc0204d6e:	63e60613          	addi	a2,a2,1598 # ffffffffc02083a8 <default_pmm_manager+0x1068>
ffffffffc0204d72:	00003517          	auipc	a0,0x3
ffffffffc0204d76:	64650513          	addi	a0,a0,1606 # ffffffffc02083b8 <default_pmm_manager+0x1078>
user_main(void *arg) {
...
ffffffffc0204d8e:	61e50513          	addi	a0,a0,1566 # ffffffffc02083a8 <default_pmm_manager+0x1068>
...
ffffffffc0204da0:	7a6010ef          	jal	ra,ffffffffc0206546 <strlen>
...
ffffffffc0204dbc:	62850513          	addi	a0,a0,1576 # ffffffffc02083e0 <default_pmm_manager+0x10a0>
...
ffffffffc0204dc8:	62c60613          	addi	a2,a2,1580 # ffffffffc02083f0 <default_pmm_manager+0x10b0>
ffffffffc0204dcc:	35f00593          	li	a1,863
ffffffffc0204dd0:	00003517          	auipc	a0,0x3
ffffffffc0204dd4:	64050513          	addi	a0,a0,1600 # ffffffffc0208410 <default_pmm_manager+0x10d0>
...
ffffffffc0204e06:	ec653503          	ld	a0,-314(a0) # ffffffffc0208cc8 <nbase>
}
...
ffffffffc0204e26:	5fe60613          	addi	a2,a2,1534 # ffffffffc0207420 <default_pmm_manager+0xe0>
ffffffffc0204e2a:	06e00593          	li	a1,110
ffffffffc0204e2e:	00002517          	auipc	a0,0x2
ffffffffc0204e32:	57250513          	addi	a0,a0,1394 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc0204e36:	e44fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e3a:	00002617          	auipc	a2,0x2
ffffffffc0204e3e:	60e60613          	addi	a2,a2,1550 # ffffffffc0207448 <default_pmm_manager+0x108>
ffffffffc0204e42:	06200593          	li	a1,98
ffffffffc0204e46:	00002517          	auipc	a0,0x2
ffffffffc0204e4a:	55a50513          	addi	a0,a0,1370 # ffffffffc02073a0 <default_pmm_manager+0x60>
...
ffffffffc0204e54:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204e56:	000ae917          	auipc	s2,0xae
ffffffffc0204e5a:	a5a90913          	addi	s2,s2,-1446 # ffffffffc02b28b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204e5e:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204e60:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204e64:	f406                	sd	ra,40(sp)
ffffffffc0204e66:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204e68:	02a48863          	beq	s1,a0,ffffffffc0204e98 <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e6c:	100027f3          	csrr	a5,sstatus
ffffffffc0204e70:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204e72:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e74:	ef9d                	bnez	a5,ffffffffc0204eb2 <proc_run+0x60>
...
ffffffffc0204e76:	755c                	ld	a5,168(a0)
ffffffffc0204e78:	577d                	li	a4,-1
ffffffffc0204e7a:	177e                	slli	a4,a4,0x3f
ffffffffc0204e7c:	83b1                	srli	a5,a5,0xc
        current = proc; // 将当前进程设置为下一个进程
ffffffffc0204e7e:	00a93023          	sd	a0,0(s2)
ffffffffc0204e82:	8fd9                	or	a5,a5,a4
ffffffffc0204e84:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(next->context));  // 进行上下文切换
ffffffffc0204e88:	03050593          	addi	a1,a0,48
ffffffffc0204e8c:	03048513          	addi	a0,s1,48
ffffffffc0204e90:	05c010ef          	jal	ra,ffffffffc0205eec <switch_to>
    if (flag) {
ffffffffc0204e94:	00099863          	bnez	s3,ffffffffc0204ea4 <proc_run+0x52>
}
...
ffffffffc0204eac:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204eae:	f92fb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc0204eb2:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204eb4:	f92fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0204eb8:	6522                	ld	a0,8(sp)
ffffffffc0204eba:	4985                	li	s3,1
ffffffffc0204ebc:	bf6d                	j	ffffffffc0204e76 <proc_run+0x24>

ffffffffc0204ebe <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204ebe:	7159                	addi	sp,sp,-112
ffffffffc0204ec0:	e8ca                	sd	s2,80(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ec2:	000ae917          	auipc	s2,0xae
ffffffffc0204ec6:	a0690913          	addi	s2,s2,-1530 # ffffffffc02b28c8 <nr_process>
ffffffffc0204eca:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204ece:	f486                	sd	ra,104(sp)
ffffffffc0204ed0:	f0a2                	sd	s0,96(sp)
ffffffffc0204ed2:	eca6                	sd	s1,88(sp)
ffffffffc0204ed4:	e4ce                	sd	s3,72(sp)
ffffffffc0204ed6:	e0d2                	sd	s4,64(sp)
ffffffffc0204ed8:	fc56                	sd	s5,56(sp)
ffffffffc0204eda:	f85a                	sd	s6,48(sp)
ffffffffc0204edc:	f45e                	sd	s7,40(sp)
ffffffffc0204ede:	f062                	sd	s8,32(sp)
ffffffffc0204ee0:	ec66                	sd	s9,24(sp)
ffffffffc0204ee2:	e86a                	sd	s10,16(sp)
ffffffffc0204ee4:	e46e                	sd	s11,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ee6:	6785                	lui	a5,0x1
ffffffffc0204ee8:	34f75063          	bge	a4,a5,ffffffffc0205228 <do_fork+0x36a>
ffffffffc0204eec:	8a2a                	mv	s4,a0
ffffffffc0204eee:	89ae                	mv	s3,a1
ffffffffc0204ef0:	8432                	mv	s0,a2
    proc = alloc_proc(); //分配一个proc_struct 1
ffffffffc0204ef2:	dedff0ef          	jal	ra,ffffffffc0204cde <alloc_proc>
ffffffffc0204ef6:	84aa                	mv	s1,a0
    if (proc == NULL) {
ffffffffc0204ef8:	2c050863          	beqz	a0,ffffffffc02051c8 <do_fork+0x30a>
    proc->parent = current;    
ffffffffc0204efc:	000aea97          	auipc	s5,0xae
ffffffffc0204f00:	9b4a8a93          	addi	s5,s5,-1612 # ffffffffc02b28b0 <current>
ffffffffc0204f04:	000ab783          	ld	a5,0(s5)
    assert(current->wait_state == 0);
ffffffffc0204f08:	0ec7a703          	lw	a4,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8acc>
    proc->parent = current;    
ffffffffc0204f0c:	f11c                	sd	a5,32(a0)
    assert(current->wait_state == 0);
ffffffffc0204f0e:	38071363          	bnez	a4,ffffffffc0205294 <do_fork+0x3d6>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f12:	4509                	li	a0,2
ffffffffc0204f14:	dcdfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204f18:	2c050763          	beqz	a0,ffffffffc02051e6 <do_fork+0x328>
    return page - pages + nbase;
ffffffffc0204f1c:	000aed97          	auipc	s11,0xae
ffffffffc0204f20:	954d8d93          	addi	s11,s11,-1708 # ffffffffc02b2870 <pages>
ffffffffc0204f24:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc0204f28:	000aed17          	auipc	s10,0xae
ffffffffc0204f2c:	940d0d13          	addi	s10,s10,-1728 # ffffffffc02b2868 <npage>
    return page - pages + nbase;
ffffffffc0204f30:	00004c97          	auipc	s9,0x4
ffffffffc0204f34:	d98cbc83          	ld	s9,-616(s9) # ffffffffc0208cc8 <nbase>
ffffffffc0204f38:	40d506b3          	sub	a3,a0,a3
ffffffffc0204f3c:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f3e:	5c7d                	li	s8,-1
ffffffffc0204f40:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc0204f44:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc0204f46:	00cc5c13          	srli	s8,s8,0xc
ffffffffc0204f4a:	0186f733          	and	a4,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f4e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f50:	30f77963          	bgeu	a4,a5,ffffffffc0205262 <do_fork+0x3a4>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f54:	000ab703          	ld	a4,0(s5)
ffffffffc0204f58:	000aea97          	auipc	s5,0xae
ffffffffc0204f5c:	928a8a93          	addi	s5,s5,-1752 # ffffffffc02b2880 <va_pa_offset>
ffffffffc0204f60:	000ab783          	ld	a5,0(s5)
ffffffffc0204f64:	02873b83          	ld	s7,40(a4)
ffffffffc0204f68:	96be                	add	a3,a3,a5
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f6a:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f6c:	020b8863          	beqz	s7,ffffffffc0204f9c <do_fork+0xde>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f70:	100a7a13          	andi	s4,s4,256
ffffffffc0204f74:	1c0a0163          	beqz	s4,ffffffffc0205136 <do_fork+0x278>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f78:	030ba703          	lw	a4,48(s7)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f7c:	018bb783          	ld	a5,24(s7)
ffffffffc0204f80:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f84:	2705                	addiw	a4,a4,1
ffffffffc0204f86:	02eba823          	sw	a4,48(s7)
    proc->mm = mm;
ffffffffc0204f8a:	0374b423          	sd	s7,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f8e:	2ed7e663          	bltu	a5,a3,ffffffffc020527a <do_fork+0x3bc>
ffffffffc0204f92:	000ab703          	ld	a4,0(s5)
...
ffffffffc0204f9e:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cd8>
...
ffffffffc0204fca:	ff1612e3          	bne	a2,a7,ffffffffc0204fae <do_fork+0xf0>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fce:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fd2:	12098f63          	beqz	s3,ffffffffc0205110 <do_fork+0x252>
ffffffffc0204fd6:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204fda:	00000797          	auipc	a5,0x0
ffffffffc0204fde:	d7678793          	addi	a5,a5,-650 # ffffffffc0204d50 <forkret>
...
ffffffffc0204fec:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fee:	14079063          	bnez	a5,ffffffffc020512e <do_fork+0x270>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204ff2:	000a2817          	auipc	a6,0xa2
ffffffffc0204ff6:	37680813          	addi	a6,a6,886 # ffffffffc02a7368 <last_pid.1>
...
ffffffffc0205008:	08e55d63          	bge	a0,a4,ffffffffc02050a2 <do_fork+0x1e4>
    if (last_pid >= next_safe) {
ffffffffc020500c:	000a2317          	auipc	t1,0xa2
ffffffffc0205010:	36030313          	addi	t1,t1,864 # ffffffffc02a736c <next_safe.0>
ffffffffc0205014:	00032783          	lw	a5,0(t1)
ffffffffc0205018:	000ae417          	auipc	s0,0xae
ffffffffc020501c:	81040413          	addi	s0,s0,-2032 # ffffffffc02b2828 <proc_list>
ffffffffc0205020:	08f55963          	bge	a0,a5,ffffffffc02050b2 <do_fork+0x1f4>
...
ffffffffc020502a:	118010ef          	jal	ra,ffffffffc0206142 <hash32>
...
ffffffffc020503a:	7f278793          	addi	a5,a5,2034 # ffffffffc02ae828 <hash_list>
...
ffffffffc0205068:	c311                	beqz	a4,ffffffffc020506c <do_fork+0x1ae>
        proc->optr->yptr = proc;
...
ffffffffc0205074:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc0205078:	14099a63          	bnez	s3,ffffffffc02051cc <do_fork+0x30e>
    wakeup_proc(proc); // wakeup_proc函数-子进程变成可执行状态 6
ffffffffc020507c:	8526                	mv	a0,s1
ffffffffc020507e:	6d9000ef          	jal	ra,ffffffffc0205f56 <wakeup_proc>
    ret = proc->pid; // set ret vaule using child proc's pid 7
ffffffffc0205082:	40c8                	lw	a0,4(s1)
}
ffffffffc0205084:	70a6                	ld	ra,104(sp)
ffffffffc0205086:	7406                	ld	s0,96(sp)
ffffffffc0205088:	64e6                	ld	s1,88(sp)
ffffffffc020508a:	6946                	ld	s2,80(sp)
ffffffffc020508c:	69a6                	ld	s3,72(sp)
ffffffffc020508e:	6a06                	ld	s4,64(sp)
ffffffffc0205090:	7ae2                	ld	s5,56(sp)
ffffffffc0205092:	7b42                	ld	s6,48(sp)
ffffffffc0205094:	7ba2                	ld	s7,40(sp)
ffffffffc0205096:	7c02                	ld	s8,32(sp)
ffffffffc0205098:	6ce2                	ld	s9,24(sp)
ffffffffc020509a:	6d42                	ld	s10,16(sp)
ffffffffc020509c:	6da2                	ld	s11,8(sp)
ffffffffc020509e:	6165                	addi	sp,sp,112
...
ffffffffc02050ae:	2c230313          	addi	t1,t1,706 # ffffffffc02a736c <next_safe.0>
    return listelm->next;
ffffffffc02050b2:	000ad417          	auipc	s0,0xad
ffffffffc02050b6:	77640413          	addi	s0,s0,1910 # ffffffffc02b2828 <proc_list>
...
ffffffffc02050ca:	108e0963          	beq	t3,s0,ffffffffc02051dc <do_fork+0x31e>
ffffffffc02050ce:	88ae                	mv	a7,a1
ffffffffc02050d0:	87f2                	mv	a5,t3
ffffffffc02050d2:	6609                	lui	a2,0x2
ffffffffc02050d4:	a811                	j	ffffffffc02050e8 <do_fork+0x22a>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050d6:	00e6d663          	bge	a3,a4,ffffffffc02050e2 <do_fork+0x224>
ffffffffc02050da:	00c75463          	bge	a4,a2,ffffffffc02050e2 <do_fork+0x224>
ffffffffc02050de:	863a                	mv	a2,a4
ffffffffc02050e0:	4885                	li	a7,1
ffffffffc02050e2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050e4:	00878d63          	beq	a5,s0,ffffffffc02050fe <do_fork+0x240>
            if (proc->pid == last_pid) {
ffffffffc02050e8:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c7c>
ffffffffc02050ec:	fed715e3          	bne	a4,a3,ffffffffc02050d6 <do_fork+0x218>
                if (++ last_pid >= next_safe) {
ffffffffc02050f0:	2685                	addiw	a3,a3,1
ffffffffc02050f2:	0ec6d063          	bge	a3,a2,ffffffffc02051d2 <do_fork+0x314>
ffffffffc02050f6:	679c                	ld	a5,8(a5)
ffffffffc02050f8:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02050fa:	fe8797e3          	bne	a5,s0,ffffffffc02050e8 <do_fork+0x22a>
ffffffffc02050fe:	c581                	beqz	a1,ffffffffc0205106 <do_fork+0x248>
ffffffffc0205100:	00d82023          	sw	a3,0(a6)
ffffffffc0205104:	8536                	mv	a0,a3
ffffffffc0205106:	f0088fe3          	beqz	a7,ffffffffc0205024 <do_fork+0x166>
ffffffffc020510a:	00c32023          	sw	a2,0(t1)
ffffffffc020510e:	bf19                	j	ffffffffc0205024 <do_fork+0x166>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0205110:	89b6                	mv	s3,a3
ffffffffc0205112:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205116:	00000797          	auipc	a5,0x0
ffffffffc020511a:	c3a78793          	addi	a5,a5,-966 # ffffffffc0204d50 <forkret>
...
ffffffffc0205128:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020512a:	ec0784e3          	beqz	a5,ffffffffc0204ff2 <do_fork+0x134>
        intr_disable();
ffffffffc020512e:	d18fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205132:	4985                	li	s3,1
ffffffffc0205134:	bd7d                	j	ffffffffc0204ff2 <do_fork+0x134>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205136:	febfe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc020513a:	8b2a                	mv	s6,a0
ffffffffc020513c:	c159                	beqz	a0,ffffffffc02051c2 <do_fork+0x304>
    if ((page = alloc_page()) == NULL) {
ffffffffc020513e:	4505                	li	a0,1
ffffffffc0205140:	ba1fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205144:	cd25                	beqz	a0,ffffffffc02051bc <do_fork+0x2fe>
    return page - pages + nbase;
ffffffffc0205146:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc020514a:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc020514e:	40d506b3          	sub	a3,a0,a3
ffffffffc0205152:	8699                	srai	a3,a3,0x6
ffffffffc0205154:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc0205156:	0186fc33          	and	s8,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc020515a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020515c:	10fc7363          	bgeu	s8,a5,ffffffffc0205262 <do_fork+0x3a4>
ffffffffc0205160:	000aba03          	ld	s4,0(s5)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205164:	6605                	lui	a2,0x1
ffffffffc0205166:	000ad597          	auipc	a1,0xad
ffffffffc020516a:	6fa5b583          	ld	a1,1786(a1) # ffffffffc02b2860 <boot_pgdir>
ffffffffc020516e:	9a36                	add	s4,s4,a3
ffffffffc0205170:	8552                	mv	a0,s4
ffffffffc0205172:	462010ef          	jal	ra,ffffffffc02065d4 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0205176:	038b8c13          	addi	s8,s7,56
    mm->pgdir = pgdir;
ffffffffc020517a:	014b3c23          	sd	s4,24(s6)
...
ffffffffc020517e:	4785                	li	a5,1
ffffffffc0205180:	40fc37af          	amoor.d	a5,a5,(s8)
...
ffffffffc0205186:	4a05                	li	s4,1
ffffffffc0205188:	c799                	beqz	a5,ffffffffc0205196 <do_fork+0x2d8>
        schedule();
ffffffffc020518a:	64d000ef          	jal	ra,ffffffffc0205fd6 <schedule>
ffffffffc020518e:	414c37af          	amoor.d	a5,s4,(s8)
    while (!try_lock(lock)) {
ffffffffc0205192:	8b85                	andi	a5,a5,1
ffffffffc0205194:	fbfd                	bnez	a5,ffffffffc020518a <do_fork+0x2cc>
        ret = dup_mmap(mm, oldmm);
ffffffffc0205196:	85de                	mv	a1,s7
ffffffffc0205198:	855a                	mv	a0,s6
ffffffffc020519a:	a0eff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc020519e:	57f9                	li	a5,-2
ffffffffc02051a0:	60fc37af          	amoand.d	a5,a5,(s8)
...
ffffffffc02051a6:	10078763          	beqz	a5,ffffffffc02052b4 <do_fork+0x3f6>
good_mm:
ffffffffc02051aa:	8bda                	mv	s7,s6
    if (ret != 0) {
ffffffffc02051ac:	dc0506e3          	beqz	a0,ffffffffc0204f78 <do_fork+0xba>
    exit_mmap(mm);
ffffffffc02051b0:	855a                	mv	a0,s6
ffffffffc02051b2:	a90ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc02051b6:	855a                	mv	a0,s6
ffffffffc02051b8:	c25ff0ef          	jal	ra,ffffffffc0204ddc <put_pgdir>
    mm_destroy(mm);
ffffffffc02051bc:	855a                	mv	a0,s6
ffffffffc02051be:	8e8ff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    kfree(proc);
ffffffffc02051c2:	8526                	mv	a0,s1
ffffffffc02051c4:	9effc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc02051c8:	5571                	li	a0,-4
    return ret;
ffffffffc02051ca:	bd6d                	j	ffffffffc0205084 <do_fork+0x1c6>
        intr_enable();
ffffffffc02051cc:	c74fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02051d0:	b575                	j	ffffffffc020507c <do_fork+0x1be>
                    if (last_pid >= MAX_PID) {
ffffffffc02051d2:	01d6c363          	blt	a3,t4,ffffffffc02051d8 <do_fork+0x31a>
                        last_pid = 1;
ffffffffc02051d6:	4685                	li	a3,1
                    goto repeat;
ffffffffc02051d8:	4585                	li	a1,1
ffffffffc02051da:	bdc5                	j	ffffffffc02050ca <do_fork+0x20c>
ffffffffc02051dc:	c9a1                	beqz	a1,ffffffffc020522c <do_fork+0x36e>
ffffffffc02051de:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02051e2:	8536                	mv	a0,a3
ffffffffc02051e4:	b581                	j	ffffffffc0205024 <do_fork+0x166>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02051e6:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02051e8:	c02007b7          	lui	a5,0xc0200
ffffffffc02051ec:	04f6ef63          	bltu	a3,a5,ffffffffc020524a <do_fork+0x38c>
ffffffffc02051f0:	000ad797          	auipc	a5,0xad
ffffffffc02051f4:	6907b783          	ld	a5,1680(a5) # ffffffffc02b2880 <va_pa_offset>
ffffffffc02051f8:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02051fc:	83b1                	srli	a5,a5,0xc
ffffffffc02051fe:	000ad717          	auipc	a4,0xad
ffffffffc0205202:	66a73703          	ld	a4,1642(a4) # ffffffffc02b2868 <npage>
ffffffffc0205206:	02e7f663          	bgeu	a5,a4,ffffffffc0205232 <do_fork+0x374>
    return &pages[PPN(pa) - nbase];
ffffffffc020520a:	00004717          	auipc	a4,0x4
ffffffffc020520e:	abe73703          	ld	a4,-1346(a4) # ffffffffc0208cc8 <nbase>
ffffffffc0205212:	8f99                	sub	a5,a5,a4
ffffffffc0205214:	079a                	slli	a5,a5,0x6
ffffffffc0205216:	000ad517          	auipc	a0,0xad
ffffffffc020521a:	65a53503          	ld	a0,1626(a0) # ffffffffc02b2870 <pages>
ffffffffc020521e:	4589                	li	a1,2
ffffffffc0205220:	953e                	add	a0,a0,a5
ffffffffc0205222:	b51fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
}
ffffffffc0205226:	bf71                	j	ffffffffc02051c2 <do_fork+0x304>
    int ret = -E_NO_FREE_PROC;
ffffffffc0205228:	556d                	li	a0,-5
ffffffffc020522a:	bda9                	j	ffffffffc0205084 <do_fork+0x1c6>
    return last_pid;
ffffffffc020522c:	00082503          	lw	a0,0(a6)
ffffffffc0205230:	bbd5                	j	ffffffffc0205024 <do_fork+0x166>
        panic("pa2page called with invalid pa");
ffffffffc0205232:	00002617          	auipc	a2,0x2
ffffffffc0205236:	21660613          	addi	a2,a2,534 # ffffffffc0207448 <default_pmm_manager+0x108>
ffffffffc020523a:	06200593          	li	a1,98
ffffffffc020523e:	00002517          	auipc	a0,0x2
ffffffffc0205242:	16250513          	addi	a0,a0,354 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc0205246:	a34fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc020524a:	00002617          	auipc	a2,0x2
ffffffffc020524e:	1d660613          	addi	a2,a2,470 # ffffffffc0207420 <default_pmm_manager+0xe0>
ffffffffc0205252:	06e00593          	li	a1,110
ffffffffc0205256:	00002517          	auipc	a0,0x2
ffffffffc020525a:	14a50513          	addi	a0,a0,330 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc020525e:	a1cfb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0205262:	00002617          	auipc	a2,0x2
ffffffffc0205266:	11660613          	addi	a2,a2,278 # ffffffffc0207378 <default_pmm_manager+0x38>
ffffffffc020526a:	06900593          	li	a1,105
ffffffffc020526e:	00002517          	auipc	a0,0x2
ffffffffc0205272:	13250513          	addi	a0,a0,306 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc0205276:	a04fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc020527a:	86be                	mv	a3,a5
ffffffffc020527c:	00002617          	auipc	a2,0x2
ffffffffc0205280:	1a460613          	addi	a2,a2,420 # ffffffffc0207420 <default_pmm_manager+0xe0>
ffffffffc0205284:	16b00593          	li	a1,363
ffffffffc0205288:	00003517          	auipc	a0,0x3
ffffffffc020528c:	18850513          	addi	a0,a0,392 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205290:	9eafb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(current->wait_state == 0);
ffffffffc0205294:	00003697          	auipc	a3,0x3
ffffffffc0205298:	19468693          	addi	a3,a3,404 # ffffffffc0208428 <default_pmm_manager+0x10e8>
ffffffffc020529c:	00002617          	auipc	a2,0x2
ffffffffc02052a0:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0206ca8 <commands+0x450>
ffffffffc02052a4:	1b900593          	li	a1,441
ffffffffc02052a8:	00003517          	auipc	a0,0x3
ffffffffc02052ac:	16850513          	addi	a0,a0,360 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc02052b0:	9cafb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc02052b4:	00003617          	auipc	a2,0x3
ffffffffc02052b8:	19460613          	addi	a2,a2,404 # ffffffffc0208448 <default_pmm_manager+0x1108>
ffffffffc02052bc:	03100593          	li	a1,49
ffffffffc02052c0:	00003517          	auipc	a0,0x3
ffffffffc02052c4:	19850513          	addi	a0,a0,408 # ffffffffc0208458 <default_pmm_manager+0x1118>
...
ffffffffc02052e2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052e4:	2de010ef          	jal	ra,ffffffffc02065c2 <memset>
...
ffffffffc0205304:	9d678793          	addi	a5,a5,-1578 # ffffffffc0204cd6 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205308:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020530a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020530c:	bb3ff0ef          	jal	ra,ffffffffc0204ebe <do_fork>
}
...
ffffffffc0205324:	59040413          	addi	s0,s0,1424 # ffffffffc02b28b0 <current>
...
ffffffffc0205338:	58473703          	ld	a4,1412(a4) # ffffffffc02b28b8 <idleproc>
ffffffffc020533c:	0ce78c63          	beq	a5,a4,ffffffffc0205414 <do_exit+0xf8>
    if (current == initproc) {
ffffffffc0205340:	000ad497          	auipc	s1,0xad
ffffffffc0205344:	58048493          	addi	s1,s1,1408 # ffffffffc02b28c0 <initproc>
...
ffffffffc020535c:	5007b783          	ld	a5,1280(a5) # ffffffffc02b2858 <boot_cr3>
...
ffffffffc02053bc:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fd8>
...
ffffffffc02053e4:	373000ef          	jal	ra,ffffffffc0205f56 <wakeup_proc>
ffffffffc02053e8:	b7f9                	j	ffffffffc02053b6 <do_exit+0x9a>
    if (flag) {
ffffffffc02053ea:	020a1263          	bnez	s4,ffffffffc020540e <do_exit+0xf2>
    schedule();
ffffffffc02053ee:	3e9000ef          	jal	ra,ffffffffc0205fd6 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053f2:	601c                	ld	a5,0(s0)
ffffffffc02053f4:	00003617          	auipc	a2,0x3
ffffffffc02053f8:	09c60613          	addi	a2,a2,156 # ffffffffc0208490 <default_pmm_manager+0x1150>
ffffffffc02053fc:	21300593          	li	a1,531
ffffffffc0205400:	43d4                	lw	a3,4(a5)
ffffffffc0205402:	00003517          	auipc	a0,0x3
ffffffffc0205406:	00e50513          	addi	a0,a0,14 # ffffffffc0208410 <default_pmm_manager+0x10d0>
...
ffffffffc0205418:	05c60613          	addi	a2,a2,92 # ffffffffc0208470 <default_pmm_manager+0x1130>
ffffffffc020541c:	1e700593          	li	a1,487
ffffffffc0205420:	00003517          	auipc	a0,0x3
ffffffffc0205424:	ff050513          	addi	a0,a0,-16 # ffffffffc0208410 <default_pmm_manager+0x10d0>
...
ffffffffc0205434:	9a9ff0ef          	jal	ra,ffffffffc0204ddc <put_pgdir>
            mm_destroy(mm);
...
ffffffffc0205444:	04060613          	addi	a2,a2,64 # ffffffffc0208480 <default_pmm_manager+0x1140>
ffffffffc0205448:	1ea00593          	li	a1,490
ffffffffc020544c:	00003517          	auipc	a0,0x3
ffffffffc0205450:	fc450513          	addi	a0,a0,-60 # ffffffffc0208410 <default_pmm_manager+0x10d0>
...
ffffffffc020545e:	bf1d                	j	ffffffffc0205394 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0205460:	2f7000ef          	jal	ra,ffffffffc0205f56 <wakeup_proc>
...
ffffffffc0205488:	42cb8b93          	addi	s7,s7,1068 # ffffffffc02b28b0 <current>
    if (0 < pid && pid < MAX_PID) {
...
ffffffffc02054a2:	4a1000ef          	jal	ra,ffffffffc0206142 <hash32>
...
ffffffffc02054b2:	37a78793          	addi	a5,a5,890 # ffffffffc02ae828 <hash_list>
...
ffffffffc02054fc:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc0205500:	2d7000ef          	jal	ra,ffffffffc0205fd6 <schedule>
        if (current->flags & PF_EXITING) {
...
ffffffffc0205532:	38a7b783          	ld	a5,906(a5) # ffffffffc02b28b8 <idleproc>
ffffffffc0205536:	0c878963          	beq	a5,s0,ffffffffc0205608 <do_wait.part.0+0x1a2>
ffffffffc020553a:	000ad797          	auipc	a5,0xad
ffffffffc020553e:	3867b783          	ld	a5,902(a5) # ffffffffc02b28c0 <initproc>
...
ffffffffc020554e:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb8>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0205582:	34a70713          	addi	a4,a4,842 # ffffffffc02b28c8 <nr_process>
...
ffffffffc02055f4:	e3060613          	addi	a2,a2,-464 # ffffffffc0207420 <default_pmm_manager+0xe0>
ffffffffc02055f8:	06e00593          	li	a1,110
ffffffffc02055fc:	00002517          	auipc	a0,0x2
ffffffffc0205600:	da450513          	addi	a0,a0,-604 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc0205604:	e77fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc0205608:	00003617          	auipc	a2,0x3
ffffffffc020560c:	ea860613          	addi	a2,a2,-344 # ffffffffc02084b0 <default_pmm_manager+0x1170>
ffffffffc0205610:	30d00593          	li	a1,781
ffffffffc0205614:	00003517          	auipc	a0,0x3
ffffffffc0205618:	dfc50513          	addi	a0,a0,-516 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc020561c:	e5ffa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205620:	00002617          	auipc	a2,0x2
ffffffffc0205624:	e2860613          	addi	a2,a2,-472 # ffffffffc0207448 <default_pmm_manager+0x108>
ffffffffc0205628:	06200593          	li	a1,98
ffffffffc020562c:	00002517          	auipc	a0,0x2
ffffffffc0205630:	d7450513          	addi	a0,a0,-652 # ffffffffc02073a0 <default_pmm_manager+0x60>
...
ffffffffc020564c:	71650513          	addi	a0,a0,1814 # ffffffffc0204d5e <user_main>
...
ffffffffc0205658:	a071                	j	ffffffffc02056e4 <init_main+0xac>
    ...
    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc020565a:	17d000ef          	jal	ra,ffffffffc0205fd6 <schedule>
    if (code_store != NULL) {
...
ffffffffc020566c:	e8850513          	addi	a0,a0,-376 # ffffffffc02084f0 <default_pmm_manager+0x11b0>
ffffffffc0205670:	b11fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205674:	000ad797          	auipc	a5,0xad
ffffffffc0205678:	24c7b783          	ld	a5,588(a5) # ffffffffc02b28c0 <initproc>
...
ffffffffc020568e:	23e6a683          	lw	a3,574(a3) # ffffffffc02b28c8 <nr_process>
...
ffffffffc020569c:	19068693          	addi	a3,a3,400 # ffffffffc02b2828 <proc_list>
...
ffffffffc02056b4:	f2850513          	addi	a0,a0,-216 # ffffffffc02085d8 <default_pmm_manager+0x1298>
...
ffffffffc02056c8:	e5468693          	addi	a3,a3,-428 # ffffffffc0208518 <default_pmm_manager+0x11d8>
ffffffffc02056cc:	00001617          	auipc	a2,0x1
ffffffffc02056d0:	5dc60613          	addi	a2,a2,1500 # ffffffffc0206ca8 <commands+0x450>
ffffffffc02056d4:	37200593          	li	a1,882
ffffffffc02056d8:	00003517          	auipc	a0,0x3
ffffffffc02056dc:	d3850513          	addi	a0,a0,-712 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc02056e0:	d9bfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc02056e4:	00003617          	auipc	a2,0x3
ffffffffc02056e8:	dec60613          	addi	a2,a2,-532 # ffffffffc02084d0 <default_pmm_manager+0x1190>
ffffffffc02056ec:	36a00593          	li	a1,874
ffffffffc02056f0:	00003517          	auipc	a0,0x3
ffffffffc02056f4:	d2050513          	addi	a0,a0,-736 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc02056f8:	d83fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056fc:	00003697          	auipc	a3,0x3
ffffffffc0205700:	eac68693          	addi	a3,a3,-340 # ffffffffc02085a8 <default_pmm_manager+0x1268>
ffffffffc0205704:	00001617          	auipc	a2,0x1
ffffffffc0205708:	5a460613          	addi	a2,a2,1444 # ffffffffc0206ca8 <commands+0x450>
ffffffffc020570c:	37500593          	li	a1,885
ffffffffc0205710:	00003517          	auipc	a0,0x3
ffffffffc0205714:	d0050513          	addi	a0,a0,-768 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205718:	d63fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020571c:	00003697          	auipc	a3,0x3
ffffffffc0205720:	e5c68693          	addi	a3,a3,-420 # ffffffffc0208578 <default_pmm_manager+0x1238>
ffffffffc0205724:	00001617          	auipc	a2,0x1
ffffffffc0205728:	58460613          	addi	a2,a2,1412 # ffffffffc0206ca8 <commands+0x450>
ffffffffc020572c:	37400593          	li	a1,884
ffffffffc0205730:	00003517          	auipc	a0,0x3
ffffffffc0205734:	ce050513          	addi	a0,a0,-800 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205738:	d43fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc020573c:	00003697          	auipc	a3,0x3
ffffffffc0205740:	e2c68693          	addi	a3,a3,-468 # ffffffffc0208568 <default_pmm_manager+0x1228>
ffffffffc0205744:	00001617          	auipc	a2,0x1
ffffffffc0205748:	56460613          	addi	a2,a2,1380 # ffffffffc0206ca8 <commands+0x450>
ffffffffc020574c:	37300593          	li	a1,883
ffffffffc0205750:	00003517          	auipc	a0,0x3
ffffffffc0205754:	cc050513          	addi	a0,a0,-832 # ffffffffc0208410 <default_pmm_manager+0x10d0>
...
ffffffffc0205764:	150d8d93          	addi	s11,s11,336 # ffffffffc02b28b0 <current>
...
ffffffffc0205796:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205798:	b56ff0ef          	jal	ra,ffffffffc0204aee <user_mem_check>
ffffffffc020579c:	40050a63          	beqz	a0,ffffffffc0205bb0 <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc02057a0:	4641                	li	a2,16
ffffffffc02057a2:	4581                	li	a1,0
ffffffffc02057a4:	1808                	addi	a0,sp,48
ffffffffc02057a6:	61d000ef          	jal	ra,ffffffffc02065c2 <memset>
    memcpy(local_name, name, len);
ffffffffc02057aa:	47bd                	li	a5,15
ffffffffc02057ac:	8626                	mv	a2,s1
ffffffffc02057ae:	1e97e263          	bltu	a5,s1,ffffffffc0205992 <do_execve+0x236>
ffffffffc02057b2:	85ca                	mv	a1,s2
ffffffffc02057b4:	1808                	addi	a0,sp,48
ffffffffc02057b6:	61f000ef          	jal	ra,ffffffffc02065d4 <memcpy>
    if (mm != NULL) {
ffffffffc02057ba:	1e098363          	beqz	s3,ffffffffc02059a0 <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc02057be:	00002517          	auipc	a0,0x2
ffffffffc02057c2:	30a50513          	addi	a0,a0,778 # ffffffffc0207ac8 <default_pmm_manager+0x788>
ffffffffc02057c6:	9f3fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc02057ca:	000ad797          	auipc	a5,0xad
ffffffffc02057ce:	08e7b783          	ld	a5,142(a5) # ffffffffc02b2858 <boot_cr3>
...
ffffffffc02057de:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b88>
ffffffffc02057e2:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057e6:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057ea:	2c070463          	beqz	a4,ffffffffc0205ab2 <do_execve+0x356>
        current->mm = NULL;
...
ffffffffc02057fc:	1c050d63          	beqz	a0,ffffffffc02059d6 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205800:	4505                	li	a0,1
ffffffffc0205802:	cdefc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205806:	3a050963          	beqz	a0,ffffffffc0205bb8 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc020580a:	000adc97          	auipc	s9,0xad
ffffffffc020580e:	066c8c93          	addi	s9,s9,102 # ffffffffc02b2870 <pages>
ffffffffc0205812:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc0205816:	000adc17          	auipc	s8,0xad
ffffffffc020581a:	052c0c13          	addi	s8,s8,82 # ffffffffc02b2868 <npage>
    return page - pages + nbase;
ffffffffc020581e:	00003717          	auipc	a4,0x3
ffffffffc0205822:	4aa73703          	ld	a4,1194(a4) # ffffffffc0208cc8 <nbase>
...
ffffffffc020583e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205840:	38f77063          	bgeu	a4,a5,ffffffffc0205bc0 <do_execve+0x464>
ffffffffc0205844:	000adb17          	auipc	s6,0xad
ffffffffc0205848:	03cb0b13          	addi	s6,s6,60 # ffffffffc02b2880 <va_pa_offset>
ffffffffc020584c:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205850:	6605                	lui	a2,0x1
ffffffffc0205852:	000ad597          	auipc	a1,0xad
ffffffffc0205856:	00e5b583          	ld	a1,14(a1) # ffffffffc02b2860 <boot_pgdir>
ffffffffc020585a:	9936                	add	s2,s2,a3
ffffffffc020585c:	854a                	mv	a0,s2
ffffffffc020585e:	577000ef          	jal	ra,ffffffffc02065d4 <memcpy>
...
ffffffffc020586a:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc020586e:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9457>
ffffffffc0205872:	14f71863          	bne	a4,a5,ffffffffc02059c2 <do_execve+0x266>
...
ffffffffc0205898:	14e78163          	beq	a5,a4,ffffffffc02059da <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
...
ffffffffc02058ba:	1e051263          	bnez	a0,ffffffffc0205a9e <do_execve+0x342>
...
ffffffffc02058ca:	38050363          	beqz	a0,ffffffffc0205c50 <do_execve+0x4f4>
...
ffffffffc02058da:	34050b63          	beqz	a0,ffffffffc0205c30 <do_execve+0x4d4>
...
ffffffffc02058ea:	32050363          	beqz	a0,ffffffffc0205c10 <do_execve+0x4b4>
...
ffffffffc02058fa:	2e050b63          	beqz	a0,ffffffffc0205bf0 <do_execve+0x494>
    mm->mm_count += 1;
...
ffffffffc0205910:	2cf6e463          	bltu	a3,a5,ffffffffc0205bd8 <do_execve+0x47c>
...
ffffffffc0205934:	48f000ef          	jal	ra,ffffffffc02065c2 <memset>
    tf->epc = elf->e_entry;
...
ffffffffc0205952:	0207e793          	ori	a5,a5,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205956:	0b440413          	addi	s0,s0,180
ffffffffc020595a:	4641                	li	a2,16
ffffffffc020595c:	4581                	li	a1,0
    tf->status = (read_csr(sstatus) | SSTATUS_SPIE ) & ~SSTATUS_SPP;
ffffffffc020595e:	10f4b023          	sd	a5,256(s1)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205962:	8522                	mv	a0,s0
ffffffffc0205964:	45f000ef          	jal	ra,ffffffffc02065c2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205968:	463d                	li	a2,15
ffffffffc020596a:	180c                	addi	a1,sp,48
ffffffffc020596c:	8522                	mv	a0,s0
ffffffffc020596e:	467000ef          	jal	ra,ffffffffc02065d4 <memcpy>
}
ffffffffc0205972:	70aa                	ld	ra,168(sp)
ffffffffc0205974:	740a                	ld	s0,160(sp)
ffffffffc0205976:	64ea                	ld	s1,152(sp)
ffffffffc0205978:	69aa                	ld	s3,136(sp)
ffffffffc020597a:	6a0a                	ld	s4,128(sp)
ffffffffc020597c:	7ae6                	ld	s5,120(sp)
ffffffffc020597e:	7b46                	ld	s6,112(sp)
ffffffffc0205980:	7ba6                	ld	s7,104(sp)
ffffffffc0205982:	7c06                	ld	s8,96(sp)
ffffffffc0205984:	6ce6                	ld	s9,88(sp)
ffffffffc0205986:	6d46                	ld	s10,80(sp)
ffffffffc0205988:	6da6                	ld	s11,72(sp)
ffffffffc020598a:	854a                	mv	a0,s2
ffffffffc020598c:	694a                	ld	s2,144(sp)
ffffffffc020598e:	614d                	addi	sp,sp,176
ffffffffc0205990:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205992:	463d                	li	a2,15
ffffffffc0205994:	85ca                	mv	a1,s2
ffffffffc0205996:	1808                	addi	a0,sp,48
ffffffffc0205998:	43d000ef          	jal	ra,ffffffffc02065d4 <memcpy>
    if (mm != NULL) {
ffffffffc020599c:	e20991e3          	bnez	s3,ffffffffc02057be <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc02059a0:	000db783          	ld	a5,0(s11)
ffffffffc02059a4:	779c                	ld	a5,40(a5)
ffffffffc02059a6:	e40788e3          	beqz	a5,ffffffffc02057f6 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc02059aa:	00003617          	auipc	a2,0x3
ffffffffc02059ae:	c4e60613          	addi	a2,a2,-946 # ffffffffc02085f8 <default_pmm_manager+0x12b8>
ffffffffc02059b2:	21d00593          	li	a1,541
ffffffffc02059b6:	00003517          	auipc	a0,0x3
ffffffffc02059ba:	a5a50513          	addi	a0,a0,-1446 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc02059be:	abdfa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc02059c2:	8526                	mv	a0,s1
ffffffffc02059c4:	c18ff0ef          	jal	ra,ffffffffc0204ddc <put_pgdir>
    mm_destroy(mm);
ffffffffc02059c8:	8526                	mv	a0,s1
ffffffffc02059ca:	8ddfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc02059ce:	5961                	li	s2,-8
    do_exit(ret);
ffffffffc02059d0:	854a                	mv	a0,s2
ffffffffc02059d2:	94bff0ef          	jal	ra,ffffffffc020531c <do_exit>
    int ret = -E_NO_MEM;
ffffffffc02059d6:	5971                	li	s2,-4
ffffffffc02059d8:	bfe5                	j	ffffffffc02059d0 <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc02059da:	0289b603          	ld	a2,40(s3)
ffffffffc02059de:	0209b783          	ld	a5,32(s3)
ffffffffc02059e2:	1cf66d63          	bltu	a2,a5,ffffffffc0205bbc <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059e6:	0049a783          	lw	a5,4(s3)
ffffffffc02059ea:	0017f693          	andi	a3,a5,1
ffffffffc02059ee:	c291                	beqz	a3,ffffffffc02059f2 <do_execve+0x296>
ffffffffc02059f0:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059f2:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059f6:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059f8:	e779                	bnez	a4,ffffffffc0205ac6 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc02059fa:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059fc:	c781                	beqz	a5,ffffffffc0205a04 <do_execve+0x2a8>
ffffffffc02059fe:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a02:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a04:	0026f793          	andi	a5,a3,2
ffffffffc0205a08:	e3f1                	bnez	a5,ffffffffc0205acc <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205a0a:	0046f793          	andi	a5,a3,4
ffffffffc0205a0e:	c399                	beqz	a5,ffffffffc0205a14 <do_execve+0x2b8>
ffffffffc0205a10:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205a14:	0109b583          	ld	a1,16(s3)
ffffffffc0205a18:	4701                	li	a4,0
ffffffffc0205a1a:	8526                	mv	a0,s1
ffffffffc0205a1c:	8ddfe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205a20:	892a                	mv	s2,a0
ffffffffc0205a22:	ed35                	bnez	a0,ffffffffc0205a9e <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a24:	0109bb83          	ld	s7,16(s3)
ffffffffc0205a28:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a2a:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a2e:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a32:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a36:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a38:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a3a:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc0205a3c:	054be963          	bltu	s7,s4,ffffffffc0205a8e <do_execve+0x332>
ffffffffc0205a40:	aa95                	j	ffffffffc0205bb4 <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a42:	6785                	lui	a5,0x1
ffffffffc0205a44:	415b8533          	sub	a0,s7,s5
ffffffffc0205a48:	9abe                	add	s5,s5,a5
ffffffffc0205a4a:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a4e:	015a7463          	bgeu	s4,s5,ffffffffc0205a56 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0205a52:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a56:	000cb683          	ld	a3,0(s9)
ffffffffc0205a5a:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a5c:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
...
ffffffffc0205a6a:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a6e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a70:	14b87863          	bgeu	a6,a1,ffffffffc0205bc0 <do_execve+0x464>
ffffffffc0205a74:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a78:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a7a:	9bb2                	add	s7,s7,a2
ffffffffc0205a7c:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a7e:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a80:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a82:	353000ef          	jal	ra,ffffffffc02065d4 <memcpy>
            start += size, from += size;
ffffffffc0205a86:	6622                	ld	a2,8(sp)
ffffffffc0205a88:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a8a:	054bf363          	bgeu	s7,s4,ffffffffc0205ad0 <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a8e:	6c88                	ld	a0,24(s1)
ffffffffc0205a90:	866a                	mv	a2,s10
ffffffffc0205a92:	85d6                	mv	a1,s5
ffffffffc0205a94:	8b9fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a98:	842a                	mv	s0,a0
ffffffffc0205a9a:	f545                	bnez	a0,ffffffffc0205a42 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205a9c:	5971                	li	s2,-4
    exit_mmap(mm);
ffffffffc0205a9e:	8526                	mv	a0,s1
ffffffffc0205aa0:	9a3fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205aa4:	8526                	mv	a0,s1
ffffffffc0205aa6:	b36ff0ef          	jal	ra,ffffffffc0204ddc <put_pgdir>
    mm_destroy(mm);
ffffffffc0205aaa:	8526                	mv	a0,s1
ffffffffc0205aac:	ffafe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205ab0:	b705                	j	ffffffffc02059d0 <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205ab2:	854e                	mv	a0,s3
ffffffffc0205ab4:	98ffe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205ab8:	854e                	mv	a0,s3
ffffffffc0205aba:	b22ff0ef          	jal	ra,ffffffffc0204ddc <put_pgdir>
            mm_destroy(mm);
ffffffffc0205abe:	854e                	mv	a0,s3
ffffffffc0205ac0:	fe6fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205ac4:	b32d                	j	ffffffffc02057ee <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205ac6:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205aca:	fb95                	bnez	a5,ffffffffc02059fe <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205acc:	4d5d                	li	s10,23
ffffffffc0205ace:	bf35                	j	ffffffffc0205a0a <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205ad0:	0109b683          	ld	a3,16(s3)
ffffffffc0205ad4:	0289b903          	ld	s2,40(s3)
ffffffffc0205ad8:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205ada:	075bfd63          	bgeu	s7,s5,ffffffffc0205b54 <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205ade:	db790fe3          	beq	s2,s7,ffffffffc020589c <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205ae2:	6785                	lui	a5,0x1
ffffffffc0205ae4:	00fb8533          	add	a0,s7,a5
ffffffffc0205ae8:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205aec:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205af0:	0b597d63          	bgeu	s2,s5,ffffffffc0205baa <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205af4:	000cb683          	ld	a3,0(s9)
ffffffffc0205af8:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205afa:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
...
ffffffffc0205b0c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b0e:	0ac5f963          	bgeu	a1,a2,ffffffffc0205bc0 <do_execve+0x464>
ffffffffc0205b12:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b16:	8652                	mv	a2,s4
ffffffffc0205b18:	4581                	li	a1,0
ffffffffc0205b1a:	96c2                	add	a3,a3,a6
ffffffffc0205b1c:	9536                	add	a0,a0,a3
ffffffffc0205b1e:	2a5000ef          	jal	ra,ffffffffc02065c2 <memset>
            start += size;
ffffffffc0205b22:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205b26:	03597463          	bgeu	s2,s5,ffffffffc0205b4e <do_execve+0x3f2>
ffffffffc0205b2a:	d6e909e3          	beq	s2,a4,ffffffffc020589c <do_execve+0x140>
ffffffffc0205b2e:	00003697          	auipc	a3,0x3
ffffffffc0205b32:	af268693          	addi	a3,a3,-1294 # ffffffffc0208620 <default_pmm_manager+0x12e0>
ffffffffc0205b36:	00001617          	auipc	a2,0x1
ffffffffc0205b3a:	17260613          	addi	a2,a2,370 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205b3e:	27200593          	li	a1,626
ffffffffc0205b42:	00003517          	auipc	a0,0x3
ffffffffc0205b46:	8ce50513          	addi	a0,a0,-1842 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205b4a:	931fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b4e:	ff5710e3          	bne	a4,s5,ffffffffc0205b2e <do_execve+0x3d2>
ffffffffc0205b52:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b54:	d52bf4e3          	bgeu	s7,s2,ffffffffc020589c <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b58:	6c88                	ld	a0,24(s1)
ffffffffc0205b5a:	866a                	mv	a2,s10
ffffffffc0205b5c:	85d6                	mv	a1,s5
ffffffffc0205b5e:	feefd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b62:	842a                	mv	s0,a0
ffffffffc0205b64:	dd05                	beqz	a0,ffffffffc0205a9c <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b66:	6785                	lui	a5,0x1
ffffffffc0205b68:	415b8533          	sub	a0,s7,s5
ffffffffc0205b6c:	9abe                	add	s5,s5,a5
ffffffffc0205b6e:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b72:	01597463          	bgeu	s2,s5,ffffffffc0205b7a <do_execve+0x41e>
                size -= la - end;
ffffffffc0205b76:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b7a:	000cb683          	ld	a3,0(s9)
ffffffffc0205b7e:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b80:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b84:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b88:	8699                	srai	a3,a3,0x6
ffffffffc0205b8a:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b8c:	67e2                	ld	a5,24(sp)
ffffffffc0205b8e:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b92:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b94:	02b87663          	bgeu	a6,a1,ffffffffc0205bc0 <do_execve+0x464>
ffffffffc0205b98:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b9c:	4581                	li	a1,0
            start += size;
ffffffffc0205b9e:	9bb2                	add	s7,s7,a2
ffffffffc0205ba0:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ba2:	9536                	add	a0,a0,a3
ffffffffc0205ba4:	21f000ef          	jal	ra,ffffffffc02065c2 <memset>
ffffffffc0205ba8:	b775                	j	ffffffffc0205b54 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205baa:	417a8a33          	sub	s4,s5,s7
ffffffffc0205bae:	b799                	j	ffffffffc0205af4 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205bb0:	5975                	li	s2,-3
ffffffffc0205bb2:	b3c1                	j	ffffffffc0205972 <do_execve+0x216>
        while (start < end) {
ffffffffc0205bb4:	86de                	mv	a3,s7
ffffffffc0205bb6:	bf39                	j	ffffffffc0205ad4 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205bb8:	5971                	li	s2,-4
ffffffffc0205bba:	bdc5                	j	ffffffffc0205aaa <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205bbc:	5961                	li	s2,-8
ffffffffc0205bbe:	b5c5                	j	ffffffffc0205a9e <do_execve+0x342>
ffffffffc0205bc0:	00001617          	auipc	a2,0x1
ffffffffc0205bc4:	7b860613          	addi	a2,a2,1976 # ffffffffc0207378 <default_pmm_manager+0x38>
ffffffffc0205bc8:	06900593          	li	a1,105
ffffffffc0205bcc:	00001517          	auipc	a0,0x1
ffffffffc0205bd0:	7d450513          	addi	a0,a0,2004 # ffffffffc02073a0 <default_pmm_manager+0x60>
ffffffffc0205bd4:	8a7fa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205bd8:	00002617          	auipc	a2,0x2
ffffffffc0205bdc:	84860613          	addi	a2,a2,-1976 # ffffffffc0207420 <default_pmm_manager+0xe0>
ffffffffc0205be0:	28d00593          	li	a1,653
ffffffffc0205be4:	00003517          	auipc	a0,0x3
ffffffffc0205be8:	82c50513          	addi	a0,a0,-2004 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205bec:	88ffa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bf0:	00003697          	auipc	a3,0x3
ffffffffc0205bf4:	b4868693          	addi	a3,a3,-1208 # ffffffffc0208738 <default_pmm_manager+0x13f8>
ffffffffc0205bf8:	00001617          	auipc	a2,0x1
ffffffffc0205bfc:	0b060613          	addi	a2,a2,176 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205c00:	28800593          	li	a1,648
ffffffffc0205c04:	00003517          	auipc	a0,0x3
ffffffffc0205c08:	80c50513          	addi	a0,a0,-2036 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205c0c:	86ffa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c10:	00003697          	auipc	a3,0x3
ffffffffc0205c14:	ae068693          	addi	a3,a3,-1312 # ffffffffc02086f0 <default_pmm_manager+0x13b0>
ffffffffc0205c18:	00001617          	auipc	a2,0x1
ffffffffc0205c1c:	09060613          	addi	a2,a2,144 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205c20:	28700593          	li	a1,647
ffffffffc0205c24:	00002517          	auipc	a0,0x2
ffffffffc0205c28:	7ec50513          	addi	a0,a0,2028 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205c2c:	84ffa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c30:	00003697          	auipc	a3,0x3
ffffffffc0205c34:	a7868693          	addi	a3,a3,-1416 # ffffffffc02086a8 <default_pmm_manager+0x1368>
ffffffffc0205c38:	00001617          	auipc	a2,0x1
ffffffffc0205c3c:	07060613          	addi	a2,a2,112 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205c40:	28600593          	li	a1,646
ffffffffc0205c44:	00002517          	auipc	a0,0x2
ffffffffc0205c48:	7cc50513          	addi	a0,a0,1996 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205c4c:	82ffa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c50:	00003697          	auipc	a3,0x3
ffffffffc0205c54:	a1068693          	addi	a3,a3,-1520 # ffffffffc0208660 <default_pmm_manager+0x1320>
ffffffffc0205c58:	00001617          	auipc	a2,0x1
ffffffffc0205c5c:	05060613          	addi	a2,a2,80 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205c60:	28500593          	li	a1,645
ffffffffc0205c64:	00002517          	auipc	a0,0x2
ffffffffc0205c68:	7ac50513          	addi	a0,a0,1964 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205c6c:	80ffa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c70 <do_yield>:
    current->need_resched = 1;
ffffffffc0205c70:	000ad797          	auipc	a5,0xad
ffffffffc0205c74:	c407b783          	ld	a5,-960(a5) # ffffffffc02b28b0 <current>
ffffffffc0205c78:	4705                	li	a4,1
ffffffffc0205c7a:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c7c:	4501                	li	a0,0
ffffffffc0205c7e:	8082                	ret

ffffffffc0205c80 <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c80:	1101                	addi	sp,sp,-32
ffffffffc0205c82:	e822                	sd	s0,16(sp)
ffffffffc0205c84:	e426                	sd	s1,8(sp)
ffffffffc0205c86:	ec06                	sd	ra,24(sp)
ffffffffc0205c88:	842e                	mv	s0,a1
ffffffffc0205c8a:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c8c:	c999                	beqz	a1,ffffffffc0205ca2 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c8e:	000ad797          	auipc	a5,0xad
ffffffffc0205c92:	c227b783          	ld	a5,-990(a5) # ffffffffc02b28b0 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c96:	7788                	ld	a0,40(a5)
ffffffffc0205c98:	4685                	li	a3,1
ffffffffc0205c9a:	4611                	li	a2,4
ffffffffc0205c9c:	e53fe0ef          	jal	ra,ffffffffc0204aee <user_mem_check>
ffffffffc0205ca0:	c909                	beqz	a0,ffffffffc0205cb2 <do_wait+0x32>
ffffffffc0205ca2:	85a2                	mv	a1,s0
}
ffffffffc0205ca4:	6442                	ld	s0,16(sp)
ffffffffc0205ca6:	60e2                	ld	ra,24(sp)
ffffffffc0205ca8:	8526                	mv	a0,s1
ffffffffc0205caa:	64a2                	ld	s1,8(sp)
ffffffffc0205cac:	6105                	addi	sp,sp,32
ffffffffc0205cae:	fb8ff06f          	j	ffffffffc0205466 <do_wait.part.0>
ffffffffc0205cb2:	60e2                	ld	ra,24(sp)
ffffffffc0205cb4:	6442                	ld	s0,16(sp)
ffffffffc0205cb6:	64a2                	ld	s1,8(sp)
ffffffffc0205cb8:	5575                	li	a0,-3
ffffffffc0205cba:	6105                	addi	sp,sp,32
ffffffffc0205cbc:	8082                	ret

ffffffffc0205cbe <do_kill>:
do_kill(int pid) {
ffffffffc0205cbe:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205cc0:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205cc2:	e406                	sd	ra,8(sp)
ffffffffc0205cc4:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205cc6:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205cca:	17f9                	addi	a5,a5,-2
ffffffffc0205ccc:	02e7e963          	bltu	a5,a4,ffffffffc0205cfe <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205cd0:	842a                	mv	s0,a0
ffffffffc0205cd2:	45a9                	li	a1,10
ffffffffc0205cd4:	2501                	sext.w	a0,a0
ffffffffc0205cd6:	46c000ef          	jal	ra,ffffffffc0206142 <hash32>
ffffffffc0205cda:	02051793          	slli	a5,a0,0x20
ffffffffc0205cde:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205ce2:	000a9797          	auipc	a5,0xa9
ffffffffc0205ce6:	b4678793          	addi	a5,a5,-1210 # ffffffffc02ae828 <hash_list>
ffffffffc0205cea:	953e                	add	a0,a0,a5
ffffffffc0205cec:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205cee:	a029                	j	ffffffffc0205cf8 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205cf0:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cf4:	00870b63          	beq	a4,s0,ffffffffc0205d0a <do_kill+0x4c>
ffffffffc0205cf8:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205cfa:	fef51be3          	bne	a0,a5,ffffffffc0205cf0 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205cfe:	5475                	li	s0,-3
}
ffffffffc0205d00:	60a2                	ld	ra,8(sp)
ffffffffc0205d02:	8522                	mv	a0,s0
ffffffffc0205d04:	6402                	ld	s0,0(sp)
ffffffffc0205d06:	0141                	addi	sp,sp,16
ffffffffc0205d08:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205d0a:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205d0e:	00177693          	andi	a3,a4,1
ffffffffc0205d12:	e295                	bnez	a3,ffffffffc0205d36 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d14:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205d16:	00176713          	ori	a4,a4,1
ffffffffc0205d1a:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205d1e:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d20:	fe06d0e3          	bgez	a3,ffffffffc0205d00 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205d24:	f2878513          	addi	a0,a5,-216
ffffffffc0205d28:	22e000ef          	jal	ra,ffffffffc0205f56 <wakeup_proc>
}
ffffffffc0205d2c:	60a2                	ld	ra,8(sp)
ffffffffc0205d2e:	8522                	mv	a0,s0
ffffffffc0205d30:	6402                	ld	s0,0(sp)
ffffffffc0205d32:	0141                	addi	sp,sp,16
ffffffffc0205d34:	8082                	ret
        return -E_KILLED;
ffffffffc0205d36:	545d                	li	s0,-9
ffffffffc0205d38:	b7e1                	j	ffffffffc0205d00 <do_kill+0x42>
...
void
proc_init(void) {
ffffffffc0205d3a:	1101                	addi	sp,sp,-32
ffffffffc0205d3c:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205d3e:	000ad797          	auipc	a5,0xad
ffffffffc0205d42:	aea78793          	addi	a5,a5,-1302 # ffffffffc02b2828 <proc_list>
ffffffffc0205d46:	ec06                	sd	ra,24(sp)
ffffffffc0205d48:	e822                	sd	s0,16(sp)
ffffffffc0205d4a:	e04a                	sd	s2,0(sp)
ffffffffc0205d4c:	000a9497          	auipc	s1,0xa9
ffffffffc0205d50:	adc48493          	addi	s1,s1,-1316 # ffffffffc02ae828 <hash_list>
ffffffffc0205d54:	e79c                	sd	a5,8(a5)
ffffffffc0205d56:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205d58:	000ad717          	auipc	a4,0xad
ffffffffc0205d5c:	ad070713          	addi	a4,a4,-1328 # ffffffffc02b2828 <proc_list>
ffffffffc0205d60:	87a6                	mv	a5,s1
ffffffffc0205d62:	e79c                	sd	a5,8(a5)
ffffffffc0205d64:	e39c                	sd	a5,0(a5)
ffffffffc0205d66:	07c1                	addi	a5,a5,16
ffffffffc0205d68:	fef71de3          	bne	a4,a5,ffffffffc0205d62 <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d6c:	f73fe0ef          	jal	ra,ffffffffc0204cde <alloc_proc>
ffffffffc0205d70:	000ad917          	auipc	s2,0xad
ffffffffc0205d74:	b4890913          	addi	s2,s2,-1208 # ffffffffc02b28b8 <idleproc>
ffffffffc0205d78:	00a93023          	sd	a0,0(s2)
ffffffffc0205d7c:	0e050f63          	beqz	a0,ffffffffc0205e7a <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d80:	4789                	li	a5,2
ffffffffc0205d82:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d84:	00003797          	auipc	a5,0x3
ffffffffc0205d88:	27c78793          	addi	a5,a5,636 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d8c:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d90:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d92:	4785                	li	a5,1
ffffffffc0205d94:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d96:	4641                	li	a2,16
ffffffffc0205d98:	4581                	li	a1,0
ffffffffc0205d9a:	8522                	mv	a0,s0
ffffffffc0205d9c:	027000ef          	jal	ra,ffffffffc02065c2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205da0:	463d                	li	a2,15
ffffffffc0205da2:	00003597          	auipc	a1,0x3
ffffffffc0205da6:	9f658593          	addi	a1,a1,-1546 # ffffffffc0208798 <default_pmm_manager+0x1458>
ffffffffc0205daa:	8522                	mv	a0,s0
ffffffffc0205dac:	029000ef          	jal	ra,ffffffffc02065d4 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205db0:	000ad717          	auipc	a4,0xad
ffffffffc0205db4:	b1870713          	addi	a4,a4,-1256 # ffffffffc02b28c8 <nr_process>
ffffffffc0205db8:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205dba:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205dbe:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205dc0:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205dc2:	4581                	li	a1,0
ffffffffc0205dc4:	00000517          	auipc	a0,0x0
ffffffffc0205dc8:	87450513          	addi	a0,a0,-1932 # ffffffffc0205638 <init_main>
    nr_process ++;
ffffffffc0205dcc:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205dce:	000ad797          	auipc	a5,0xad
ffffffffc0205dd2:	aed7b123          	sd	a3,-1310(a5) # ffffffffc02b28b0 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205dd6:	cf6ff0ef          	jal	ra,ffffffffc02052cc <kernel_thread>
ffffffffc0205dda:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205ddc:	08a05363          	blez	a0,ffffffffc0205e62 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205de0:	6789                	lui	a5,0x2
ffffffffc0205de2:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205de6:	17f9                	addi	a5,a5,-2
ffffffffc0205de8:	2501                	sext.w	a0,a0
ffffffffc0205dea:	02e7e363          	bltu	a5,a4,ffffffffc0205e10 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205dee:	45a9                	li	a1,10
ffffffffc0205df0:	352000ef          	jal	ra,ffffffffc0206142 <hash32>
ffffffffc0205df4:	02051793          	slli	a5,a0,0x20
ffffffffc0205df8:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205dfc:	96a6                	add	a3,a3,s1
ffffffffc0205dfe:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205e00:	a029                	j	ffffffffc0205e0a <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205e02:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c8c>
ffffffffc0205e06:	04870b63          	beq	a4,s0,ffffffffc0205e5c <proc_init+0x122>
    return listelm->next;
ffffffffc0205e0a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205e0c:	fef69be3          	bne	a3,a5,ffffffffc0205e02 <proc_init+0xc8>
    return NULL;
ffffffffc0205e10:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e12:	0b478493          	addi	s1,a5,180
ffffffffc0205e16:	4641                	li	a2,16
ffffffffc0205e18:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205e1a:	000ad417          	auipc	s0,0xad
ffffffffc0205e1e:	aa640413          	addi	s0,s0,-1370 # ffffffffc02b28c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e22:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205e24:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e26:	79c000ef          	jal	ra,ffffffffc02065c2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205e2a:	463d                	li	a2,15
ffffffffc0205e2c:	00003597          	auipc	a1,0x3
ffffffffc0205e30:	99458593          	addi	a1,a1,-1644 # ffffffffc02087c0 <default_pmm_manager+0x1480>
ffffffffc0205e34:	8526                	mv	a0,s1
ffffffffc0205e36:	79e000ef          	jal	ra,ffffffffc02065d4 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e3a:	00093783          	ld	a5,0(s2)
ffffffffc0205e3e:	cbb5                	beqz	a5,ffffffffc0205eb2 <proc_init+0x178>
ffffffffc0205e40:	43dc                	lw	a5,4(a5)
ffffffffc0205e42:	eba5                	bnez	a5,ffffffffc0205eb2 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e44:	601c                	ld	a5,0(s0)
ffffffffc0205e46:	c7b1                	beqz	a5,ffffffffc0205e92 <proc_init+0x158>
ffffffffc0205e48:	43d8                	lw	a4,4(a5)
ffffffffc0205e4a:	4785                	li	a5,1
ffffffffc0205e4c:	04f71363          	bne	a4,a5,ffffffffc0205e92 <proc_init+0x158>
}
ffffffffc0205e50:	60e2                	ld	ra,24(sp)
ffffffffc0205e52:	6442                	ld	s0,16(sp)
ffffffffc0205e54:	64a2                	ld	s1,8(sp)
ffffffffc0205e56:	6902                	ld	s2,0(sp)
ffffffffc0205e58:	6105                	addi	sp,sp,32
ffffffffc0205e5a:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e5c:	f2878793          	addi	a5,a5,-216
ffffffffc0205e60:	bf4d                	j	ffffffffc0205e12 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e62:	00003617          	auipc	a2,0x3
ffffffffc0205e66:	93e60613          	addi	a2,a2,-1730 # ffffffffc02087a0 <default_pmm_manager+0x1460>
ffffffffc0205e6a:	39500593          	li	a1,917
ffffffffc0205e6e:	00002517          	auipc	a0,0x2
ffffffffc0205e72:	5a250513          	addi	a0,a0,1442 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205e76:	e04fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e7a:	00003617          	auipc	a2,0x3
ffffffffc0205e7e:	90660613          	addi	a2,a2,-1786 # ffffffffc0208780 <default_pmm_manager+0x1440>
ffffffffc0205e82:	38700593          	li	a1,903
ffffffffc0205e86:	00002517          	auipc	a0,0x2
ffffffffc0205e8a:	58a50513          	addi	a0,a0,1418 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205e8e:	decfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e92:	00003697          	auipc	a3,0x3
ffffffffc0205e96:	95e68693          	addi	a3,a3,-1698 # ffffffffc02087f0 <default_pmm_manager+0x14b0>
ffffffffc0205e9a:	00001617          	auipc	a2,0x1
ffffffffc0205e9e:	e0e60613          	addi	a2,a2,-498 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205ea2:	39c00593          	li	a1,924
ffffffffc0205ea6:	00002517          	auipc	a0,0x2
ffffffffc0205eaa:	56a50513          	addi	a0,a0,1386 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205eae:	dccfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205eb2:	00003697          	auipc	a3,0x3
ffffffffc0205eb6:	91668693          	addi	a3,a3,-1770 # ffffffffc02087c8 <default_pmm_manager+0x1488>
ffffffffc0205eba:	00001617          	auipc	a2,0x1
ffffffffc0205ebe:	dee60613          	addi	a2,a2,-530 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205ec2:	39b00593          	li	a1,923
ffffffffc0205ec6:	00002517          	auipc	a0,0x2
ffffffffc0205eca:	54a50513          	addi	a0,a0,1354 # ffffffffc0208410 <default_pmm_manager+0x10d0>
ffffffffc0205ece:	dacfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205ed2 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205ed2:	1141                	addi	sp,sp,-16
ffffffffc0205ed4:	e022                	sd	s0,0(sp)
ffffffffc0205ed6:	e406                	sd	ra,8(sp)
ffffffffc0205ed8:	000ad417          	auipc	s0,0xad
ffffffffc0205edc:	9d840413          	addi	s0,s0,-1576 # ffffffffc02b28b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205ee0:	6018                	ld	a4,0(s0)
ffffffffc0205ee2:	6f1c                	ld	a5,24(a4)
ffffffffc0205ee4:	dffd                	beqz	a5,ffffffffc0205ee2 <cpu_idle+0x10>
            schedule();
ffffffffc0205ee6:	0f0000ef          	jal	ra,ffffffffc0205fd6 <schedule>
ffffffffc0205eea:	bfdd                	j	ffffffffc0205ee0 <cpu_idle+0xe>

ffffffffc0205eec <switch_to>:
.text
...
ffffffffc0205eec:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205ef0:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205ef4:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205ef6:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205ef8:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205efc:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205f00:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205f04:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205f08:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205f0c:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205f10:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205f14:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205f18:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205f1c:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205f20:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205f24:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205f28:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205f2a:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205f2c:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205f30:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205f34:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205f38:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205f3c:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205f40:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205f44:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f48:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f4c:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f50:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205f54:	8082                	ret

ffffffffc0205f56 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205f56:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205f58:	1101                	addi	sp,sp,-32
ffffffffc0205f5a:	ec06                	sd	ra,24(sp)
ffffffffc0205f5c:	e822                	sd	s0,16(sp)
ffffffffc0205f5e:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f60:	478d                	li	a5,3
ffffffffc0205f62:	04f70b63          	beq	a4,a5,ffffffffc0205fb8 <wakeup_proc+0x62>
ffffffffc0205f66:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f68:	100027f3          	csrr	a5,sstatus
ffffffffc0205f6c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f6e:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f70:	ef9d                	bnez	a5,ffffffffc0205fae <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f72:	4789                	li	a5,2
ffffffffc0205f74:	02f70163          	beq	a4,a5,ffffffffc0205f96 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f78:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f7a:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f7e:	e491                	bnez	s1,ffffffffc0205f8a <wakeup_proc+0x34>
        else {
...
ffffffffc0205f80:	60e2                	ld	ra,24(sp)
ffffffffc0205f82:	6442                	ld	s0,16(sp)
ffffffffc0205f84:	64a2                	ld	s1,8(sp)
...
ffffffffc0205f90:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f92:	eaefa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f96:	00003617          	auipc	a2,0x3
ffffffffc0205f9a:	8ba60613          	addi	a2,a2,-1862 # ffffffffc0208850 <default_pmm_manager+0x1510>
ffffffffc0205f9e:	45c9                	li	a1,18
ffffffffc0205fa0:	00003517          	auipc	a0,0x3
ffffffffc0205fa4:	89850513          	addi	a0,a0,-1896 # ffffffffc0208838 <default_pmm_manager+0x14f8>
ffffffffc0205fa8:	d3afa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205fac:	bfc9                	j	ffffffffc0205f7e <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205fae:	e98fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205fb2:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205fb4:	4485                	li	s1,1
ffffffffc0205fb6:	bf75                	j	ffffffffc0205f72 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205fb8:	00003697          	auipc	a3,0x3
ffffffffc0205fbc:	86068693          	addi	a3,a3,-1952 # ffffffffc0208818 <default_pmm_manager+0x14d8>
ffffffffc0205fc0:	00001617          	auipc	a2,0x1
ffffffffc0205fc4:	ce860613          	addi	a2,a2,-792 # ffffffffc0206ca8 <commands+0x450>
ffffffffc0205fc8:	45a5                	li	a1,9
ffffffffc0205fca:	00003517          	auipc	a0,0x3
ffffffffc0205fce:	86e50513          	addi	a0,a0,-1938 # ffffffffc0208838 <default_pmm_manager+0x14f8>
ffffffffc0205fd2:	ca8fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205fd6 <schedule>:

void
schedule(void) {
ffffffffc0205fd6:	1141                	addi	sp,sp,-16
ffffffffc0205fd8:	e406                	sd	ra,8(sp)
ffffffffc0205fda:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205fdc:	100027f3          	csrr	a5,sstatus
ffffffffc0205fe0:	8b89                	andi	a5,a5,2
ffffffffc0205fe2:	4401                	li	s0,0
ffffffffc0205fe4:	efbd                	bnez	a5,ffffffffc0206062 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205fe6:	000ad897          	auipc	a7,0xad
ffffffffc0205fea:	8ca8b883          	ld	a7,-1846(a7) # ffffffffc02b28b0 <current>
ffffffffc0205fee:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205ff2:	000ad517          	auipc	a0,0xad
ffffffffc0205ff6:	8c653503          	ld	a0,-1850(a0) # ffffffffc02b28b8 <idleproc>
ffffffffc0205ffa:	04a88e63          	beq	a7,a0,ffffffffc0206056 <schedule+0x80>
ffffffffc0205ffe:	0c888693          	addi	a3,a7,200
ffffffffc0206002:	000ad617          	auipc	a2,0xad
ffffffffc0206006:	82660613          	addi	a2,a2,-2010 # ffffffffc02b2828 <proc_list>
        le = last;
ffffffffc020600a:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc020600e:	4809                	li	a6,2
ffffffffc0206010:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0206012:	00c78863          	beq	a5,a2,ffffffffc0206022 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0206016:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020601a:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020601e:	03070163          	beq	a4,a6,ffffffffc0206040 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0206022:	fef697e3          	bne	a3,a5,ffffffffc0206010 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0206026:	ed89                	bnez	a1,ffffffffc0206040 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0206028:	451c                	lw	a5,8(a0)
ffffffffc020602a:	2785                	addiw	a5,a5,1
ffffffffc020602c:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020602e:	00a88463          	beq	a7,a0,ffffffffc0206036 <schedule+0x60>
            proc_run(next);
ffffffffc0206032:	e21fe0ef          	jal	ra,ffffffffc0204e52 <proc_run>
    if (flag) {
ffffffffc0206036:	e819                	bnez	s0,ffffffffc020604c <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0206038:	60a2                	ld	ra,8(sp)
ffffffffc020603a:	6402                	ld	s0,0(sp)
...
ffffffffc0206044:	fef712e3          	bne	a4,a5,ffffffffc0206028 <schedule+0x52>
ffffffffc0206048:	852e                	mv	a0,a1
ffffffffc020604a:	bff9                	j	ffffffffc0206028 <schedule+0x52>
}
ffffffffc020604c:	6402                	ld	s0,0(sp)
ffffffffc020604e:	60a2                	ld	ra,8(sp)
ffffffffc0206050:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206052:	deefa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206056:	000ac617          	auipc	a2,0xac
ffffffffc020605a:	7d260613          	addi	a2,a2,2002 # ffffffffc02b2828 <proc_list>
ffffffffc020605e:	86b2                	mv	a3,a2
ffffffffc0206060:	b76d                	j	ffffffffc020600a <schedule+0x34>
        intr_disable();
ffffffffc0206062:	de4fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206066:	4405                	li	s0,1
ffffffffc0206068:	bfbd                	j	ffffffffc0205fe6 <schedule+0x10>

ffffffffc020606a <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc020606a:	000ad797          	auipc	a5,0xad
ffffffffc020606e:	8467b783          	ld	a5,-1978(a5) # ffffffffc02b28b0 <current>
}
ffffffffc0206072:	43c8                	lw	a0,4(a5)
ffffffffc0206074:	8082                	ret

ffffffffc0206076 <sys_pgdir>:
...
ffffffffc020607a <sys_putc>:
    cputchar(c);
ffffffffc020607a:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc020607c:	1141                	addi	sp,sp,-16
ffffffffc020607e:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0206080:	936fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
ffffffffc0206084:	60a2                	ld	ra,8(sp)
ffffffffc0206086:	4501                	li	a0,0
ffffffffc0206088:	0141                	addi	sp,sp,16
ffffffffc020608a:	8082                	ret

ffffffffc020608c <sys_kill>:
    return do_kill(pid);
ffffffffc020608c:	4108                	lw	a0,0(a0)
ffffffffc020608e:	c31ff06f          	j	ffffffffc0205cbe <do_kill>

ffffffffc0206092 <sys_yield>:
    return do_yield();
ffffffffc0206092:	bdfff06f          	j	ffffffffc0205c70 <do_yield>

ffffffffc0206096 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206096:	6d14                	ld	a3,24(a0)
ffffffffc0206098:	6910                	ld	a2,16(a0)
ffffffffc020609a:	650c                	ld	a1,8(a0)
ffffffffc020609c:	6108                	ld	a0,0(a0)
ffffffffc020609e:	ebeff06f          	j	ffffffffc020575c <do_execve>

ffffffffc02060a2 <sys_wait>:
    return do_wait(pid, store);
ffffffffc02060a2:	650c                	ld	a1,8(a0)
ffffffffc02060a4:	4108                	lw	a0,0(a0)
ffffffffc02060a6:	bdbff06f          	j	ffffffffc0205c80 <do_wait>

ffffffffc02060aa <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc02060aa:	000ad797          	auipc	a5,0xad
ffffffffc02060ae:	8067b783          	ld	a5,-2042(a5) # ffffffffc02b28b0 <current>
ffffffffc02060b2:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc02060b4:	4501                	li	a0,0
ffffffffc02060b6:	6a0c                	ld	a1,16(a2)
ffffffffc02060b8:	e07fe06f          	j	ffffffffc0204ebe <do_fork>

ffffffffc02060bc <sys_exit>:
    return do_exit(error_code);
ffffffffc02060bc:	4108                	lw	a0,0(a0)
ffffffffc02060be:	a5eff06f          	j	ffffffffc020531c <do_exit>

ffffffffc02060c2 <syscall>:
};
...
void
syscall(void) {
ffffffffc02060c2:	715d                	addi	sp,sp,-80
ffffffffc02060c4:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc02060c6:	000ac497          	auipc	s1,0xac
ffffffffc02060ca:	7ea48493          	addi	s1,s1,2026 # ffffffffc02b28b0 <current>
ffffffffc02060ce:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc02060d0:	e0a2                	sd	s0,64(sp)
ffffffffc02060d2:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc02060d4:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc02060d6:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02060d8:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc02060da:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02060de:	0327ee63          	bltu	a5,s2,ffffffffc020611a <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02060e2:	00391713          	slli	a4,s2,0x3
ffffffffc02060e6:	00002797          	auipc	a5,0x2
ffffffffc02060ea:	7d278793          	addi	a5,a5,2002 # ffffffffc02088b8 <syscalls>
ffffffffc02060ee:	97ba                	add	a5,a5,a4
ffffffffc02060f0:	639c                	ld	a5,0(a5)
ffffffffc02060f2:	c785                	beqz	a5,ffffffffc020611a <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02060f4:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02060f6:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02060f8:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02060fa:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02060fc:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02060fe:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc0206100:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc0206102:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc0206104:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc0206106:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc0206108:	0028                	addi	a0,sp,8
ffffffffc020610a:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc020610c:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc020610e:	e828                	sd	a0,80(s0)
}
ffffffffc0206110:	6406                	ld	s0,64(sp)
ffffffffc0206112:	74e2                	ld	s1,56(sp)
ffffffffc0206114:	7942                	ld	s2,48(sp)
ffffffffc0206116:	6161                	addi	sp,sp,80
ffffffffc0206118:	8082                	ret
    print_trapframe(tf);
ffffffffc020611a:	8522                	mv	a0,s0
ffffffffc020611c:	f18fa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc0206120:	609c                	ld	a5,0(s1)
ffffffffc0206122:	86ca                	mv	a3,s2
ffffffffc0206124:	00002617          	auipc	a2,0x2
ffffffffc0206128:	74c60613          	addi	a2,a2,1868 # ffffffffc0208870 <default_pmm_manager+0x1530>
ffffffffc020612c:	43d8                	lw	a4,4(a5)
ffffffffc020612e:	06200593          	li	a1,98
ffffffffc0206132:	0b478793          	addi	a5,a5,180
ffffffffc0206136:	00002517          	auipc	a0,0x2
ffffffffc020613a:	76a50513          	addi	a0,a0,1898 # ffffffffc02088a0 <default_pmm_manager+0x1560>
ffffffffc020613e:	b3cfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0206142 <hash32>:
 *
...
ffffffffc0206142:	9e3707b7          	lui	a5,0x9e370
ffffffffc0206146:	2785                	addiw	a5,a5,1
ffffffffc0206148:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc020614c:	02000793          	li	a5,32
ffffffffc0206150:	9f8d                	subw	a5,a5,a1
}
ffffffffc0206152:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc020617a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020617c:	03067e63          	bgeu	a2,a6,ffffffffc02061b8 <printnum+0x60>
...
ffffffffc0206196:	82678793          	addi	a5,a5,-2010 # ffffffffc02089b8 <syscalls+0x100>
ffffffffc020619a:	020a5a13          	srli	s4,s4,0x20
...
ffffffffc02061cc:	e8d2                	sd	s4,80(sp)
ffffffffc02061ce:	e4d6                	sd	s5,72(sp)
ffffffffc02061d0:	e0da                	sd	s6,64(sp)
ffffffffc02061d2:	fc5e                	sd	s7,56(sp)
ffffffffc02061d4:	f06a                	sd	s10,32(sp)
ffffffffc02061d6:	fc86                	sd	ra,120(sp)
ffffffffc02061d8:	f8a2                	sd	s0,112(sp)
ffffffffc02061da:	f862                	sd	s8,48(sp)
...
ffffffffc02061e6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061e8:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061ec:	5b7d                	li	s6,-1
ffffffffc02061ee:	00002a97          	auipc	s5,0x2
ffffffffc02061f2:	7f6a8a93          	addi	s5,s5,2038 # ffffffffc02089e4 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061f6:	00003b97          	auipc	s7,0x3
ffffffffc02061fa:	a0ab8b93          	addi	s7,s7,-1526 # ffffffffc0208c00 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061fe:	000d4503          	lbu	a0,0(s10)
ffffffffc0206202:	001d0413          	addi	s0,s10,1
ffffffffc0206206:	01350a63          	beq	a0,s3,ffffffffc020621a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc020620a:	c121                	beqz	a0,ffffffffc020624a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc020620c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020620e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0206210:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206212:	fff44503          	lbu	a0,-1(s0)
ffffffffc0206216:	ff351ae3          	bne	a0,s3,ffffffffc020620a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020621a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020621e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0206222:	4c81                	li	s9,0
ffffffffc0206224:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0206226:	5c7d                	li	s8,-1
ffffffffc0206228:	5dfd                	li	s11,-1
ffffffffc020622a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020622e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206230:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206234:	0ff5f593          	zext.b	a1,a1
ffffffffc0206238:	00140d13          	addi	s10,s0,1
ffffffffc020623c:	04b56263          	bltu	a0,a1,ffffffffc0206280 <vprintfmt+0xbc>
ffffffffc0206240:	058a                	slli	a1,a1,0x2
ffffffffc0206242:	95d6                	add	a1,a1,s5
ffffffffc0206244:	4194                	lw	a3,0(a1)
ffffffffc0206246:	96d6                	add	a3,a3,s5
ffffffffc0206248:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020624a:	70e6                	ld	ra,120(sp)
ffffffffc020624c:	7446                	ld	s0,112(sp)
ffffffffc020624e:	74a6                	ld	s1,104(sp)
ffffffffc0206250:	7906                	ld	s2,96(sp)
ffffffffc0206252:	69e6                	ld	s3,88(sp)
ffffffffc0206254:	6a46                	ld	s4,80(sp)
ffffffffc0206256:	6aa6                	ld	s5,72(sp)
ffffffffc0206258:	6b06                	ld	s6,64(sp)
ffffffffc020625a:	7be2                	ld	s7,56(sp)
ffffffffc020625c:	7c42                	ld	s8,48(sp)
ffffffffc020625e:	7ca2                	ld	s9,40(sp)
ffffffffc0206260:	7d02                	ld	s10,32(sp)
ffffffffc0206262:	6de2                	ld	s11,24(sp)
ffffffffc0206264:	6109                	addi	sp,sp,128
ffffffffc0206266:	8082                	ret
            padc = '0';
ffffffffc0206268:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020626a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020626e:	846a                	mv	s0,s10
ffffffffc0206270:	00140d13          	addi	s10,s0,1
ffffffffc0206274:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206278:	0ff5f593          	zext.b	a1,a1
ffffffffc020627c:	fcb572e3          	bgeu	a0,a1,ffffffffc0206240 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0206280:	85a6                	mv	a1,s1
ffffffffc0206282:	02500513          	li	a0,37
ffffffffc0206286:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206288:	fff44783          	lbu	a5,-1(s0)
ffffffffc020628c:	8d22                	mv	s10,s0
ffffffffc020628e:	f73788e3          	beq	a5,s3,ffffffffc02061fe <vprintfmt+0x3a>
ffffffffc0206292:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206296:	1d7d                	addi	s10,s10,-1
ffffffffc0206298:	ff379de3          	bne	a5,s3,ffffffffc0206292 <vprintfmt+0xce>
ffffffffc020629c:	b78d                	j	ffffffffc02061fe <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020629e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc02062a2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062a6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc02062a8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02062ac:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062b0:	02d86463          	bltu	a6,a3,ffffffffc02062d8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02062b4:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02062b8:	002c169b          	slliw	a3,s8,0x2
ffffffffc02062bc:	0186873b          	addw	a4,a3,s8
ffffffffc02062c0:	0017171b          	slliw	a4,a4,0x1
ffffffffc02062c4:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02062c6:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02062ca:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02062cc:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02062d0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062d4:	fed870e3          	bgeu	a6,a3,ffffffffc02062b4 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02062d8:	f40ddce3          	bgez	s11,ffffffffc0206230 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02062dc:	8de2                	mv	s11,s8
ffffffffc02062de:	5c7d                	li	s8,-1
ffffffffc02062e0:	bf81                	j	ffffffffc0206230 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02062e2:	fffdc693          	not	a3,s11
ffffffffc02062e6:	96fd                	srai	a3,a3,0x3f
ffffffffc02062e8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ec:	00144603          	lbu	a2,1(s0)
ffffffffc02062f0:	2d81                	sext.w	s11,s11
ffffffffc02062f2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062f4:	bf35                	j	ffffffffc0206230 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062f6:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062fa:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02062fe:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206300:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0206302:	bfd9                	j	ffffffffc02062d8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0206304:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206306:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020630a:	01174463          	blt	a4,a7,ffffffffc0206312 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020630e:	1a088e63          	beqz	a7,ffffffffc02064ca <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0206312:	000a3603          	ld	a2,0(s4)
ffffffffc0206316:	46c1                	li	a3,16
ffffffffc0206318:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020631a:	2781                	sext.w	a5,a5
ffffffffc020631c:	876e                	mv	a4,s11
ffffffffc020631e:	85a6                	mv	a1,s1
ffffffffc0206320:	854a                	mv	a0,s2
ffffffffc0206322:	e37ff0ef          	jal	ra,ffffffffc0206158 <printnum>
            break;
ffffffffc0206326:	bde1                	j	ffffffffc02061fe <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0206328:	000a2503          	lw	a0,0(s4)
ffffffffc020632c:	85a6                	mv	a1,s1
ffffffffc020632e:	0a21                	addi	s4,s4,8
ffffffffc0206330:	9902                	jalr	s2
            break;
ffffffffc0206332:	b5f1                	j	ffffffffc02061fe <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0206334:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206336:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020633a:	01174463          	blt	a4,a7,ffffffffc0206342 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020633e:	18088163          	beqz	a7,ffffffffc02064c0 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0206342:	000a3603          	ld	a2,0(s4)
ffffffffc0206346:	46a9                	li	a3,10
ffffffffc0206348:	8a2e                	mv	s4,a1
ffffffffc020634a:	bfc1                	j	ffffffffc020631a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020634c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0206350:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206352:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206354:	bdf1                	j	ffffffffc0206230 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206356:	85a6                	mv	a1,s1
ffffffffc0206358:	02500513          	li	a0,37
ffffffffc020635c:	9902                	jalr	s2
            break;
ffffffffc020635e:	b545                	j	ffffffffc02061fe <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206360:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206364:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206366:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206368:	b5e1                	j	ffffffffc0206230 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020636a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020636c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206370:	01174463          	blt	a4,a7,ffffffffc0206378 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206374:	14088163          	beqz	a7,ffffffffc02064b6 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206378:	000a3603          	ld	a2,0(s4)
ffffffffc020637c:	46a1                	li	a3,8
ffffffffc020637e:	8a2e                	mv	s4,a1
ffffffffc0206380:	bf69                	j	ffffffffc020631a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206382:	03000513          	li	a0,48
...
ffffffffc020638e:	07800513          	li	a0,120
ffffffffc0206392:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206394:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206396:	6782                	ld	a5,0(sp)
ffffffffc0206398:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020639a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020639e:	bfb5                	j	ffffffffc020631a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063a0:	000a3403          	ld	s0,0(s4)
ffffffffc02063a4:	008a0713          	addi	a4,s4,8
ffffffffc02063a8:	e03a                	sd	a4,0(sp)
ffffffffc02063aa:	14040263          	beqz	s0,ffffffffc02064ee <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02063ae:	0fb05763          	blez	s11,ffffffffc020649c <vprintfmt+0x2d8>
ffffffffc02063b2:	02d00693          	li	a3,45
ffffffffc02063b6:	0cd79163          	bne	a5,a3,ffffffffc0206478 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063ba:	00044783          	lbu	a5,0(s0)
ffffffffc02063be:	0007851b          	sext.w	a0,a5
ffffffffc02063c2:	cf85                	beqz	a5,ffffffffc02063fa <vprintfmt+0x236>
ffffffffc02063c4:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063c8:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063cc:	000c4563          	bltz	s8,ffffffffc02063d6 <vprintfmt+0x212>
ffffffffc02063d0:	3c7d                	addiw	s8,s8,-1
ffffffffc02063d2:	036c0263          	beq	s8,s6,ffffffffc02063f6 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02063d6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063d8:	0e0c8e63          	beqz	s9,ffffffffc02064d4 <vprintfmt+0x310>
ffffffffc02063dc:	3781                	addiw	a5,a5,-32
ffffffffc02063de:	0ef47b63          	bgeu	s0,a5,ffffffffc02064d4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02063e2:	03f00513          	li	a0,63
ffffffffc02063e6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063e8:	000a4783          	lbu	a5,0(s4)
ffffffffc02063ec:	3dfd                	addiw	s11,s11,-1
ffffffffc02063ee:	0a05                	addi	s4,s4,1
ffffffffc02063f0:	0007851b          	sext.w	a0,a5
ffffffffc02063f4:	ffe1                	bnez	a5,ffffffffc02063cc <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063f6:	01b05963          	blez	s11,ffffffffc0206408 <vprintfmt+0x244>
ffffffffc02063fa:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02063fc:	85a6                	mv	a1,s1
ffffffffc02063fe:	02000513          	li	a0,32
ffffffffc0206402:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0206404:	fe0d9be3          	bnez	s11,ffffffffc02063fa <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206408:	6a02                	ld	s4,0(sp)
ffffffffc020640a:	bbd5                	j	ffffffffc02061fe <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020640c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020640e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0206412:	01174463          	blt	a4,a7,ffffffffc020641a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0206416:	08088d63          	beqz	a7,ffffffffc02064b0 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020641a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020641e:	0a044d63          	bltz	s0,ffffffffc02064d8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0206422:	8622                	mv	a2,s0
ffffffffc0206424:	8a66                	mv	s4,s9
ffffffffc0206426:	46a9                	li	a3,10
ffffffffc0206428:	bdcd                	j	ffffffffc020631a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020642a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020642e:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc0206430:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0206432:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0206436:	8fb5                	xor	a5,a5,a3
ffffffffc0206438:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020643c:	02d74163          	blt	a4,a3,ffffffffc020645e <vprintfmt+0x29a>
ffffffffc0206440:	00369793          	slli	a5,a3,0x3
ffffffffc0206444:	97de                	add	a5,a5,s7
ffffffffc0206446:	639c                	ld	a5,0(a5)
ffffffffc0206448:	cb99                	beqz	a5,ffffffffc020645e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020644a:	86be                	mv	a3,a5
ffffffffc020644c:	00000617          	auipc	a2,0x0
ffffffffc0206450:	1cc60613          	addi	a2,a2,460 # ffffffffc0206618 <etext+0x2c>
ffffffffc0206454:	85a6                	mv	a1,s1
ffffffffc0206456:	854a                	mv	a0,s2
ffffffffc0206458:	0ce000ef          	jal	ra,ffffffffc0206526 <printfmt>
ffffffffc020645c:	b34d                	j	ffffffffc02061fe <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020645e:	00002617          	auipc	a2,0x2
ffffffffc0206462:	57a60613          	addi	a2,a2,1402 # ffffffffc02089d8 <syscalls+0x120>
ffffffffc0206466:	85a6                	mv	a1,s1
ffffffffc0206468:	854a                	mv	a0,s2
ffffffffc020646a:	0bc000ef          	jal	ra,ffffffffc0206526 <printfmt>
ffffffffc020646e:	bb41                	j	ffffffffc02061fe <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206470:	00002417          	auipc	s0,0x2
ffffffffc0206474:	56040413          	addi	s0,s0,1376 # ffffffffc02089d0 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206478:	85e2                	mv	a1,s8
ffffffffc020647a:	8522                	mv	a0,s0
ffffffffc020647c:	e43e                	sd	a5,8(sp)
ffffffffc020647e:	0e2000ef          	jal	ra,ffffffffc0206560 <strnlen>
ffffffffc0206482:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206486:	01b05b63          	blez	s11,ffffffffc020649c <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020648a:	67a2                	ld	a5,8(sp)
ffffffffc020648c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206490:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206492:	85a6                	mv	a1,s1
ffffffffc0206494:	8552                	mv	a0,s4
ffffffffc0206496:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206498:	fe0d9ce3          	bnez	s11,ffffffffc0206490 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020649c:	00044783          	lbu	a5,0(s0)
ffffffffc02064a0:	00140a13          	addi	s4,s0,1
ffffffffc02064a4:	0007851b          	sext.w	a0,a5
ffffffffc02064a8:	d3a5                	beqz	a5,ffffffffc0206408 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064aa:	05e00413          	li	s0,94
ffffffffc02064ae:	bf39                	j	ffffffffc02063cc <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02064b0:	000a2403          	lw	s0,0(s4)
ffffffffc02064b4:	b7ad                	j	ffffffffc020641e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02064b6:	000a6603          	lwu	a2,0(s4)
ffffffffc02064ba:	46a1                	li	a3,8
ffffffffc02064bc:	8a2e                	mv	s4,a1
ffffffffc02064be:	bdb1                	j	ffffffffc020631a <vprintfmt+0x156>
ffffffffc02064c0:	000a6603          	lwu	a2,0(s4)
ffffffffc02064c4:	46a9                	li	a3,10
ffffffffc02064c6:	8a2e                	mv	s4,a1
ffffffffc02064c8:	bd89                	j	ffffffffc020631a <vprintfmt+0x156>
ffffffffc02064ca:	000a6603          	lwu	a2,0(s4)
ffffffffc02064ce:	46c1                	li	a3,16
ffffffffc02064d0:	8a2e                	mv	s4,a1
ffffffffc02064d2:	b5a1                	j	ffffffffc020631a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02064d4:	9902                	jalr	s2
ffffffffc02064d6:	bf09                	j	ffffffffc02063e8 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02064d8:	85a6                	mv	a1,s1
ffffffffc02064da:	02d00513          	li	a0,45
ffffffffc02064de:	e03e                	sd	a5,0(sp)
ffffffffc02064e0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064e2:	6782                	ld	a5,0(sp)
ffffffffc02064e4:	8a66                	mv	s4,s9
ffffffffc02064e6:	40800633          	neg	a2,s0
ffffffffc02064ea:	46a9                	li	a3,10
ffffffffc02064ec:	b53d                	j	ffffffffc020631a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064ee:	03b05163          	blez	s11,ffffffffc0206510 <vprintfmt+0x34c>
ffffffffc02064f2:	02d00693          	li	a3,45
ffffffffc02064f6:	f6d79de3          	bne	a5,a3,ffffffffc0206470 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02064fa:	00002417          	auipc	s0,0x2
ffffffffc02064fe:	4d640413          	addi	s0,s0,1238 # ffffffffc02089d0 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206502:	02800793          	li	a5,40
ffffffffc0206506:	02800513          	li	a0,40
ffffffffc020650a:	00140a13          	addi	s4,s0,1
ffffffffc020650e:	bd6d                	j	ffffffffc02063c8 <vprintfmt+0x204>
ffffffffc0206510:	00002a17          	auipc	s4,0x2
ffffffffc0206514:	4c1a0a13          	addi	s4,s4,1217 # ffffffffc02089d1 <syscalls+0x119>
ffffffffc0206518:	02800513          	li	a0,40
ffffffffc020651c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206520:	05e00413          	li	s0,94
ffffffffc0206524:	b565                	j	ffffffffc02063cc <vprintfmt+0x208>

ffffffffc0206526 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206526:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0206528:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020652c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020652e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206530:	ec06                	sd	ra,24(sp)
ffffffffc0206532:	f83a                	sd	a4,48(sp)
ffffffffc0206534:	fc3e                	sd	a5,56(sp)
ffffffffc0206536:	e0c2                	sd	a6,64(sp)
ffffffffc0206538:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020653a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020653c:	c89ff0ef          	jal	ra,ffffffffc02061c4 <vprintfmt>
}
ffffffffc0206540:	60e2                	ld	ra,24(sp)
ffffffffc0206542:	6161                	addi	sp,sp,80
ffffffffc0206544:	8082                	ret

ffffffffc0206546 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0206546:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc020654a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020654c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020654e:	cb81                	beqz	a5,ffffffffc020655e <strlen+0x18>
        cnt ++;
ffffffffc0206550:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0206552:	00a707b3          	add	a5,a4,a0
ffffffffc0206556:	0007c783          	lbu	a5,0(a5)
ffffffffc020655a:	fbfd                	bnez	a5,ffffffffc0206550 <strlen+0xa>
...
ffffffffc0206560:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206562:	e589                	bnez	a1,ffffffffc020656c <strnlen+0xc>
ffffffffc0206564:	a811                	j	ffffffffc0206578 <strnlen+0x18>
        cnt ++;
ffffffffc0206566:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206568:	00f58863          	beq	a1,a5,ffffffffc0206578 <strnlen+0x18>
ffffffffc020656c:	00f50733          	add	a4,a0,a5
ffffffffc0206570:	00074703          	lbu	a4,0(a4)
ffffffffc0206574:	fb6d                	bnez	a4,ffffffffc0206566 <strnlen+0x6>
ffffffffc0206576:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206578:	852e                	mv	a0,a1
ffffffffc020657a:	8082                	ret

ffffffffc020657c <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020657c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020657e:	0005c703          	lbu	a4,0(a1)
ffffffffc0206582:	0785                	addi	a5,a5,1
ffffffffc0206584:	0585                	addi	a1,a1,1
ffffffffc0206586:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020658a:	fb75                	bnez	a4,ffffffffc020657e <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0206592:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206596:	cb89                	beqz	a5,ffffffffc02065a8 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206598:	0505                	addi	a0,a0,1
ffffffffc020659a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020659c:	fee789e3          	beq	a5,a4,ffffffffc020658e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02065a0:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02065a4:	9d19                	subw	a0,a0,a4
ffffffffc02065a6:	8082                	ret
ffffffffc02065a8:	4501                	li	a0,0
ffffffffc02065aa:	bfed                	j	ffffffffc02065a4 <strcmp+0x16>

ffffffffc02065ac <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc02065ac:	00054783          	lbu	a5,0(a0)
ffffffffc02065b0:	c799                	beqz	a5,ffffffffc02065be <strchr+0x12>
        if (*s == c) {
ffffffffc02065b2:	00f58763          	beq	a1,a5,ffffffffc02065c0 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02065b6:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02065ba:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02065bc:	fbfd                	bnez	a5,ffffffffc02065b2 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02065c2:	ca01                	beqz	a2,ffffffffc02065d2 <memset+0x10>
ffffffffc02065c4:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02065c6:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02065c8:	0785                	addi	a5,a5,1
ffffffffc02065ca:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02065ce:	fec79de3          	bne	a5,a2,ffffffffc02065c8 <memset+0x6>
    }
    return s;
...
ffffffffc02065d4 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02065d4:	ca19                	beqz	a2,ffffffffc02065ea <memcpy+0x16>
ffffffffc02065d6:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02065d8:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02065da:	0005c703          	lbu	a4,0(a1)
ffffffffc02065de:	0585                	addi	a1,a1,1
ffffffffc02065e0:	0785                	addi	a5,a5,1
ffffffffc02065e2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02065e6:	fec59ae3          	bne	a1,a2,ffffffffc02065da <memcpy+0x6>
    }
    return dst;
